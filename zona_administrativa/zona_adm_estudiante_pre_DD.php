...
$query_ES_DD = "INSERT INTO reg_estudiantes(estu_expediente, nombre_estu, apellidos_estu, nacimiento_estu, id_sexo, id_ciudad,
			                                id_estado, id_pais, id_religion, ci_estu, id_medico, id_sangre) 
...
$query_ES_DD_act = "INSERT INTO reg_estu_actual(id_estud, id_reg_pagos, cursa_actualmente, grado_actual, repite_actual, 
				...
				if (!mysqli_query($enlace,$query_ES_DD_obs))  // si no logro ingresar las observaciones del estudiante 1
				            ...
				            {   // en caso de que logre guardar las obs del estudiante 1
								...
								$obs_success4="<i class=\"fas fa-check-circle fa-lg\"></i>";
											...
											$exitoZ.="- &nbsp;
														<i data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Representado N°4 ha sido Pre-Inscrito sin foto.\">
											...
											mysqli_close($enlace);
										    	...
										    	$exitoZ.="- &nbsp;
														<i data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Representado N°4 ha sido Pre-Inscrito con foto.\">
