...
include("consultas_add/chequeo_estudiantes_add_ins.php");   // chequea que lo introducido este bien.
...
// independiente de que exista foto o documento de identidad procede a registrar a los estudiantes máx 5.
    ...
    {
include ("zona_adm_estudiante_ins_AA.php");
    }
    ...
    {
include ("zona_adm_estudiante_ins_AA.php");
include ("zona_adm_estudiante_ins_BB.php");
    }
...
include ("zona_adm_estudiante_ins_AA.php");
include ("zona_adm_estudiante_ins_BB.php");
include ("zona_adm_estudiante_ins_CC.php");
    }
...
include ("zona_adm_estudiante_ins_BB.php");
include ("zona_adm_estudiante_ins_CC.php");
include ("zona_adm_estudiante_ins_DD.php");
    }
...
include ("zona_adm_estudiante_ins_CC.php");
include ("zona_adm_estudiante_ins_DD.php");
include ("zona_adm_estudiante_ins_EE.php");
    }       */
...
<?php include ("consultas_add/query_estudiante_ins.php"); ?>  <!-- hace los queries necesarios para los select del formulario -->
...
if ($alerta_principal  == "0") {
 ...
 echo '<script type="text/javascript">';
  ...
  title: "",
  text: "Si dispone de las fotos y/o del documento de identidad, cárguelos en el sistema previo a llenar el formulario!",
  icon: "",
});';
  echo '}, 3000);</script>';  
      			...
      			<div class="card-body">
		      		...
		      		<div class="form-row">
				      		...
				      		<div class="col-md-3 col-lg-3 mb-1">
								...
								<i class="fas fa-user-check fa-lg"></i>&nbsp;&nbsp; <b> Inscripción: </b></div> 
...
<div style=" height: 100%; line-height: 200px;">
	                            ...
	                            <img  src="../0 Croppie/fotorepre<?php echo $fotPP;?>.png?nocache=<?php echo time(); ?>"
...
<div style=" height: 100%; line-height: 150px;">
	                            ...
	                            <img src="../0 Croppie/ci_repre<?php echo $fotPP;?>.png?nocache=<?php echo time(); ?>" alt="..." class="img-thumbnail" style=" max-height: 170px; padding-bottom: 5px;" 
...
<i class="fas fa-check"></i>&nbsp;&nbsp;Imagen recortada</b>; click en <b class="text-primary">"Continuar"</b>; al finalizar hacer clic en <b class="text-info">"Inscribir"</b>.
...
<div class="modal fade" tabindex="-1" id="cropImagePop_B" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">Centre el documento de identidad dentro del margen y haga clic en continuar.</h5>
<!--        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>  -->
      </div>
						...
						$('#cropImageBtn_A').on('click', function (ev) {
							$uploadCrop_A.croppie('result', {
								...
								size: 'viewport'
 								...
 								$.ajax({
						        url:"../0 Croppie/upload_fot_repre.php?namexx=<?php echo $nnn['ci']; ?>",
						        type: "POST",
						        data:{"image": response},
            ...
            $uploadCrop_B.croppie('rotate', parseInt($(this).data('deg')));
						...
						$('#cropImageBtn_B').on('click', function (ev) {
							$uploadCrop_B.croppie('result', {
								...
								$.ajax({
						        url:"../0 Croppie/upload_ci_repre.php?namexx=<?php echo $nnn['ci']; ?>",
						        type: "POST",
						  		...
						  		<div class="input-group input-group-sm col-md-4 mb-2">
										<div class="input-group-prepend">
											<span class="input-group-text" id="basic-addon1"><i class="far fa-user-circle "></i></span>  
							      				...
							      				<select class="form-control importantex" id="civil" name="civil" required>
							   ...
							   <div class="input-group input-group-sm col-md-4 mb-2">
										<div class="input-group-prepend">
											<span class="input-group-text" id="basic-addon1"><i class="fas fa-briefcase "></i></span>  
							      				...
							      				<select class="form-control importantex" id="profesion" name="profesion" required>
							  							
							  							<option selected disabled value="">Profesión/Oficio:</option>
							  							<option disabled></option>
...
<input maxlength="59" type="text" class="form-control importantex" id="calle" name="calle" placeholder="ejemp: calle Bolívar ó sector Santa Ana ó Urbanización San Luis" aria-label="calle" aria-describedby="basic-addon1" required>
							  </div>
							...
							<div class="input-group-prepend">
											<span class="input-group-text" id="basic-addon1"><i class="fab fa-gg fa-lg"></i></span>  
							      				...
							      				<select class="form-control importantex" id="codigo" name="codigo" required>
							  							...
							  							<option selected disabled value="">Cód Post.</option>
							  							<option disabled></option>
...
<option value="<?php echo $row_datos_viviendas['id_vivienda']; ?>"><?php echo $row_datos_viviendas['nombre_vivienda']; ?></option>
 ...
 <div class="form-row">
							   ...
							   <div class="input-group input-group-sm col-md-6 mb-2">
									<div class="input-group-prepend">
										<span class="input-group-text" id="basic-addon1">&nbsp;<i class="fab fa-xing "></i></span>  
									</div>
										<input maxlength="30" type="text" class="form-control importantex" id="nombre_vi" name="nombre_vi" placeholder="Nombre de la vivienda..." aria-label="nombre_vi" aria-describedby="basic-addon1" required>
							  </div>
...
<div class="col-md-12 mt-3 mb-2 content-box-alterno rounded " style="<?php echo $gdiv2; ?>" >
 ...
 <?php include ("zona_adm_estudiante_ins_2.php"); ?>
...
<div class="col-md-12 mt-3 mb-2 content-box-gray rounded " style="<?php echo $gdiv3; ?>">
 ...
 <?php include ("zona_adm_estudiante_ins_3.php"); ?>
...
<!-- representado 4 -->
<div class="col-md-12 mt-3 mb-2 content-box-alterno rounded " style="<?php echo $gdiv4; ?>">

 <?php include ("zona_adm_estudiante_ins_4.php"); ?>
...
<!-- representado 5 -->
<div class="col-md-12 mt-3 mb-2 content-box-gray rounded " style="<?php echo $gdiv5; ?>">

 <?php include ("zona_adm_estudiante_ins_5.php"); ?>
...
<input type="hidden" id="quien" name="quien" value="<?php echo $_SESSION['id']; ?>">
						...
						<i class="fas fa-save fa-lg"></i> &nbsp Inscribir</button>
...
<b class="text-success"> <i class="fas fa-check"></i>&nbsp;&nbsp;Imagen recortada</b>; para avanzar haga click en <b class="text-primary">"Continuar".</b>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="submit" class="btn btn-primary" id="cropImageBtn_ED">Continuar</button>

         <button type="submit" class="btn btn-secondary" name="cancelDDD" disabled>Continuar</button>
