...
$num_cedula = mysqli_real_escape_string($enlace,$_POST['cedula']);
			...
			$mod_email_estu_act1 = 'colegio@colegio.col';

		$mod_se_retira_con_act1 = 'actualizar';
 		$mod_control_med_act1 = '.';
 		$v_otra_act1 = '.';

 		$v1_act1 = 'No';  $v2_act1 = 'No';  $v3_act1 = 'No';  $v4_act1 = 'No';
 		$v5_act1 = 'No';  $v6_act1 = 'No';  $v7_act1 = 'No';  $v8_act1 = 'No';
 		$v9_act1 = 'No';  $v10_act1 = 'No';  $v11_act1 = 'No';  $v12_act1 = 'No';
 		$v13_act1 = 'No';  $v14_act1 = 'No';  $v15_act1 = 'No';	

 		$mod_medicamentos_act1 = '.';	
...
$query_ES_AA = "INSERT INTO reg_estudiantes(estu_expediente, nombre_estu, apellidos_estu, nacimiento_estu, id_sexo, id_ciudad,
							...
							VALUES (   '".mysqli_real_escape_string($enlace,$_POST['expediente_est1'])."'          ,
									   ...
									   '".mysqli_real_escape_string($enlace,$_POST['cedula_est1'])."'          ,									   
										...
										'$padece_act1', '$sangre_act1', '$mod_email_estu_act1', 'actualizar'    ,
