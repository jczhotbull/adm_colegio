...
echo'<h3 style="font-variant:small-caps; color:red;">No se actualizo correctamente la Nota Revisión 2.</h3>
...
echo'<h3 style="font-variant:small-caps; color:green;">Se actualizo correctamente la Nota Revisión 2.</h3>
  <a href="javascript:window.history.back();">&laquo; Volver a la página anterior &laquo;</a>';
