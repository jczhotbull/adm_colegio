 ...
 <div data-toggle="tooltip" data-placement="top" title="Borrar foto." >
                ...
                <button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal"
                 data-target="#borrar_foto<?php echo $row_datos_estudiantes['id_estud']; ?>"> <i class="fas fa-camera-retro"></i></button>
...
<div class="modal fade" id="borrar_foto<?php echo $row_datos_estudiantes['id_estud']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
