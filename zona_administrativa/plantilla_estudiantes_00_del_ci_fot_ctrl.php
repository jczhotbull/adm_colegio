 ...
 <div data-toggle="tooltip" data-placement="top" title="Borrar Doc. de Id." >
                ...
                <button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal"
                 data-target="#borrar_ci_foto<?php echo $row_datos_control['id_estud']; ?>"> <i class="fas fa-id-card"></i></button>
...
<div class="modal fade" id="borrar_ci_foto<?php echo $row_datos_control['id_estud']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
