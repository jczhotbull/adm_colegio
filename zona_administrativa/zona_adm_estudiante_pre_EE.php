...
$query_ES_EE_act = "INSERT INTO reg_estu_actual(id_estud, id_reg_pagos, cursa_actualmente, grado_actual, repite_actual, 
				...
				if (!mysqli_query($enlace,$query_ES_EE_obs))  // si no logro ingresar las observaciones del estudiante 1
				            ...
				            {   // en caso de que logre guardar las obs del estudiante 1
								...
								$obs_success5="<i class=\"fas fa-check-circle fa-lg\"></i>";
											...
											$exitoZ.="- &nbsp;
														<i data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Representado N°5 ha sido Pre-Inscrito sin foto.\">
											...
											mysqli_close($enlace);
										    	...
										    	$exitoZ.="- &nbsp;
														<i data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Representado N°5 ha sido Pre-Inscrito con foto.\">
