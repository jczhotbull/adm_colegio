...
if (strlen($_POST['buscar_estud']) <=2 )  // no sea mayor a 40 caracteres
    ...
    header( "Location: plantilla_estudiantes_search_ape.php?ciclo=".$el_cicloXX."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=5" ); 
...
WHERE  reg_estu_actual.id_estud = reg_estudiantes.id_estud
      ...
      if ($totalRows_datos_plantilla_bus == '0') {
       ...
       header( "Location: plantilla_estudiantes_search_ape.php?ciclo=".$el_cicloXX."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=55" );
      ...
      if ($totalRows_datos_plantilla_bus >= '1' and $totalRows_datos_plantilla_bus <= '16') {
        ...
        header( "Location: plantilla_estudiantes_search_ape.php?ciclo=".$el_cicloXX."&tituloJKL=Resultados...&criterio=".$busqueda."&alertin=0" );
      ...
      if ($totalRows_datos_plantilla_bus >= '17') {
        ...
        header( "Location: plantilla_estudiantes_search_ape.php?ciclo=".$el_cicloXX."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=1" ); 
...
<?php include ("listas_imp_php/lista_estudiantes_search_ape.php"); ?>  <!-- ayuda a hacer el listado -->
