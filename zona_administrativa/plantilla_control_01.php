...
<?php include ("listas_imp_php/lista_control_ins_general.php"); ?>  <!-- ayuda a hacer el listado -->
...
<?php  if ( $r_d_reg_sobreD['proviene_de_otro'] == '1') {
    ...
    <?php  
      $flechinda = '<br><span style="color:#FF8F00;"><b>Inscrito en:</b></span><br>'  ;
      echo $flechinda;
      echo "<b>";
