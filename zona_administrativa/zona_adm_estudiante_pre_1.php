...
<div class="form-row ">  <!-- datos del estudiante -->
						  		...
						  		<b class="text-info">Datos del representado N°1: </b>
...
<div style=" height: 100%; line-height: 200px;">
	                            ...
	                            <img  src="../0 Croppie/foto_estu1<?php echo $fotPP;?>.png?nocache=<?php echo time(); ?>"

				 class="fotologuitocol img-responsive img-thumbnail" style=" max-height: 214px; padding-bottom: 5px;"

				  id=""  onerror="this.src='../zz_fotos_p/ZZvacioA.jpg';"/>       
...
<div class="form-row mt-1  ">  <!-- cargar ci estudiante 1  -->
	<div class="col-lg-12 ">
		...
		<img src="../0 Croppie/ci_est_act1<?php echo $fotPP;?>.png?nocache=<?php echo time(); ?>" alt="..." class="img-thumbnail" style=" max-height: 170px; padding-bottom: 5px;"   onerror="this.src='../zz_fotos_p/ZZvacio_act1.jpg';" > 
...
<option selected disabled value="">Municipio:</option>
              ...
              $querymod28_est1 = "SELECT * FROM d_municipio WHERE nombre_municipio != '.' ORDER BY nombre_municipio ASC";
              $datos_mod28_est1 = mysqli_query($enlace, $querymod28_est1) or die(mysqli_error());
              $row_datos_mod28_est1 = mysqli_num_rows($datos_mod28_est1);                          

                          while ($row_datos_mod28_est1 = mysqli_fetch_assoc($datos_mod28_est1))
                          {                            
?>
    <option value = "<?php echo $row_datos_mod28_est1['nombre_municipio']; ?>"><?php echo $row_datos_mod28_est1['nombre_municipio'];?></option>
<?php
                          }                          
                          mysqli_close($enlace);
                          ?>   
...
<div class="input-group-prepend">
   ...
   <select class="form-control form-control-sm" id="mod_vive_con_estud_act1" name="mod_vive_con_estud_act1" required >
<option selected disabled value="">Vive con su:</option>
                              <option disabled></option>

                                <?php 
                          include("../conectar.php");
              $querymod258_act1 = "SELECT * FROM d_vive_con WHERE nombre_vive_con != '.' ORDER BY nombre_vive_con ASC";
              $datos_mod258_act1 = mysqli_query($enlace, $querymod258_act1) or die(mysqli_error());
              $row_datos_mod258_act1 = mysqli_num_rows($datos_mod258_act1);                          

                          while ($row_datos_mod258_act1 = mysqli_fetch_assoc($datos_mod258_act1))
                          {                            
?>
    <option value = "<?php echo $row_datos_mod258_act1['nombre_vive_con']; ?>"><?php echo $row_datos_mod258_act1['nombre_vive_con'];?></option>
<?php
                          }                          
                          mysqli_close($enlace);
                          ?>   
...
<div class="input-group-prepend">   
   ...
   <select class="form-control form-control-sm" id="mod_traslada_estud_act1" name="mod_traslada_estud_act1" required >
<option selected disabled value="">Se traslada en:</option>
                              <option disabled></option>
                                ...
                                <?php 
                          include("../conectar.php");
              $querymod247_act1 = "SELECT * FROM d_traslada_en WHERE nombre_traslada_en != '.' ORDER BY nombre_traslada_en ASC";
              $datos_mod247_act1 = mysqli_query($enlace, $querymod247_act1) or die(mysqli_error());
              $row_datos_mod247_act1 = mysqli_num_rows($datos_mod247_act1);                          

                          while ($row_datos_mod247_act1 = mysqli_fetch_assoc($datos_mod247_act1))
                          {                            
?>
    <option value = "<?php echo $row_datos_mod247_act1['nombre_traslada_en']; ?>"><?php echo $row_datos_mod247_act1['nombre_traslada_en'];?></option>
<?php
                          }                          
                          mysqli_close($enlace);
                          ?>   
...
<div class="input-group input-group-sm col-md-3 mb-2">
                <div class="input-group-prepend">
                      ...
                      <input maxlength="29" type="text" class="form-control form-control-sm " id="mod_alergias_estud_act1" name="mod_alergias_estud_act1"
 required>   
...
<div class="input-group-prepend">
  ...
  <input maxlength="59" type="text" class="form-control form-control-sm " id="mod_padecio_estud_act1" name="mod_padecio_estud_act1"
 required> 
...
<div class="input-group-prepend">   
   ...
   <select class="form-control form-control-sm" id="mod_se_retira_con_act1" name="mod_se_retira_con_act1" required >
<option selected disabled value="">Se retira del colegio con/en:</option>
                              <option disabled></option>

                                <?php 
                          include("../conectar.php");
              $querymod269_act1 = "SELECT * FROM d_se_retira WHERE nombre_se_retira != '.' ORDER BY nombre_se_retira ASC";
              $datos_mod269_act1 = mysqli_query($enlace, $querymod269_act1) or die(mysqli_error());
              $row_datos_mod269_act1 = mysqli_num_rows($datos_mod269_act1);                          

                          while ($row_datos_mod269_act1 = mysqli_fetch_assoc($datos_mod269_act1))
                          {                            
?>
    <option value = "<?php echo $row_datos_mod269_act1['nombre_se_retira']; ?>"><?php echo $row_datos_mod269_act1['nombre_se_retira'];?></option>
<?php
                          }                          
                          mysqli_close($enlace);
                          ?>   
...
<div class="input-group input-group-sm col-md-3 mb-2">
                <div class="input-group-prepend">
                      <span class="input-group-text alert-warning" id="basic-addon1"><i>En control con un especialista en:</i></span>  
                            ...
                            <input maxlength="59" type="text" class="form-control form-control-sm " id="mod_control_med_act1" name="mod_control_med_act1"
>   
...
<div class="input-group input-group-sm col-md-3 mb-2">
                <div class="input-group-prepend">
                      <span class="input-group-text alert-warning" id="basic-addon1"><i>Cuales medicamentos recibe:</i></span>  
                            ...
                            <input maxlength="29" type="text" class="form-control form-control-sm " id="mod_medicamentos_act1" name="mod_medicamentos_act1">   
...
<input maxlength="59"  type="email" class="form-control form-control-sm " id="mod_email_estu_act1" name="mod_email_estu_act1"> 
...
<div class="form-row">  <!-- row dos  nuevo añadido-->
     ...
     <select class="form-control form-control-sm" id="mod_v1_act1" name="mod_v1_act1">
    ...
    <div class="input-group input-group-sm col-md-3 mb-2">
     ...
     <select class="form-control form-control-sm" id="mod_v2_act1" name="mod_v2_act1">
    ...
    <div class="input-group input-group-sm col-md-3 mb-2">
     ...
     <select class="form-control form-control-sm" id="mod_v3_act1" name="mod_v3_act1">
    ...
    <option value="Si" >Si</option>  
     ...
     <select class="form-control form-control-sm" id="mod_v4_act1" name="mod_v4_act1">
...
<div class="form-row">  <!-- row tres  nuevo añadido-->
    ...
    <div class="input-group input-group-sm col-md-3 mb-2">
     ...
     <select class="form-control form-control-sm" id="mod_v5_act1" name="mod_v5_act1">
    ...
    <option value="Si" >Si</option> 
     ...
     <select class="form-control form-control-sm" id="mod_v6_act1" name="mod_v6_act1">
    ...
    <option value="Si" >Si</option> 
     ...
     <select class="form-control form-control-sm" id="mod_v7_act1" name="mod_v7_act1">
    ...
    <option value="Si" >Si</option>  
     ...
     <select class="form-control form-control-sm" id="mod_v8_act1" name="mod_v8_act1">
...
<div class="form-row">  <!-- row cuatro  nuevo añadido-->
    ...
    <div class="input-group input-group-sm col-md-3 mb-2">
     ...
     <select class="form-control form-control-sm" id="mod_v9_act1" name="mod_v9_act1">
    ...
    <option value="Si" >Si</option>  
     ...
     <select class="form-control form-control-sm" id="mod_v10_act1" name="mod_v10_act1">
    ...
    <option value="Si" >Si</option>  
     ...
     <select class="form-control form-control-sm" id="mod_v11_act1" name="mod_v11_act1">
    ...
    <option value="Si" >Si</option> 
     ...
     <select class="form-control form-control-sm" id="mod_v12_act1" name="mod_v12_act1">
...
<div class="form-row">  <!-- row quinto  nuevo añadido-->
    ...
    <div class="input-group input-group-sm col-md-3 mb-2">
     ...
     <select class="form-control form-control-sm" id="mod_v13_act1" name="mod_v13_act1">
    ...
    <option value="Si" >Si</option> 
     ...
     <select class="form-control form-control-sm" id="mod_v14_act1" name="mod_v14_act1">
    ...
    <option value="Si" >Si</option>  
     ...
     <select class="form-control form-control-sm" id="mod_v15_act1" name="mod_v15_act1">
...
<input maxlength="29" type="text" class="form-control form-control-sm" id="v_otra_act1" name="v_otra_act1" >  
...
<div data-toggle="tooltip" data-placement="right" title="Borrar foto y/o documentos cargados del estudiante 1.">
...
<div class="form-row margencito">  <!-- viene de otro plantel -->
	...
	<div class="input-group input-group-sm col-md-4 mb-2">
			...
			<input maxlength="39" type="text" class="form-control" id="plantel_pro1" name="plantel_pro1"
...
<input type="text" class="form-control form-control-sm" id="mod_areas_pendientes1" name="mod_areas_pendientes1"  >
        </div>
	...
	<div class="input-group input-group-sm col-md-3 mb-2">
										<div class="input-group-prepend">
											<span class="input-group-text" id="basic-addon1"><i>Edad:</i></span>  
							      				...
							      				<select class="form-control importantex" id="edad_act1" name="edad_act1" required>
