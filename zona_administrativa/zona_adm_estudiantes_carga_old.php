...
<div class="input-group col-md-6 col-lg-5 col-xl-5 mt-2">
...
<div class="input-group col-md-6 col-lg-5 col-xl-5 mt-2" data-toggle="tooltip" data-placement="top" title="Permite a los representes ver he imprimir el corte promedio de todos los lapsos y las actividades de revisión; Activarlo al dar por finalizado el año escolar." >
...
<div class="col-md-6 col-lg-2 col-xl-2 mt-2">
...
<form method="POST">
 ...
 <form method="POST">
           ...
           <div class="input-group input-group-sm mb-1">            
            <input type="text" class="form-control" name="buscar_estud_nombre" placeholder="Nombre(s)...">
            <input type="hidden" id="ciclo_cicloso" name="ciclo_cicloso" value="<?php echo $id_periodo_clave; ?>">
            <div class="input-group-append">
 ...
 <form method="POST">
           ...
           <div class="input-group input-group-sm mb-1">            
            <input type="text" class="form-control" name="buscar_estud_apell" placeholder="Apellido(s)...">
            <input type="hidden" id="ciclo_cicloso" name="ciclo_cicloso" value="<?php echo $id_periodo_clave; ?>">
            <div class="input-group-append">
...
<?php if ($el_g ==34 or $el_g ==35 or $el_g ==36 or $el_g ==37 or $el_g ==38 or $el_g ==40 or $el_g ==41 or $el_g ==43 or $el_g ==44 or $el_g ==45 or $el_g ==46 or $el_g ==47
  or $el_g ==50 or $el_g ==51 or $el_g ==52 or $el_g ==53 or $el_g ==54 or $el_g ==55 or $el_g ==56 or $el_g ==58  or $el_g ==60 or $el_g ==61 or $el_g ==62 ){?>style="display:none"<?php } ?> >
...
<?php if ($el_g ==34 or $el_g ==35 or $el_g ==36 or $el_g ==37 or $el_g ==38 or $el_g ==40 or $el_g ==41 or $el_g ==42  or $el_g ==44 or $el_g ==45 or $el_g ==46 or $el_g ==47
 or $el_g ==50 or $el_g ==51 or $el_g ==52 or $el_g ==53 or $el_g ==54 or $el_g ==55 or $el_g ==56 or $el_g ==58 or $el_g ==60 or $el_g ==62  ){?>style="display:none"<?php } ?> >
...
<?php if ($el_g ==34 or $el_g ==35 or $el_g ==36 or $el_g ==37 or $el_g ==38 or $el_g ==40 or $el_g ==41 or $el_g ==42 or $el_g ==43  or $el_g ==45 or $el_g ==46 or $el_g ==47
 or $el_g ==50 or $el_g ==51 or $el_g ==52 or $el_g ==53 or $el_g ==54 or $el_g ==55 or $el_g ==56 or $el_g ==58 or $el_g ==59 or $el_g ==62 ){?>style="display:none"<?php } ?> >
