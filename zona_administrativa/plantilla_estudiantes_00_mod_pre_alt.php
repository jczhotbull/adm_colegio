...
<div class="form-row">
  ...
  <img class="img-thumbnail border border-success"  src="<?php echo $row_datos_estudiantes_YYY['foto_repre']; ?>?nocache=<?php echo time(); ?>"
...
value="<?php echo $row_datos_estudiantes_YYY['nombre_repre']; ?>" required> 
 ...
 <input type="hidden" id="id_repre_GHJ"  name="id_repre_GHJ"
    value="<?php echo $row_datos_estudiantes_YYY['id_repre']; ?>">  <!-- para saber donde guardar el cambio -->
...
value="<?php echo $row_datos_estudiantes_YYY['apellido_repre']; ?>" required> 
...
value="<?php echo $row_datos_estudiantes_YYY['email_repre']; ?>"> 
...
value="<?php echo $row_datos_estudiantes_YYY['ci_repre']; ?>" required> 
...
$id_del_repre = $row_datos_estudiantes_YYY['id_repre'];
...
value="<?php echo $row_datos_estudiantes_YYY['celular_repre']; ?>" required> 
...
value="<?php echo $row_datos_estudiantes_YYY['telefono_repre']; ?>"> 
...
<input type="date" class="form-control form-control-sm" id="mod_nacimiento_repre" name="mod_nacimiento_repre" value="<?php echo $row_datos_estudiantes_YYY['nacimiento_repre']; ?>" >
        </div>
...
<input maxlength="12" type="text" class="form-control form-control-sm" id="mod_password_repre" name="mod_password_repre" value="<?php echo $row_datos_estudiantes_YYY['clave_repre']; ?>" required>
        </div>
...
$id_dela_direccion = $row_datos_estudiantes_YYY['id_direccion'];
...
mysqli_close($enlace);
 ...
 <input type="hidden" id="id_direcc_GHJ"  name="id_direcc_GHJ"
    value="<?php echo $row_datos_estudiantes_YYY['id_direccion']; ?>">  <!-- para saber donde guardar el cambio -->
...
<?php
 ...
 <div class="input-group input-group-sm col-md-3 mb-2">
  ...
  <div class="input-group-prepend">
    <span class="input-group-text alert-info" id="basic-addon1"><i>Mun.:</i></span> 
  </div>

   <select class="form-control form-control-sm" id="mod_municipio_estud" name="mod_municipio_estud" >
...
<div class="input-group input-group-sm col-md-3 mb-2">
                <div class="input-group-prepend">
                      <span class="input-group-text alert-info" id="basic-addon1"><i class="fab fa-medrt"></i><i>&nbsp; Padece de:</i></span>  
                    </div>
...
<div class="input-group-prepend">
  <span class="input-group-text alert-warning" id="basic-addon1">&nbsp;<b>Email:</b></span> 
</div>

  <input maxlength="59" type="email" class="form-control form-control-sm " id="mod_email_estud" name="mod_email_estud"
...
<div class="form-row">  <!-- row cero  nuevo añadido-->
 ...
 <div class="input-group input-group-sm col-md-2 mb-2">
  ...
  <div class="input-group-prepend">
   ...
   <select class="form-control form-control-sm" id="mod_vive_con_estud" name="mod_vive_con_estud" >
...
<?php
 ...
 <div class="input-group input-group-sm col-md-3 mb-2">
  ...
  <div class="input-group-prepend">
   ...
   <select class="form-control form-control-sm" id="mod_traslada_estud" name="mod_traslada_estud"  >
...
value="<?php echo $row_datos_estudiantes['alergico_a']; ?>" >   
...
value="<?php echo $row_datos_estudiantes['enf_padecidas']; ?>" > 
...
<div class="form-row">  <!-- row uno  nuevo añadido-->
 ...
 <div class="input-group input-group-sm col-md-4 mb-2">
  ...
  <div class="input-group-prepend">
   ...
   <select class="form-control form-control-sm" id="mod_se_retira_con" name="mod_se_retira_con"  >
...
<?php
...

 {
  ...
  <input type=\"date\" class=\"form-control form-control-sm\" id=\"mod_inscripcion_fecha\" name=\"mod_inscripcion_fecha\" >"; }
...
<input type="hidden" id="ffff" name="ffff" value="<?php echo $r_d_reg_estu_actual_HOY['fecha_inscripcion']; ?>">
