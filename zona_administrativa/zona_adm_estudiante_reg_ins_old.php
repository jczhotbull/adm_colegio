...
$errorZ .=" &nbsp; &nbsp;
                ...
                <i class=\"fas fa-stopwatch fa-lg\"></i>&nbsp; - El estudiante ya está inscrito en el ciclo seleccionado!!!</i> &nbsp ";
...
include("plantilla_estudiantes_00_update_reg_ins_new.php");   // procesa los datos
...
and nombre_seccion != '1er a 3er Nivel' and nombre_seccion != 'A y B'
and nombre_seccion !='1er Nivel' and nombre_seccion !='2do Nivel' and nombre_seccion !='3er Nivel' ORDER BY nombre_seccion ASC";
      			...
      			<div class="card-body">
		      		...
		      		<div class="form-row">
				      		...
				      		<div class="col-md-3 col-lg-3 mb-1">
								...
								<i class="fas fa-clipboard fa-lg"></i>&nbsp;&nbsp; <b> Inscripción Alumno Regular: </b></div> 
...
.punterodd{
	...
	cursor: pointer;
							...
							<?php include ("zona_adm_estudiante_reg_ins_form.php"); ?> 
...
{ 
 ...
 echo '<script type="text/javascript">';
  echo 'setTimeout(function () { swal({
  type: "success",
  title: "Re-Inscripción Realizada Correctamente!",
  allowOutsideClick: false,
  allowEscapeKey: false,
  allowEnterKey: false,
