...
if ($a_convertir == '4' or $b_convertir == '4' or $c_convertir == '4' or $d_convertir == '4' or $e_convertir == '4' or $f_convertir == '4' or $g_convertir == '4' or
$h_convertir == '4' or $i_convertir == '4' or $j_convertir == '4' or $k_convertir == '4' or $l_convertir == '4' or $m_convertir == '4' or $n_convertir == '4'  ) {
  
                       $errorZ=" Revise los formatos empleados en una de las Áreas, Asignaturas o Materias - No puede ser Cualitativa.";
...
<div data-toggle="tooltip" data-placement="top" title="Global Definitivas  Con Aux Final"  <?php if ($_SESSION ['cargo'] == 'Profesor' ){?>style="display:none"<?php } ?> >

 <form target="_blank" action="zzz_impresiones/imp_lista_carta_mod_global_definitiva_auxi.php" method="POST">
    ...
    <input type="hidden" id="id_lapsoxxx"  name="id_lapsoxxx"  value="Def">
          ...
          <button type="submit" name="imp_carta" id="imp_carta" class="btn btn-info mr-1 mb-1 btn_sizes" <?php if ($totalRows_control>=40){?>style="display:none"<?php } ?> >
           <i class="fas fa-battery-full fa-lg"></i>&nbsp;&nbsp; "Carta+Aux"</button>


</form> </div>


<div class="mr-1" data-toggle="tooltip" data-placement="top" title="Global Definitivas Con Aux Final"  <?php if ($_SESSION ['cargo'] == 'Profesor' ){?>style="display:none"<?php } ?> >

<form target="_blank" action="zzz_impresiones/imp_lista_oficio_mod_global_definitiva_auxi.php" method="POST">
    ...
    <input type="hidden" id="id_lapsoxxx"  name="id_lapsoxxx"  value="Def°">
          ...
          <button type="submit" name="imp_carta" id="imp_carta" class="btn btn-info btn_sizes" <?php if ($totalRows_control<=39){?>style="display:none"<?php } ?> >
           <i class="fas fa-battery-full fa-lg"></i>&nbsp;&nbsp; "Oficio+Aux"</button>
...
<div class="mr-1" data-toggle="tooltip" data-placement="top" title="1° - Actividades Aplazadas"  <?php if ($_SESSION ['cargo'] == 'Profesor' ){?>style="display:none"<?php } ?> >

 <form target="_blank" action="zzz_impresiones/resumen_de_actividades_alte_apla.php" method="POST">
    ...
    <input type="hidden" id="id_lapsoxxx"  name="id_lapsoxxx"  value="1°">
          ...
          <button type="submit" name="imp_carta_resumen" id="imp_carta_resumen" class="btn btn-warning mr-1 mb-1 btn_sizes" > 
           <i class="far fa-surprise fa-lg"></i>&nbsp;&nbsp; "Oficio"</button>   
...
<div class="mr-1" data-toggle="tooltip" data-placement="top" title="2° - Actividades Aplazadas"  <?php if ($_SESSION ['cargo'] == 'Profesor' ){?>style="display:none"<?php } ?> >
 ...
 <form target="_blank" action="zzz_impresiones/resumen_de_actividades_alte_apla.php" method="POST">
    ...
    <input type="hidden" id="id_lapsoxxx"  name="id_lapsoxxx"  value="2°">
          ...
          <button type="submit" name="imp_carta_resumen" id="imp_carta_resumen" class="btn btn-warning mr-1 mb-1 btn_sizes" >
           <i class="far fa-frown-open fa-lg"></i>&nbsp;&nbsp; "Oficio"</button> 

</form> </div>

 

<div class="mr-1" data-toggle="tooltip" data-placement="top" title="3° - Actividades Aplazadas"  <?php if ($_SESSION ['cargo'] == 'Profesor' ){?>style="display:none"<?php } ?> >
 ...
 <form target="_blank" action="zzz_impresiones/resumen_de_actividades_alte_apla.php" method="POST">
    ...
    <input type="hidden" id="id_lapsoxxx"  name="id_lapsoxxx"  value="3°">
          ...
          <button type="submit" name="imp_carta_resumen" id="imp_carta_resumen" class="btn btn-warning mr-1 mb-1 btn_sizes" >
           <i class="far fa-tired fa-lg"></i>&nbsp;&nbsp; "Oficio"</button>   
...
if ($row_datos_controlasign['a_convertir']==4) {
  $a_convertir = 'Cua. - Corregir el error!';  
}
?>
...
if ($row_datos_controlasign['b_convertir']==4) {
  $b_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['c_convertir']==4) {
  $c_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['d_convertir']==4) {
  $d_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['e_convertir']==4) {
  $e_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['f_convertir']==4) {
  $f_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['g_convertir']==4) {
  $g_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['h_convertir']==4) {
  $h_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
...
if ($row_datos_controlasign['i_convertir']==4) {
  $i_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['j_convertir']==4) {
  $j_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['k_convertir']==4) {
  $k_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['l_convertir']==4) {
  $l_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['m_convertir']==4) {
  $m_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
...
if ($row_datos_controlasign['n_convertir']==4) {
  $n_convertir = 'Cua. - Corregir el error, seleccionar la opción correcta.';  
}
?>
