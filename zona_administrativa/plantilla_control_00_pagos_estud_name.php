...
if(isset($_POST['buscalo_name_alu']))
    {



if (strlen($_POST['buscar_name_alu']) <=3 )  // no sea mayor a 40 caracteres
    ...
    header( "Location: plantilla_control_00_pagos_estud_name.php?ciclo=".$cicloJKL."&criterio=".$xxxsearch."&alertin=5" ); 
...
$busqueda = $_POST['buscar_name_alu'];
...
$query_bus = "SELECT * FROM  reg_estudiantes, reg_estu_actual                        
         ...
         GROUP BY reg_estudiantes.id_estud ORDER BY reg_estudiantes.nombre_estu ASC" ;
...
mysqli_close($enlace); 
      ...
      if ($totalRows_datos_plantilla_bus == '0') {
        ...
        $xxxsearch = "xxxxxx";
         ...
         header( "Location: plantilla_control_00_pagos_estud_name.php?ciclo=".$cicloJKL."&criterio=".$xxxsearch."&alertin=55" ); 
      ...
      if ($totalRows_datos_plantilla_bus >= '1' && $totalRows_datos_plantilla_bus <= '5' ) {
        ...
        header( "Location: plantilla_control_00_pagos_estud_name.php?alertin=100&ciclo=".$cicloJKL."&criterio=".$busqueda."" );
        ...
        $xxxsearch = "xxxxxx";
         ...
         header( "Location: plantilla_control_00_pagos_estud_name.php?ciclo=".$cicloJKL."&criterio=".$xxxsearch."&alertin=99" ); 
...
$query = "SELECT * FROM  reg_estudiantes, obs_estu, reg_estu_actual                        
         ...
         and reg_estudiantes.nombre_estu LIKE '%".$consul."%'         
...
<form method="POST">
            ...
            <input type="text" class="form-control" name="buscar_name_alu" placeholder="Ingrese el nombre del alumno..." aria-label="">
            <div class="input-group-append">
              <button type="submit" name="buscalo_name_alu" class="btn btn-success"><i style="color:white;"><i class="fas fa-chevron-circle-right fa-lg "></i></i></button>
            </div>
...
<div class="form-row mb-3" style="display:<?php echo $show_div; ?> " >   
 ...
 <b><a href="plantilla_control_00_pagos_estud_name.php?ciclo=<?php echo $el_id_del_periodo_viejo;?>&alertin=100&criterio=<?php echo $consul;  ?>"><i class="fas fa-hand-holding-usd fa-lg"></i>&nbsp; "Revisar"</a></b>
...
<div class="<?php echo $el_col_es; ?>" style='<?php echo $div_estado; ?>'> 
