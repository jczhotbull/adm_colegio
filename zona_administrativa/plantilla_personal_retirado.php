...
<?php include ("listas_imp_php/lista_plantilla_retirado.php "); ?>  <!-- hace la lista -->
...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <div class="form-row">
            ...
            <i><b>Laboraron en el plantel:</b> </i></div> 
...
<?php
echo $row_datos_plantilla['nombre_per'];?>, <?php echo $row_datos_plantilla['apellido_per'] ;?> 
"&nbsp; </b> Fue incorporado en el plantel el
 <?php
...
<div class="form-row">
<div class="input-group col-lg-12 mb-2">
 y fue desincorporado del plantel el
 <?php
 echo $fecha_formateada;
 ?>. 
</div>
