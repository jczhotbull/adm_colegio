...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal_global.php" method="POST">
...
<!--    <input type="hidden" id=""   name=""   value="">
  ...
  <div data-toggle="tooltip" data-placement="top" title="Lista con nombres" >
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal_vac_global.php" method="POST">
...
<!--    <input type="hidden" id=""   name=""   value="">
  ...
  <div data-toggle="tooltip" data-placement="top" title="Lista con datos extras" >

    <form target="_blank" action="zzz_impresiones/imp_lista_personal_vac_especial.php" method="POST">
...
<!--    <input type="hidden" id=""   name=""   value="">
    <input type="hidden" id=""   name=""   value="">  -->
          ...
          <button type="submit" name="imp_lista_del_personal_vac_especial" id="imp_lista_del_personal_vac_especial" class="btn btn-warning mr-1 mb-1 btn_sizes"  >
           <i class="fas fa-print"></i>&nbsp;&nbsp; "Especial"</button>
