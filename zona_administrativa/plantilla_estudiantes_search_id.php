...
if (strlen($_POST['buscar_estud']) <=2 )  // no sea mayor a 40 caracteres
    ...
    header( "Location: plantilla_estudiantes_search_id.php?ciclo=".$el_cicloXX."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=5" ); 
...
WHERE  reg_estu_actual.id_estud = reg_estudiantes.id_estud
      ...
      if ($totalRows_datos_plantilla_bus == '0') {
       ...
       header( "Location: plantilla_estudiantes_search_id.php?ciclo=".$el_cicloXX."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=55" );
      ...
      if ($totalRows_datos_plantilla_bus >= '1' and $totalRows_datos_plantilla_bus <= '16') {
        ...
        header( "Location: plantilla_estudiantes_search_id.php?ciclo=".$el_cicloXX."&tituloJKL=Resultados...&criterio=".$busqueda."&alertin=0" );
      ...
      if ($totalRows_datos_plantilla_bus >= '17') {
        ...
        header( "Location: plantilla_estudiantes_search_id.php?ciclo=".$el_cicloXX."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=1" ); 
...
<?php include ("listas_imp_php/lista_estudiantes_search_id.php"); ?>  <!-- ayuda a hacer el listado -->
...
<form method="POST">
            ...
            <input type="text" class="form-control" name="buscar_estud" placeholder="Ingrese el doc de Id ó Cedula Escolar..." aria-label="">
...
<?php include("plantilla_estudiantes_00_upd_ci_fot.php");   ?>
                ...
                if($row_datos_estudiantes['foto_estu'] !='') { 

                 echo $row_datos_estudiantes['foto_estu']; }

                 else {
                  $UUU = "../zz_fotos_p/ZZvacio5.jpg";
                  echo $UUU;
                  ...
                  alt="FOTO POR CARGAR"  onerror="this.src='../zz_fotos_p/ZZvacio5.jpg';" width="80px" />     </a>
...
foreach(glob($dir.''.$el_id_es.'_*.png') as $file) {
  ...
  if ($num < 18) {
    $num++;
    print $pre_comienzo.''.$file.''.$post_comienzo.''.$comienzo.''.$file.''.$final.''.$final_a. "\n&nbsp;";
...
<!-- cierre de aaa -->
        ...
        <div class="card-footer text-muted"><b>Info:</b> Puede incorporar, modificar he imprimir datos, así como retirar de la lista a un estudiante.
        <div class="text-muted">Los apellidos, precedidos del icono&nbsp;&nbsp;<span style="color:orange;"><i class="far fa-lightbulb fa-lg"></i></span>&nbsp;&nbsp;
        son indicativos, de que el alumno ha sido pre-inscrito por su representante.</div>
      <p class="text-primary"><b>Nota:</b> En esta página se pueden descargar fácilmente las fotos del o los estudiantes, haciendo clic sobre la foto deseada.</p>
