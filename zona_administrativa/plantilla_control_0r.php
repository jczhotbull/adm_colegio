...
<?php include ("listas_imp_php/lista_control_ret.php"); ?>  <!-- ayuda a hacer el listado -->
...
$reg_estu_HOYx = "SELECT * FROM  edades, grados, secciones, reg_estu_actual  
...
<?php  if ( $r_d_reg_sobreD['proviene_de_otro'] == '1' && $el_totalpptt =='1') {
      $flechin = '<span style="color:limegreen;"><b>Provenía de:</b></span><br>'  ;
      echo $flechin;
    ...
    <?php  
      $flechinda = '<br><span style="color:#FF8F00;"><b>Cursaba:</b></span><br>'  ;
      echo $flechinda;
      echo "<b>";
      echo $r_d_reg_estu_HOYx['nombre_grados'];
      echo "</b>  - <b>";
      echo $r_d_reg_estu_HOYx['nombre_seccion'];
       echo "<b>";
...
<!-- cierre modal editar -->
                      ...
                      data-target="#borrar<?php echo $row_datos_control['id_estud']; ?>">
...
<div class="modal fade" id="borrar<?php echo $row_datos_control['id_estud']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        El Alumno <b>" <?php echo $row_datos_control['nombre_estu'];?>, <?php echo $row_datos_control['apellidos_estu'];?> "</b> con expediente N°: <?php echo $row_datos_control['estu_expediente'];?>, quedará fuera del sistema.
...
<br><br><br>
  ...
  <form method="post">
    ...
    value="<?php echo $row_datos_control['id_estud']; ?>" > Eliminar</button>
...
<!-- *****   -->
    ...
    <div class="card-footer text-muted"><b>Info:</b> Puede re-incorporar alumnos, mover entre secciones, acomodar apellidos y nombres he incluso remover al alumno por completo del sistema.</div> 
