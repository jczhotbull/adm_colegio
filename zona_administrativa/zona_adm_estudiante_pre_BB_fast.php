...
$num_cedula = mysqli_real_escape_string($enlace,$_POST['cedula']);
			...
			$mod_email_estu_act2 = 'colegio@colegio.col';
			
$mod_se_retira_con_act2 = 'actualizar';
    $mod_control_med_act2 = '.';
    $v_otra_act2 = '.';

    $v1_act2 = 'No';  $v2_act2 = 'No';  $v3_act2 = 'No';  $v4_act2 = 'No';
    $v5_act2 = 'No';  $v6_act2 = 'No';  $v7_act2 = 'No';  $v8_act2 = 'No';
    $v9_act2 = 'No';  $v10_act2 = 'No';  $v11_act2 = 'No';  $v12_act2 = 'No';
    $v13_act2 = 'No';  $v14_act2 = 'No';  $v15_act2 = 'No'; 

  	$mod_medicamentos_act2 = '.';	
...
$query_ES_BB = "INSERT INTO reg_estudiantes(estu_expediente, nombre_estu, apellidos_estu, nacimiento_estu, id_sexo, id_ciudad,
							...
							VALUES (   '".mysqli_real_escape_string($enlace,$_POST['expediente_est2'])."'          ,
									   ...
									   '".mysqli_real_escape_string($enlace,$_POST['cedula_est2'])."'          ,									   
										...
										'$padece_act2', '$sangre_act2', '$mod_email_estu_act2',  'actualizar'    ,
...
$query_ES_BB_act = "INSERT INTO reg_estu_actual(id_estud, id_reg_pagos, cursa_actualmente, grado_actual, repite_actual, 
				...
				if (!mysqli_query($enlace,$query_ES_BB_obs))  // si no logro ingresar las observaciones del estudiante 1
				            ...
				            {   // en caso de que logre guardar las obs del estudiante 1
								...
								$obs_success2="<i class=\"fas fa-check-circle fa-lg\"></i>";
											...
											$exitoZ.="- &nbsp;
														<i data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"N°2 ha sido Pre-Inscrito sin foto.\">
											...
											$mostrar_form = 'none';
										    	...
										    	$exitoZ.="- &nbsp;
														<i data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"N°2 ha sido Pre-Inscrito con foto.\">
