...
$queryGG = "SELECT * FROM plantilla_contratados, plantilla_personal, sexo, divisiones, grados, areas_all, plantilla_areas
         ...
         WHERE  plantilla_contratados.id_per = plantilla_personal.id_per
            ...
            and plantilla_areas.id_ramas = '$consul'
            and status = '1'            

            GROUP BY ci_per ORDER BY nombre_per ASC ";

$datos_plantilla = mysqli_query($enlace, $queryGG) or die(mysqli_error());
