...
$query = "SELECT * FROM plantilla_contratados, plantilla_personal
         ...
         and plantilla_contratados.status = '1'                
            ...
            and  plantilla_personal.nombre_per LIKE  '%".$consulHJK."%'   
            GROUP by plantilla_personal.nombre_per ";
              ...
              <tbody>
                ...
                <tr>
                   ...
                   <td class="align-middle" align="center"><?php echo $row_datos_plantilla['nombre_per'];  ?>, <br>
                                                             <?php   echo " " .$row_datos_plantilla['apellido_per'];  $id_perx = $row_datos_plantilla['id_per'];

                                                      include("../conectar.php");

                                                      $queryCCC =       "SELECT id_contrato FROM plantilla_contratados where id_per = '$id_perx' LIMIT 1 ";

                                                      $datos_CCC = mysqli_query($enlace, $queryCCC) or die(mysqli_error());

                                                      $row_datos_CCC = mysqli_fetch_array($datos_CCC); 

                                                      $id_contratox = $row_datos_CCC['id_contrato'];




$query_recursos = "SELECT * FROM plantilla_contratados, plantilla_personal
...
$datos_recursos = mysqli_query($enlace, $query_recursos) or die(mysqli_error());

$row_datos_recursos = mysqli_fetch_array($datos_recursos);   
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <?php include("plantilla_personal_00_mod_search.php"); ?>
...
<div class="form-row">  
   ...
   <div class="col-lg-6">
                    <?php if ($row_datos_recursos['status']=='1') { ?>
                    ...
                    <?php if ($row_datos_recursos['status']=='0') { ?>
