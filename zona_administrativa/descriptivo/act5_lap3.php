...
$el_id_del_es = $row_datos_control_notas_descc["d_35"];
...
?>
 ...
 <select class="form-control form-control-sm" id="EC<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="SS_L3-D5[]" form="save_L3_N5" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="SS_L3-N5[]" name="SS_L3-N5[]" form="save_L3_N5" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_35"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_35"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_35 = $row_datos_control_notas_descc["nt_35"];
$english_f = number_format($la_nt_35, 0, '.', '');
