...
$el_id_del_es = $row_datos_control_notas_descc["d_14"];
...
?>
 ...
 <select class="form-control form-control-sm" id="DA<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="DD_L1-D4[]" form="save_L1_N4" >
...
?>
 ...
 <select class="form-control form-control-sm" id="DD_L1-N4[]" name="DD_L1-N4[]" form="save_L1_N4"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_14"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_14"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_14 = $row_datos_control_notas_descc["nt_14"];
$english_f = number_format($la_nt_14, 0, '.', '');
