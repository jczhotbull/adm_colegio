...
$el_id_del_es = $row_datos_control_notas_descc["d_16"];
...
?>
 ...
 <select class="form-control form-control-sm" id="FA<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="FF_L1-D6[]" form="save_L1_N6" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="FF_L1-N6[]" name="FF_L1-N6[]" form="save_L1_N6" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_16"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_16"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_16 = $row_datos_control_notas_descc["nt_16"];
$english_f = number_format($la_nt_16, 0, '.', '');
