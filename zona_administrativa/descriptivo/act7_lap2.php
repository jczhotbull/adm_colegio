...
<?php  if ( $row_datos_control_descc['retirado_si_o_no'] == '1') {
      $resultiNN = '<b><span style="color:purple;"> -"RET"</span></b>'; 
      echo $resultiNN;
    }   ?>
...
$el_id_del_es = $row_datos_control_notas_descc["d_27"];
...
?>
 ...
 <select class="form-control form-control-sm" id="GB<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="NN_L2-D7[]" form="save_L2_N7" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="NN_L2-N7[]" name="NN_L2-N7[]" form="save_L2_N7" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_27"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_27"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_27 = $row_datos_control_notas_descc["nt_27"];
$english_f = number_format($la_nt_27, 0, '.', '');
