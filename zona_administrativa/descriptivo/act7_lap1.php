...
$el_id_del_es = $row_datos_control_notas_descc["d_17"];
...
?>
 ...
 <select class="form-control form-control-sm" id="GA<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="GG_L1-D7[]" form="save_L1_N7" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="GG_L1-N7[]" name="GG_L1-N7[]" form="save_L1_N7" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_17"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_17"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_17 = $row_datos_control_notas_descc["nt_17"];
$english_f = number_format($la_nt_17, 0, '.', '');
