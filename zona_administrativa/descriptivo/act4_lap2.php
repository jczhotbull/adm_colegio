...
<?php  if ( $row_datos_control_descc['retirado_si_o_no'] == '1') {
      $resultiKK = '<b><span style="color:purple;"> -"RET"</span></b>'; 
      echo $resultiKK;
    }   ?>
...
$el_id_del_es = $row_datos_control_notas_descc["d_24"];
...
?>
 ...
 <select class="form-control form-control-sm" id="DB<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="KK_L2-D4[]" form="save_L2_N4" >
...
?>
 ...
 <select class="form-control form-control-sm" id="KK_L2-N4[]" name="KK_L2-N4[]" form="save_L2_N4"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_24"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_24"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_24 = $row_datos_control_notas_descc["nt_24"];
$english_f = number_format($la_nt_24, 0, '.', '');
