...
$el_id_del_es = $row_datos_control_notas_descc["d_13"];
...
?>
 ...
 <select class="form-control form-control-sm" id="CA<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="CC_L1-D3[]" form="save_L1_N3" >
...
?>
 ...
 <select class="form-control form-control-sm" id="CC_L1-N3[]" name="CC_L1-N3[]" form="save_L1_N3" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_13"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_13"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_13 = $row_datos_control_notas_descc["nt_13"];
$english_f = number_format($la_nt_13, 0, '.', '');
