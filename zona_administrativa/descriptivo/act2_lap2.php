...
<?php  if ( $row_datos_control_descc['retirado_si_o_no'] == '1') {
      $resultiII = '<b><span style="color:purple;"> -"RET"</span></b>'; 
      echo $resultiII;
    }   ?>
...
$el_id_del_es = $row_datos_control_notas_descc["d_22"];
...
?>
 ...
 <select class="form-control form-control-sm" id="BB<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="II_L2-D2[]" form="save_L2_N2" >
...
?>
 ...
 <select class="form-control form-control-sm" id="II_L2-N2[]" name="II_L2-N2[]" form="save_L2_N2"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_22"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_22"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_22 = $row_datos_control_notas_descc["nt_22"];
$english_f = number_format($la_nt_22, 0, '.', '');
