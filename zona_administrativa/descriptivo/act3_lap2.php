...
<?php  if ( $row_datos_control_descc['retirado_si_o_no'] == '1') {
      $resultiJJ = '<b><span style="color:purple;"> -"RET"</span></b>'; 
      echo $resultiJJ;
    }   ?>
...
$el_id_del_es = $row_datos_control_notas_descc["d_23"];
...
?>
 ...
 <select class="form-control form-control-sm" id="CB<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="JJ_L2-D3[]" form="save_L2_N3" >
...
?>
 ...
 <select class="form-control form-control-sm" id="JJ_L2-N3[]" name="JJ_L2-N3[]" form="save_L2_N3"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_23"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_23"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_23 = $row_datos_control_notas_descc["nt_23"];
$english_f = number_format($la_nt_23, 0, '.', '');
