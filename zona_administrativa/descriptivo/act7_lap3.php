...
$el_id_del_es = $row_datos_control_notas_descc["d_37"];
...
?>
 ...
 <select class="form-control form-control-sm" id="GC<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="UU_L3-D7[]" form="save_L3_N7" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="UU_L3-N7[]" name="UU_L3-N7[]" form="save_L3_N7" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_37"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_37"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_37 = $row_datos_control_notas_descc["nt_37"];
$english_f = number_format($la_nt_37, 0, '.', '');
