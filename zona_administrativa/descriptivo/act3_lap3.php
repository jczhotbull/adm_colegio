...
$el_id_del_es = $row_datos_control_notas_descc["d_33"];
...
?>
 ...
 <select class="form-control form-control-sm" id="CC<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="QQ_L3-D3[]" form="save_L3_N3" >
...
?>
 ...
 <select class="form-control form-control-sm" id="QQ_L3-N3[]" name="QQ_L3-N3[]" form="save_L3_N3"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_33"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_33"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_33 = $row_datos_control_notas_descc["nt_33"];
$english_f = number_format($la_nt_33, 0, '.', '');
