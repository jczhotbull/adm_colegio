...
<?php  if ( $row_datos_control_descc['retirado_si_o_no'] == '1') {
      $resultiHH = '<b><span style="color:purple;"> -"RET"</span></b>'; 
      echo $resultiHH;
    }   ?>
...
$el_id_del_es = $row_datos_control_notas_descc["d_21"];
...
?>
 ...
 <select class="form-control form-control-sm" id="AB<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="HH_L2-D1[]" form="save_L2_N1" >
...
$query2_ultraA = "SELECT * FROM plantilla_indicadores where ind_materia = '$suso' and (en_lapso = '2°' OR en_lapso = 'Todos') ORDER BY ind_desc ASC";
...
?>   	
 ...
 <select class="form-control form-control-sm" id="HH_L2-N1[]" name="HH_L2-N1[]" form="save_L2_N1"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_21"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_21"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_21 = $row_datos_control_notas_descc["nt_21"];
$english_f = number_format($la_nt_21, 0, '.', '');
