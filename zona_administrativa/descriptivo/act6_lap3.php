...
$el_id_del_es = $row_datos_control_notas_descc["d_36"];
...
?>
 ...
 <select class="form-control form-control-sm" id="FC<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="TT_L3-D6[]" form="save_L3_N6" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="TT_L3-N6[]" name="TT_L3-N6[]" form="save_L3_N6" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_36"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_36"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_36 = $row_datos_control_notas_descc["nt_36"];
$english_f = number_format($la_nt_36, 0, '.', '');
