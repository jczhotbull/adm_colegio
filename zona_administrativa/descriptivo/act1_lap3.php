...
$el_id_del_es = $row_datos_control_notas_descc["d_31"];
...
?>
 ...
 <select class="form-control form-control-sm" id="AC<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="OO_L3-D1[]" form="save_L3_N1" >
...
?>
 ...
 <select class="form-control form-control-sm" id="OO_L3-N1[]" name="OO_L3-N1[]" form="save_L3_N1"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_31"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_31"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_31 = $row_datos_control_notas_descc["nt_31"];
$english_f = number_format($la_nt_31, 0, '.', '');
