...
<?php  if ( $row_datos_control_descc['retirado_si_o_no'] == '1') {
      $resultiLL = '<b><span style="color:purple;"> -"RET"</span></b>'; 
      echo $resultiLL;
    }   ?>
...
$el_id_del_es = $row_datos_control_notas_descc["d_25"];
...
?>
 ...
 <select class="form-control form-control-sm" id="EB<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="LL_L2-D5[]" form="save_L2_N5" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="LL_L2-N5[]" name="LL_L2-N5[]" form="save_L2_N5" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_25"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_25"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_25 = $row_datos_control_notas_descc["nt_25"];
$english_f = number_format($la_nt_25, 0, '.', '');
