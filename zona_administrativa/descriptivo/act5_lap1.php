...
$el_id_del_es = $row_datos_control_notas_descc["d_15"];
...
?>
 ...
 <select class="form-control form-control-sm" id="EA<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="EE_L1-D5[]" form="save_L1_N5" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="EE_L1-N5[]" name="EE_L1-N5[]" form="save_L1_N5" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_15"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_15"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_15 = $row_datos_control_notas_descc["nt_15"];
$english_f = number_format($la_nt_15, 0, '.', '');
