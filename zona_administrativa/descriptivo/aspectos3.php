...
<table class="table table-sm table-bordered">
  <thead>
    ...
    <tr>
      ...
      <th style="background-color: #F7E8DA; " scope="col">1</th>
      <th scope="col">2</th>
      <th style="background-color: #F7E8DA; "  scope="col">3</th>
      <th scope="col">4</th>
      <th style="background-color: #F7E8DA; "  scope="col">5</th>
      <th scope="col">6</th>
      <th  style="background-color: #F7E8DA; " scope="col">7</th>
...
$el_id_del_es = $row_datos_control_notas_descc["asp_3"];
...
<td style="background-color: #F7E8DA; " align="center">
<?php echo $row_datos_control_notas_descc["nt_31"]; ?>
</td>


<td align="center">
<?php echo $row_datos_control_notas_descc["nt_32"]; ?>
</td>

<td  style="background-color: #F7E8DA; " align="center">
<?php echo $row_datos_control_notas_descc["nt_33"]; ?>
</td>

<td align="center">
<?php echo $row_datos_control_notas_descc["nt_34"]; ?>
</td>

<td  style="background-color: #F7E8DA; " align="center">
<?php echo $row_datos_control_notas_descc["nt_35"]; ?>
</td>


<td align="center">
<?php echo $row_datos_control_notas_descc["nt_36"]; ?>
</td>


<td  style="background-color: #F7E8DA; " align="center">
<?php echo $row_datos_control_notas_descc["nt_37"]; ?>
</td>
 ...
 <select class="form-control form-control-sm" id="AA_L3-Asp3[]" name="AA_L3-Asp3[]" form="save_aspectos_L3" >
...
$query2_ultraA = "SELECT * FROM plantilla_reforzar where ind_materiax = '$suso' and (este_lapso = '3°' OR este_lapso = 'Todos') ORDER BY ind_refuerza ASC";
