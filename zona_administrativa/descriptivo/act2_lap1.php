...
<div class="form-row col-md-12 col-lg-12">
          ...
          <div class="input-group  mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text alert-success" id="basic-addon1"><i>Duplicar <b>tras guardar la "primera"</b> descripción de actividad, aprendizaje, contenido u objetivo a lograr en el resto del grupo?</i></span>  
                    </div>

<select class="form-control" id="selecc_copy" name="selecc_copy" form="save_L1_N2">
  

<option value="No" selected>No duplicar</option>
<option value="Si">Si duplicar</option>
...
$el_id_del_es = $row_datos_control_notas_descc["d_12"];
...
?>
 ...
 <select class="form-control form-control-sm" id="BA<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="BB_L1-D2[]" form="save_L1_N2" >
...
?>  	
 ...
 <select class="form-control form-control-sm" id="BB_L1-N2[]" name="BB_L1-N2[]" form="save_L1_N2"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_12"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_12"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_12 = $row_datos_control_notas_descc["nt_12"];
$english_f = number_format($la_nt_12, 0, '.', '');
