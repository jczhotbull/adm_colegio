...
<?php  if ( $row_datos_control_descc['retirado_si_o_no'] == '1') {
      $resultiPP = '<b><span style="color:purple;"> -"RET"</span></b>'; 
      echo $resultiPP;
    }   ?>
...
$el_id_del_es = $row_datos_control_notas_descc["d_32"];
...
?>
 ...
 <select class="form-control form-control-sm" id="BC<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="PP_L3-D2[]" form="save_L3_N2" >
...
?>	
 ...
 <select class="form-control form-control-sm" id="PP_L3-N2[]" name="PP_L3-N2[]" form="save_L3_N2"  > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_32"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_32"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_32 = $row_datos_control_notas_descc["nt_32"];
$english_f = number_format($la_nt_32, 0, '.', '');
