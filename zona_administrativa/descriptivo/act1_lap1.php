...
$alerta_imp = '<b>Info:</b> Si el listado se muestra incompleto, <b>confirmar</b> que se hubiera seleccionado correctamente el sistema de evaluación en esta, área, asignatura o materia.';
$alerta_ccc = '<b>Actividades, contenidos u objetivos no realizados o presentados:</b> Dejar en blanco la calificación y el sistema le asignara  la nomenclatura correspondiente.';

$alerta_fff = '<b>Calificaciones:</b> No se podrá colocar una calificación / valoración a un estudiante, hasta que ha dicho estudiante le sea guardada una actividad y/o contenido.';
...
$el_id_del_es = $row_datos_control_notas_descc["d_11"];
...
<script type="text/javascript">
 ...
 <select class="form-control form-control-sm" id="AA<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="AA_L1-D1[]" form="save_L1_N1" >
...
<option disabled value=""></option>  
                                <option disabled value="">Descripción del Aprendizaje para <?php echo $suso; ?>  <!-- :<?php echo $rrtt; ?> --></option>
...
$query2_ultraA = "SELECT * FROM plantilla_indicadores where ind_materia = '$suso' and (en_lapso = '1°' OR en_lapso = 'Todos') ORDER BY ind_desc ASC";
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="AA_L1-N1[]" name="AA_L1-N1[]" form="save_L1_N1"    > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_11"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_11"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_11 = $row_datos_control_notas_descc["nt_11"];
$english_f = number_format($la_nt_11, 0, '.', '');
