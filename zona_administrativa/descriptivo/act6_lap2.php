...
<?php  if ( $row_datos_control_descc['retirado_si_o_no'] == '1') {
      $resultiMM = '<b><span style="color:purple;"> -"RET"</span></b>'; 
      echo $resultiMM;
    }   ?>
...
$el_id_del_es = $row_datos_control_notas_descc["d_26"];
...
?>
 ...
 <select class="form-control form-control-sm" id="FB<?php echo $rrtt; $rrtt = $rrtt+1; ?>" name="MM_L2-D6[]" form="save_L2_N6" >
...
if ($row_datos_control_indicador["id_indicador"] == '') {
 ...
 <select class="form-control form-control-sm" id="MM_L2-N6[]" name="MM_L2-N6[]" form="save_L2_N6" > 
                              
<option selected value="<?php echo $row_datos_control_notas_descc["nt_26"]; ?>">
<?php
 include("../../conectar.php");
if ($row_datos_control_notas_descc["nt_26"] == '') {
    $nay = '';
   echo $nay;
}

else {
$la_nt_26 = $row_datos_control_notas_descc["nt_26"];
$english_f = number_format($la_nt_26, 0, '.', '');
