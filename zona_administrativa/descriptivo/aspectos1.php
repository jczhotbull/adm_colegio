...
<table class="table table-sm table-bordered">
  <thead>
    ...
    <tr>
      ...
      <th style="background-color: #D7FBCC; " scope="col">1</th>
      <th scope="col">2</th>
      <th style="background-color: #D7FBCC; " scope="col">3</th>
      <th scope="col">4</th>
      <th style="background-color: #D7FBCC; " scope="col">5</th>
      <th scope="col">6</th>
      <th style="background-color: #D7FBCC; " scope="col">7</th>
...
$el_id_del_es = $row_datos_control_notas_descc["asp_1"];
...
<td style="background-color: #D7FBCC; " align="center">
<?php echo $row_datos_control_notas_descc["nt_11"]; ?>
</td>


<td align="center">
<?php echo $row_datos_control_notas_descc["nt_12"]; ?>
</td>

<td style="background-color: #D7FBCC; "  align="center">
<?php echo $row_datos_control_notas_descc["nt_13"]; ?>
</td>

<td align="center">
<?php echo $row_datos_control_notas_descc["nt_14"]; ?>
</td>

<td style="background-color: #D7FBCC; " align="center">
<?php echo $row_datos_control_notas_descc["nt_15"]; ?>
</td>


<td align="center">
<?php echo $row_datos_control_notas_descc["nt_16"]; ?>
</td>


<td style="background-color: #D7FBCC; " align="center">
<?php echo $row_datos_control_notas_descc["nt_17"]; ?>
</td>
 ...
 <select class="form-control form-control-sm" id="AA_L1-Asp1[]" name="AA_L1-Asp1[]" form="save_aspectos_L1" >
...
$query2_ultraA = "SELECT * FROM plantilla_reforzar where ind_materiax = '$suso' and (este_lapso = '1°' OR este_lapso = 'Todos') ORDER BY ind_refuerza ASC";
