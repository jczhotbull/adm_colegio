...
<select class="form-control" id="GAsource" name="selecc_copy_new" >
...
$query2_ultraAZZ = "SELECT * FROM plantilla_indicadores where ind_materia = '$suso_ee' and (en_lapso = '1°' OR en_lapso = 'Todos') ORDER BY ind_desc ASC";
