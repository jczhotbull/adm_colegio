		  ...
		  if (empty($_POST['titulo3']) )      // si esta vacío
			...
			if (!mysqli_query($enlace,$query_q))      // si no ha logrado ingresar los datos
				...
				else     // etapa de creacion del contrato.
				{
            	 ...
            	 $query_vida = "INSERT INTO vida_prof(id_per, fecha_vida, plantel_vida, edad_privados, edad_oficiales)   
			...
			VALUES     ('$trab_act', '$plantel_a', '".mysqli_real_escape_string($enlace,$_POST['names_planteles_a'])."', '$asignatura_otro_a', '$grado_otro_a', '$per_id'),
					   ...
					   ('$trab_act', '$plantel_d', '".mysqli_real_escape_string($enlace,$_POST['names_planteles_d'])."', '$asignatura_otro_d', '$grado_otro_d', '$per_id')								  
		                ...
		                $query_obs = "INSERT INTO obs_per(obs_per, id_per)   

						VALUES ('$obs_text', '$per_id')";  
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">Centre, simulando una foto carnet, haga clic en guardar y luego en actualizar.</h5>
      		...
      		<div class="col-md-12">
      			...
      			<div class="col-md-12 mt-1 card border-info divXXheight">
      				...
      				<div class="mt-2">
      				 ...
      				 <button class="btn btn-success cropImageBtn_A" id="cropImageBtn_A">Recortar</button>
...
<b class="text-success"> <i class="fas fa-check"></i>&nbsp;&nbsp;Imagen cargada</b>; click en <b class="text-primary">"Actualizar"</b> para confirmar.
 ...
 <div class="modal-footer">
       ...
       <button type="submit" name="submit" class="btn btn-primary " id="update22" disabled>Actualizar</button>
...
<div class="modal fade"  id="cropImagePop_B" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">Centre el documento de identidad, haga clic en guardar y luego en actualizar.</h5>
<!--        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>  -->
      </div>
      ...
      <div class="col-md-12 mt-1 card border-info divXXheight">   
  					...
  					<button class="btn btn-success cropImageBtn_B" id="cropImageBtn_B">Recortar</button>	
...
<b class="text-success"> <i class="fas fa-check"></i>&nbsp;&nbsp;Imagen cargada</b>; click en <b class="text-primary">"Actualizar"</b> para confirmar.
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="submit" class="btn btn-primary " id="update44" disabled>Actualizar</button>
...
<form method="POST" name="ingresar_personal">   
...
<input type="text" class="form-control" id="plantel_ini" name="plantel_ini" placeholder="Nombre del plantel..." aria-label="nombres" aria-describedby="basic-addon1" >
							  </div>
