...
$var_cedula_estudianteAA = $_POST["cedula_est1"];
			...
			$mod_email_estu = 'colegio@colegio.col';


		$mod_se_retira_con = 'actualizar';
 		$mod_control_med = '.';
 		$v_otra = '.';

 		$v1 = 'No';  $v2 = 'No';  $v3 = 'No';  $v4 = 'No';
 		$v5 = 'No';  $v6 = 'No';  $v7 = 'No';  $v8 = 'No';
 		$v9 = 'No';  $v10 = 'No';  $v11 = 'No';  $v12 = 'No';
 		$v13 = 'No';  $v14 = 'No';  $v15 = 'No';	
...
$query_ES_AA = "INSERT INTO reg_estudiantes(estu_expediente, nombre_estu, apellidos_estu, nacimiento_estu, id_sexo, id_ciudad,
							...
							VALUES (   '".mysqli_real_escape_string($enlace,$_POST['expediente_est1'])."'          ,
									   ...
									   '".mysqli_real_escape_string($enlace,$_POST['cedula_est1'])."'          ,									   
										...
										'$padece_act1', '$sangre_act1', '$mod_email_estu', 'actualizar'  ,
				...
				if (!mysqli_query($enlace,$query_ES_AA_obs))  // si no logro ingresar las observaciones del estudiante 1
				            ...
				            {   // en caso de que logre guardar las obs del estudiante 1
								...
								$obs_success1="<i class=\"fas fa-check-circle fa-lg\"></i>";
											...
											$exitoZ.="- &nbsp; Representado, Pre-Inscrito. &nbsp;&nbsp; <i class=\"fas fa-user-check fa-lg\"></i> &nbsp; &nbsp; &nbsp; &nbsp;
							<b><a href=\"plantilla_representantes_pagos_ci_el.php?tituloJKL=Historial&ciclo=".$cursa_est1."&alertin=100&criterio=".$var_cedula_re."\"><i class=\"fas fa-link\"></i> Agendar Pagos!</a></b>		 ";  
