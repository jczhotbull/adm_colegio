...
if ($R_resultadin == '1' or $R_resultadin == '5' ) {
...
$sql_ytr = "INSERT INTO documentos_solicitados (id_doc_sol, id_estud, estudio, status_estu, fecha_soli)
                  
                  VALUES ( '$id_del_reg', '$id_estud', '1', '1', NOW() )

                  ON DUPLICATE KEY

                  UPDATE estudio = '1', status_estu = '1', fecha_soli = '$fecha'  ";
                        ...
                        $exitoZ.="- &nbsp;La constancia de &nbsp;<b>Estudio</b>&nbsp; ha sido agendada. &nbsp; <i class=\"fas fa-exchange-alt fa-lg\"></i> &nbsp ";
                       mysqli_close($enlace);
...
$sql_ytr = "INSERT INTO documentos_solicitados (id_doc_sol, id_estud, retiro, status_ret, fecha_soli)
                  
                  VALUES ( '$id_del_reg', '$id_estud', '1', '1', NOW() )

                  ON DUPLICATE KEY

                  UPDATE retiro = '1', status_ret = '1', fecha_soli = '$fecha'  ";
                        ...
                        $exitoZ.="- &nbsp;La constancia de &nbsp;<b>Retiro</b>&nbsp; ha sido agendada. &nbsp; <i class=\"fas fa-exchange-alt fa-lg\"></i> &nbsp ";
                       mysqli_close($enlace);
...
$sql_ytr = "INSERT INTO documentos_solicitados (id_doc_sol, id_estud, inscripcion, status_ins, fecha_soli)
                  
                  VALUES ( '$id_del_reg', '$id_estud', '1', '1', NOW() )

                  ON DUPLICATE KEY

                  UPDATE inscripcion = '1', status_ins = '1', fecha_soli = '$fecha'  ";
                        ...
                        $exitoZ.="- &nbsp;La constancia de &nbsp;<b>Inscripción</b>&nbsp; ha sido agendada. &nbsp; <i class=\"fas fa-exchange-alt fa-lg\"></i> &nbsp ";
                       mysqli_close($enlace);
...
$sql_ytr = "INSERT INTO documentos_solicitados (id_doc_sol, id_estud, aceptacion, status_acep, fecha_soli)
                  
                  VALUES ( '$id_del_reg', '$id_estud', '1', '1', NOW() )

                  ON DUPLICATE KEY

                  UPDATE aceptacion = '1', status_acep = '1', fecha_soli = '$fecha'  ";
                        ...
                        $exitoZ.="- &nbsp;La constancia de &nbsp;<b>Aceptación</b>&nbsp; ha sido agendada. &nbsp; <i class=\"fas fa-exchange-alt fa-lg\"></i> &nbsp ";
                       mysqli_close($enlace);
...
<?php include ("../conectar.php"); ?>   <!--   necesario para poder listar -->
 ...
 <?php include ("listas_php/doc_soli_search.php"); ?>     <!-- ayuda a hacer el listado -->
...
<form method="POST">
          ...
          <div class="col-md-2 col-lg-2 mt-4 mb-1">
           ...
           <div class="col-md-4 col-lg-4 mt-4 mb-1 pr-1">
            
<a href="documentos_solicitados.php?alertin=0"><button type="button" class="btn btn-warning">Regresar a solicitudes realizadas... <i class="fas fa-undo fa-lg "></i></button></a>            
            ...
            <table class="table table-bordered table-sm table-hover" id="dataTable" width="100%" cellspacing="0"  >
              ...
              <thead>
                <tr>
                  ...
                  <th>Constancia - Estatus / Imprimir:</th>            
...
<div class="form-row mb-2">
                ...
                <div class="form-row col-lg-6"> <form target="_blank" action="zzz_impresiones/imp_const_estu.php" method="post">

 <span data-toggle="tooltip" data-placement="top" title="Agendar">
                 <button type="button" class="btn btn-success btn-sm" style="width:165px;" data-toggle="modal" data-target="#estudio<?php echo $row_datos_doc['id_estud']; ?>"
                  <?php if ($estatus_estu == " ' Impreso ' " or $estatus_estu == " ' En Proceso ' "){ ?> disabled <?php   } ?> >
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <i class="fas fa-info fa-lg"></i> &nbsp;¡Agendar Solicitud!</h5>
...
<!-- cierre modal editar -->
                ...
                <div class="form-row col-lg-6">
                  ...
                  <form target="_blank" action="zzz_impresiones/imp_const_ret_uno.php" method="post">
                 ...
                 <button type="button" class="btn btn-danger btn-sm" style="width:165px;" data-toggle="modal" data-target="#retiro<?php echo $row_datos_doc['id_estud']; ?>"
                   <?php if ($estatus_ret == " ' Impreso ' " or $estatus_ret == " ' En Proceso ' "){ ?> disabled <?php   } ?> >
                                            <!-- este ultimo identifica cual modal abrir -->
...
<span data-toggle="tooltip" data-placement="top" title="Constancia de retiro 1er Momento">
                 <button type="submit" name="print_ret" class="btn btn-outline-info btn-sm" >
                                            <i class="fas fa-print fa-lg"></i>
                 </button></span>
                 </form>&nbsp;
                   ...
                   <form target="_blank" action="zzz_impresiones/imp_const_ret_uno_y_dos.php" method="post">

                    <input type="hidden" id="id_estu"   name="id_estu"  value="<?php echo $row_datos_doc['id_estud']; ?>">
  
<span data-toggle="tooltip" data-placement="top" title="Constancia de retiro 1er y 2do Momento">
                 <button type="submit" name="print_ret" class="btn btn-outline-success btn-sm" >
                                            <i class="fas fa-print fa-lg"></i>
                 </button></span>
                 </form>&nbsp;
                   ...
                   <form target="_blank" action="zzz_impresiones/imp_const_ret.php" method="post">
           

                    <input type="hidden" id="id_estu"   name="id_estu"  value="<?php echo $row_datos_doc['id_estud']; ?>">
  

<span data-toggle="tooltip" data-placement="top" title="Constancia de retiro año completo">
...
<!-- cierre modal editar -->
    ...
    <div class="form-row mb-2">
                ...
                <div class="form-row col-lg-6"><form target="_blank" action="zzz_impresiones/imp_const_ins.php" method="post">
 ...
 <span data-toggle="tooltip" data-placement="top" title="Agendar">
                 <button type="button" class="btn btn-info btn-sm" style="width:165px;" data-toggle="modal" data-target="#inscripcion<?php echo $row_datos_doc['id_estud']; ?>"
                  <?php if ($estatus_ins == " ' Impreso ' " or $estatus_ins == " ' En Proceso ' " ){ ?> disabled <?php   } ?> >
                                            <!-- este ultimo identifica cual modal abrir -->
...
<!-- cierre modal editar -->
                ...
                <div class="form-row col-lg-6"> <form target="_blank" action="zzz_impresiones/imp_const_acep.php" method="post">
 ...
 <span data-toggle="tooltip" data-placement="top" title="Agendar">
                 <button type="button" class="btn btn-secondary btn-sm" style="width:165px;"  data-toggle="modal" data-target="#aceptacion<?php echo $row_datos_doc['id_estud']; ?>"
                  <?php if ($estatus_acep == " ' Impreso ' " or $estatus_acep == " ' En Proceso ' " ){ ?> disabled <?php   } ?> >
                                            <!-- este ultimo identifica cual modal abrir -->
