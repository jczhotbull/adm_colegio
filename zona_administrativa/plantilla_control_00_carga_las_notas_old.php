...
<h5 style="color:darkviolet;" class="ml-4  mt-3 mb-3"><b>!Sistema de Evaluación Procesual!</b> es necesario llevar un registro basado en porcentajes, para el correcto funcionamiento del programa.</h5>
...
$total_def_prom =number_format($total_def_un_dec);
 ...
 <form action="saves/saves_L1_N1.php" id="save_L1_N1" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L1_N2.php" id="save_L1_N2" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L1_N3.php" id="save_L1_N3" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L1_N4.php" id="save_L1_N4" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L1_N5.php" id="save_L1_N5" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L1_N6.php" id="save_L1_N6" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L1_N7.php" id="save_L1_N7" method="POST" autocomplete="off" >      
</form> 

 <form action="saves/saves_ZA_Au1.php" id="save_ZA_Au1" method="POST" autocomplete="off" >      
</form> 



 <form action="saves/saves_L2_N1.php"  id="save_L2_N1" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L2_N2.php"  id="save_L2_N2" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L2_N3.php"  id="save_L2_N3" method="POST" autocomplete="off" >      
</form> 
 <form  action="saves/saves_L2_N4.php" id="save_L2_N4" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L2_N5.php"  id="save_L2_N5" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L2_N6.php"  id="save_L2_N6" method="POST" autocomplete="off" >      
</form> 
 <form  action="saves/saves_L2_N7.php" id="save_L2_N7" method="POST" autocomplete="off" >      
</form> 

 <form action="saves/saves_ZB_Au2.php" id="save_ZB_Au2" method="POST" autocomplete="off" >      
</form> 




 <form action="saves/saves_L3_N1.php" id="save_L3_N1" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L3_N2.php" id="save_L3_N2" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L3_N3.php" id="save_L3_N3" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L3_N4.php" id="save_L3_N4" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L3_N5.php" id="save_L3_N5" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L3_N6.php" id="save_L3_N6" method="POST" autocomplete="off" >      
</form> 
 <form action="saves/saves_L3_N7.php" id="save_L3_N7" method="POST" autocomplete="off" >      
</form> 

 <form action="saves/saves_ZC_Au3.php" id="save_ZC_Au3" method="POST" autocomplete="off" >      
</form> 



 <form action="saves/saves_Aux_final_ZZZ.php" id="save_Aux_final_ZZZ" method="POST" autocomplete="off" >      
</form> 




 <form action="saves/saves_Rev1.php" id="save_Rev1" method="POST" autocomplete="off" >      
</form> 


 <form action="saves/saves_Rev2.php" id="save_Rev2" method="POST" autocomplete="off" >      
</form> 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_11; ?>;"> <span  data-toggle="tooltip" data-placement="left" title="Equivale a <?php echo $nota_real_11; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtAA<?php echo $row_datos_control["id_estud"]; ?>" name="AA_L1-N1[]" form="save_L1_N1"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_12; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_12; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtBB<?php echo $row_datos_control["id_estud"]; ?>" name="BB_L1-N2[]" form="save_L1_N2"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_13; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_13; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtCC<?php echo $row_datos_control["id_estud"]; ?>" name="CC_L1-N3[]" form="save_L1_N3"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_14; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_14; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtDD<?php echo $row_datos_control["id_estud"]; ?>" name="DD_L1-N4[]" form="save_L1_N4"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_15; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_15; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtEE<?php echo $row_datos_control["id_estud"]; ?>" name="EE_L1-N5[]" form="save_L1_N5"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_16; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_16; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtFF<?php echo $row_datos_control["id_estud"]; ?>" name="FF_L1-N6[]" form="save_L1_N6"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_17; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_17; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtGG<?php echo $row_datos_control["id_estud"]; ?>" name="GG_L1-N7[]" form="save_L1_N7"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_21; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $firstape; ?> <?php echo $firstnam; ?> / <?php echo $nota_real_21; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtHH<?php echo $row_datos_control["id_estud"]; ?>" name="HH_L2-N1[]" form="save_L2_N1"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_22; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_22; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtII<?php echo $row_datos_control["id_estud"]; ?>" name="II_L2-N2[]" form="save_L2_N2" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_23; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_23; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtJJ<?php echo $row_datos_control["id_estud"]; ?>" name="JJ_L2-N3[]" form="save_L2_N3" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_24; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_24; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtKK<?php echo $row_datos_control["id_estud"]; ?>" name="KK_L2-N4[]" form="save_L2_N4" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_25; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_25; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtLL<?php echo $row_datos_control["id_estud"]; ?>" name="LL_L2-N5[]" form="save_L2_N5" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_26; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_26; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtMM<?php echo $row_datos_control["id_estud"]; ?>" name="MM_L2-N6[]" form="save_L2_N6" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_27; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_27; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtNN<?php echo $row_datos_control["id_estud"]; ?>" name="NN_L2-N7[]" form="save_L2_N7" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_31; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $firstape; ?> <?php echo $firstnam; ?> / <?php echo $nota_real_31; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtOO<?php echo $row_datos_control["id_estud"]; ?>" name="OO_L3-N1[]" form="save_L3_N1" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_32; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_32; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtPP<?php echo $row_datos_control["id_estud"]; ?>" name="PP_L3-N2[]" form="save_L3_N2" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_33; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_33; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtQQ<?php echo $row_datos_control["id_estud"]; ?>" name="QQ_L3-N3[]" form="save_L3_N3"
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_34; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_34; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtRR<?php echo $row_datos_control["id_estud"]; ?>" name="RR_L3-N4[]" form="save_L3_N4" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_35; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_35; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtSS<?php echo $row_datos_control["id_estud"]; ?>" name="SS_L3-N5[]" form="save_L3_N5" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_36; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_36; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtTT<?php echo $row_datos_control["id_estud"]; ?>" name="TT_L3-N6[]" form="save_L3_N6" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%; background-color: <?php echo $color_nt_37; ?>;"><span data-toggle="tooltip" data-placement="left" title="<?php echo $nota_real_37; ?>"> 
    <input type="text" onkeypress="return GFG_Fun(this, event)" maxlength="4" style="width : 92%; height : 85%;" id="txtUU<?php echo $row_datos_control["id_estud"]; ?>" name="UU_L3-N7[]" form="save_L3_N7" 
...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:2.6%;">
 ...
 <?php } while ($row_datos_control = mysqli_fetch_assoc($datos_control)); ?>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act1"
                      <?php if ($text_aaa == 1 OR $text_rest_a == 'disabled'  ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_1act1" form="save_L1_N1" class="btn btn-aaa btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act2"
                      <?php if ($text_aaa == 1 OR $text_rest_b == 'disabled'  ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_1act2" form="save_L1_N2" class="btn btn-aaa btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act3"
                      <?php if ($text_aaa == 1 OR $text_rest_c == 'disabled'  ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_1act3" form="save_L1_N3" class="btn btn-aaa btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act4"
                      <?php if ($text_aaa == 1 OR $text_rest_d == 'disabled'  ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_1act4" form="save_L1_N4" class="btn btn-aaa btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act5"
                      <?php if ($text_aaa == 1 OR $text_rest_e == 'disabled'  ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_1act5" form="save_L1_N5" class="btn btn-aaa btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act6"
                      <?php if ($text_aaa == 1 OR $text_rest_f == 'disabled'  ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_1act6" form="save_L1_N6" class="btn btn-aaa btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act7"
                      <?php if ($text_aaa == 1 OR $text_rest_g == 'disabled'  ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_1act7" form="save_L1_N7" class="btn btn-aaa btn-sm"><i class="far fa-save fa-lg"></i></button></span>
...
<!-- https://blog.koalite.com/bbg/  -->
 ...
 <td style="height: 23px; width: 2.6%;">
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act1"
                      <?php if ($text_bbb == 1 OR $text_rest_a == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_2act1" form="save_L2_N1" class="btn btn-bbb btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act2"
                      <?php if ($text_bbb == 1 OR $text_rest_b == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_2act2" form="save_L2_N2" class="btn btn-bbb btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act3"
                      <?php if ($text_bbb == 1  OR $text_rest_c == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_2act3" form="save_L2_N3" class="btn btn-bbb btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act4"
                      <?php if ($text_bbb == 1 OR $text_rest_d == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_2act4" form="save_L2_N4" class="btn btn-bbb btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act5"
                      <?php if ($text_bbb == 1 OR $text_rest_e == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_2act5" form="save_L2_N5" class="btn btn-bbb btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act6"
                      <?php if ($text_bbb == 1 OR $text_rest_f == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_2act6" form="save_L2_N6" class="btn btn-bbb btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act7"
                      <?php if ($text_bbb == 1 OR $text_rest_g == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_2act7" form="save_L2_N7" class="btn btn-bbb btn-sm"><i class="far fa-save fa-lg"></i></button></span>
...
<td style="height: 23px; width: 2.6%;">
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act1"
                      <?php if ($text_ccc == 1 OR $text_rest_a == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_3act1" form="save_L3_N1" class="btn btn-ccc btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act2"
                      <?php if ($text_ccc == 1 OR $text_rest_b == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_3act2" form="save_L3_N2" class="btn btn-ccc btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act3"
                      <?php if ($text_ccc == 1 OR $text_rest_c == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_3act3" form="save_L3_N3" class="btn btn-ccc btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act4"
                      <?php if ($text_ccc == 1 OR $text_rest_d == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_3act4" form="save_L3_N4" class="btn btn-ccc btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act5"
                      <?php if ($text_ccc == 1 OR $text_rest_e == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_3act5" form="save_L3_N5" class="btn btn-ccc btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act6"
                      <?php if ($text_ccc == 1 OR $text_rest_f == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_3act6" form="save_L3_N6" class="btn btn-ccc btn-sm"><i class="far fa-save fa-lg"></i></button></span>
  ...
  <span data-toggle="tooltip" data-placement="bottom" title="Act7"
                      <?php if ($text_ccc == 1 OR $text_rest_g == 'disabled' ){?>style="display:none"<?php } ?>   ><button type="submit"
                    name="guardar_3act7" form="save_L3_N7" class="btn btn-ccc btn-sm"><i class="far fa-save fa-lg"></i></button></span>
