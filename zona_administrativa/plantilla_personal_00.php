...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal.php" method="POST">
...
<!--    <input type="hidden" id=""   name=""   value="">
  ...
  <div data-toggle="tooltip" data-placement="top" title="Lista con nombres" >
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal_vac.php" method="POST">
            ...
            <table class="table table-bordered table-sm table-hover" id="dataTable" width="100%" cellspacing="0"  >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle" align="center"><?php echo $row_datos_plantilla['nombre_per']; $id_contratox = $row_datos_plantilla['id_contrato']; ?></td>
                  <td class="align-middle" align="center"><?php echo $row_datos_plantilla['apellido_per']; $id_perx = $row_datos_plantilla['id_per']; ?> </td>
                  <td class="align-middle" align="center"><?php echo $row_datos_plantilla['ci_per']; ?> </td>
...
<?php include("plantilla_personal_00_upd_for.php");   ?>
                  ...
                  <td class="align-middle" align="center"><?php echo $row_datos_plantilla['email_per']; ?> </td>
                  <td class="align-middle" align="center"><?php echo $row_datos_plantilla['celular_per'];
...
<?php if ($row_datos_plantillaHU['id_grupo']=='5' OR $row_datos_plantillaHU['id_grupo']=='1' OR $row_datos_plantillaHU['id_grupo']=='9' OR $row_datos_plantillaHU['id_grupo']=='14') { ?>   <!-- si esta en el grupo de profesores -->
...
<?php if ($row_datos_plantillaHU['id_grupo']!='5' AND $row_datos_plantillaHU['id_grupo']!='1' AND $row_datos_plantillaHU['id_grupo']!='9' AND $row_datos_plantillaHU['id_grupo']!='14') { ?>   <!-- cualquier otro grupo -->
