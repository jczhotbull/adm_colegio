...
// estudiante 3
			...
			$pais_nac_est3 = $_POST["pais_nac_est3"];
			$religion_act3 = $_POST["religion_act3"];
			$padece_act3 = $_POST["padece_act3"];
			$sangre_act3 = $_POST["sangre_act3"];	

			$mod_email_estu_act3 = mysqli_real_escape_string($enlace,$_POST['mod_email_estu_act3']);

			

$mod_se_retira_con_act3 = mysqli_real_escape_string($enlace,$_POST['mod_se_retira_con_act3']);
    $mod_control_med_act3 = mysqli_real_escape_string($enlace,$_POST['mod_control_med_act3']);
    $v_otra_act3 = mysqli_real_escape_string($enlace,$_POST['v_otra_act3']);

    $v1_act3 = $_POST["mod_v1_act3"];  $v2_act3 = $_POST["mod_v2_act3"];  $v3_act3 = $_POST["mod_v3_act3"];  $v4_act3 = $_POST["mod_v4_act3"];
    $v5_act3 = $_POST["mod_v5_act3"];  $v6_act3 = $_POST["mod_v6_act3"];  $v7_act3 = $_POST["mod_v7_act3"];  $v8_act3 = $_POST["mod_v8_act3"];
    $v9_act3 = $_POST["mod_v9_act3"];  $v10_act3 = $_POST["mod_v10_act3"];  $v11_act3 = $_POST["mod_v11_act3"];  $v12_act3 = $_POST["mod_v12_act3"];
    $v13_act3 = $_POST["mod_v13_act3"];  $v14_act3 = $_POST["mod_v14_act3"];  $v15_act3 = $_POST["mod_v15_act3"]; 

  	$mod_medicamentos_act3 = $_POST["mod_medicamentos_act3"];	
...
$query_ES_CC = "INSERT INTO reg_estudiantes(estu_expediente, nombre_estu, apellidos_estu, nacimiento_estu, id_sexo, id_ciudad,
							...
							VALUES (   '".mysqli_real_escape_string($enlace,$_POST['expediente_est3'])."'          ,
									   ...
									   '".mysqli_real_escape_string($enlace,$_POST['cedula_est3'])."'          ,									   
										...
										'$padece_act3', '$sangre_act3', '1', '$mod_email_estu_act3',  '".mysqli_real_escape_string($enlace,$_POST['municipio_est3'])."'    ,

										'".mysqli_real_escape_string($enlace,$_POST['mod_vive_con_estud_act3'])."'          ,
							           '".mysqli_real_escape_string($enlace,$_POST['mod_traslada_estud_act3'])."'            ,
									   '".mysqli_real_escape_string($enlace,$_POST['mod_padecio_estud_act3'])."'          ,
									   '".mysqli_real_escape_string($enlace,$_POST['mod_alergias_estud_act3'])."'        ,
...
$query_ES_CC_sob = "INSERT INTO reg_estu_sobre(id_estud, proviene_de_otro, nombre_plantel_pro, id_ciudad, id_grado, id_periodo_es, es_repitiente, areas_pendientes) 
				...
				if (!mysqli_query($enlace,$query_ES_CC_sob))  // si no logro ingresar sobre el estudiante 1
				            ...
				            {   // en caso de que logre realizar el registro sobre el estudiante 1
								...
								$edad_act3 = $_POST["edad_act3"];
								$talla_cam3 = $_POST["talla_cam3"];
								$talla_pant3 = $_POST["talla_pant3"];
								$talla_zap3 = $_POST["talla_zap3"];

								$peso_act3 = $_POST["peso_act3"];	
								$estatura_act3 = $_POST["estatura_act3"];

								$seccion_act3 = $_POST["seccion_act3"];		

					
$query_ES_CC_act = "INSERT INTO reg_estu_actual(id_estud, id_reg_pagos, cursa_actualmente, grado_actual, repite_actual, fecha_inscripcion,
							...
							VALUES (   '$estu3_id', '$id_pago_CC', '$cursa_est3',
							           '$grado_act3',
							           '$repite_actual3',
							           '".mysqli_real_escape_string($enlace,$_POST['fecha_ins_act3'])."'        ,
	...
	$reg_estu_actual_id3 = mysqli_insert_id($enlace); // almacena el id insertado en el query pasado...
			...
			if (!mysqli_query($enlace,$query_qCF_C))      // si no ha logrado ingresar los datos
				...
				mysqli_close($enlace);
							...
							VALUES (   '$estu3_id', 
							'".mysqli_real_escape_string($enlace,$_POST['obs_text3'])."'          )";
				...
				if (!mysqli_query($enlace,$query_ES_CC_obs))  // si no logro ingresar las observaciones del estudiante 1
				            ...
				            {   // en caso de que logre guardar las obs del estudiante 1
								...
								$obs_success3="<i class=\"fas fa-check-circle fa-lg\"></i>";
											...
											$exitoZ.="- &nbsp;
														<i data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Representado N°3 ha sido Inscrito sin foto.\">
											...
											<b><a href=\"plantilla_representantes_search.php?tituloJKL=Resultados...&criterio=".$num_cedula."\"><i class=\"fas fa-link\"></i> Completar Planilla Extendida!!!</a></b>		 ";
										    	...
										    	$exitoZ.="- &nbsp;
														<i data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Representado N°3 ha sido Inscrito con foto.\">
