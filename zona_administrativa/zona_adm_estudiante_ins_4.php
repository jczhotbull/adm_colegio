...
<div class="form-row margencito">  <!-- viene de otro plantel -->
	...
	<div class="input-group input-group-sm col-md-4 mb-2">
			...
			<input maxlength="38" type="text" class="form-control" id="plantel_pro4" name="plantel_pro4"
...
<div class="form-row">
	...
	<div class="input-group input-group-sm col-md-5 mb-2">
			...
			<input type="date" class="form-control importantex" id="fecha_ins_act4" name="fecha_ins_act4" <?php echo $requerido4; ?>>
	</div>  
	...
	<div class="input-group input-group-sm col-md-7 mb-2">
										<div class="input-group-prepend">
											<span class="input-group-text" id="basic-addon1"><i>Asignar una sección momentanea:</i></span>  
							      				...
							      				<select class="form-control importantex" id="seccion_act4" name="seccion_act4" <?php echo $requerido4; ?>>
...
<option value="<?php echo $row_datos_seccion4['id_seccion']; ?>"><?php echo $row_datos_seccion4['nombre_seccion']; ?></option>

                                <?php } while ($row_datos_seccion4 = mysqli_fetch_assoc($datos_seccion4)); ?> 
