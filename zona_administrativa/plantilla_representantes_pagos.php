...
if(isset($_POST['save_alterno_ins']))
        {
...
if(isset($_POST['buscalo_id_repre']))
    {



if (strlen($_POST['buscar_id_repre']) <=3 )  // no sea mayor a 40 caracteres
...
$busqueda = $_POST['buscar_id_repre'];
...
include("../conectar.php");
      ...
      $query_busee = "SELECT ci_repre FROM reg_representante

            
        where ci_repre LIKE  '".$busqueda."' limit 1 ";

$datos_plantilla_busee = mysqli_query($enlace, $query_busee) or die(mysqli_error());
$totalRows_datos_plantilla_busee = mysqli_num_rows($datos_plantilla_busee); 


if ($totalRows_datos_plantilla_busee == 1) {
...
mysqli_close($enlace); 
      ...
      if ($totalRows_datos_estudiantesaa == '0') {

        $xxxsearch = "xxxxxx";

         header( "Location: plantilla_representantes_pagos.php?tituloJKL=Historial&ciclo=".$cicloJKL."&criterio=".$xxxsearch."&alertin=55" ); 
      ...
      if ($totalRows_datos_estudiantesaa == '1' ) {
        ...
        header( "Location: plantilla_representantes_pagos.php?tituloJKL=Historial&alertin=100&ciclo=".$cicloJKL."&criterio=".$busqueda."" );
...
<form method="POST">
            ...
            <input type="text" class="form-control" name="buscar_id_repre" placeholder="Ingrese el doc de Id del representante..." aria-label="">
            <div class="input-group-append">
              <button type="submit" name="buscalo_id_repre" class="btn btn-success"><i style="color:white;"><i class="fas fa-chevron-circle-right fa-lg "></i></i></button>
            </div>
...
<td class="align-middle" align="center"><b><?php echo $row_datos_estudiantes['nombre_repre']; ?></b>,<br>
                  ...
                  <span style="color: green;"><?php echo $row_de_ids['nombre_profesion']; ?>  </span> <br>
...
<div class="form-row mb-3" style="display:<?php echo $show_div; ?> " >   
 ...
 <b><a href="plantilla_representantes_pagos.php?tituloJKL=Historial&ciclo=<?php echo $el_id_del_periodo_viejo;?>&alertin=100&criterio=<?php echo $row_datos_estudiantes['ci_repre'];  ?>"><i class="fas fa-hand-holding-usd fa-lg"></i>&nbsp; "Revisar"</a></b>
...
$query_YUTcc = "SELECT id_estud, cursa_actualmente, el_activo  FROM reg_estu_actual

         WHERE  id_estud = $el_id_es 

         and  el_activo = '1'          
        
         GROUP BY id_estud limit 1 ";

$datos_estudiantes_YUTcc = mysqli_query($enlace, $query_YUTcc) or die(mysqli_error());

$row_datos_estudiantes_YUTcc = mysqli_fetch_array($datos_estudiantes_YUTcc); 
...
?>
 ...
 <b><a href="plantilla_estudiantes_search_id.php?ciclo=<?php echo $row_datos_estudiantes_YUTcc['cursa_actualmente'];?>&tituloJKL=Resultados&criterio=<?php echo $row_datos_estudiantes_YUT['ci_estu'];?>&alertin=0"><i class="fas fa-link"></i> Doc Id:</a></b>
...
<button type="submit" name="save_alterno_ins" class="btn btn-secondary btn-sm btn-lg btn-block" style="display:<?php echo $show_alt_div; ?>">
<i class="fas fa-hdd"></i>&nbsp;Solo Actualizar</button>
...
<div data-toggle="tooltip" data-placement="top" title="Proceso: <?php echo $f3_nombre; ?> <?php echo $f3_apellido; ?>." >
      <b><?php echo $tercero_pago; ?> </b> &nbsp;<i class="fas fa-dollar-sign"></i></div>
    </span>
...
<div data-toggle="tooltip" data-placement="top" title="Proceso: <?php echo $f4_nombre; ?> <?php echo $f4_apellido; ?>." >
      ...
      <b><?php echo $cuarto_pago; ?> </b> &nbsp;<i class="fas fa-dollar-sign"></i></div>
    </span>
...
<div data-toggle="tooltip" data-placement="top" title="Proceso: <?php echo $f5_nombre; ?> <?php echo $f5_apellido; ?>." >
  <b><?php echo $quinto_pago; ?> </b> &nbsp;<i class="fas fa-dollar-sign"></i></div>
...
<div data-toggle="tooltip" data-placement="top" title="Proceso: <?php echo $f7_nombre; ?> <?php echo $f7_apellido; ?>." >
  <b><?php echo $septimo_pago; ?> </b> &nbsp;<i class="fas fa-dollar-sign"></i></div>
...
<div data-toggle="tooltip" data-placement="top" title="Proceso: <?php echo $f9_nombre; ?> <?php echo $f9_apellido; ?>." >
  <b><?php echo $noveno_pago; ?> </b> &nbsp;<i class="fas fa-dollar-sign"></i></div>
</span>
...
<div data-toggle="tooltip" data-placement="top" title="Proceso: <?php echo $f10_nombre; ?> <?php echo $f10_apellido; ?>." >
      <b><?php echo $decimo_pago; ?> </b> &nbsp;<i class="fas fa-dollar-sign"></i></div>
    </span>
...
<div data-toggle="tooltip" data-placement="top" title="Proceso: <?php echo $f11_nombre; ?> <?php echo $f11_apellido; ?>." >
  <b><?php echo $onceavo_pago; ?>  </b> &nbsp;<i class="fas fa-dollar-sign"></i></div>
</span>
...
<div data-toggle="tooltip" data-placement="top" title="Proceso: <?php echo $f12_nombre; ?> <?php echo $f12_apellido; ?>." >
  <b><?php echo $doceavo_pago; ?> </b> &nbsp;<i class="fas fa-dollar-sign"></i></div>
    </span>
