...
<TD class="miniborder" style="width:19%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center"><b>Estudiantes</b>
</TD>

<TD class="miniborder" style="width:79%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center">Confirmar datos de contacto
</TD>
...
<TD class="miniborder" style="width:19%; height:16px; font-size: 12px; color:<?php echo $color_imp3; ?>;" align="center">Apellidos y Nombres
</TD>



<TD class="miniborder" style="width:20%; height:16px; font-size: 12px; color:<?php echo $color_imp3; ?>;" align="center">Telf.(s)
</TD>


<TD class="miniborder" style="width:27%; height:16px; font-size: 12px; color:<?php echo $color_imp3; ?>;" align="center">Email
</TD>

<TD class="miniborder" style="width:32%; height:16px; font-size: 12px; color:<?php echo $color_imp3; ?>;" align="center">Anotaciones y/o Firma
</TD>
...
<TD class="miniborder" style="width:19%; height:16px; font-size: 11px; color:<?php echo $color_imp1; ?>; padding-left: 4px;" align="left">
...
<TD class="miniborder" style="width:20%; height:16px; font-size: 11px; color:<?php echo $color_imp1; ?>;" align="center"><b><?php echo $row_datos_controlP['celular_repre']; ?></b>, <?php echo $row_datos_controlP['telefono_repre']; ?> 
</TD>
...
<TD class="miniborder" style="width:27%; height:16px; font-size: 11px; color:<?php echo $color_imp1; ?>;" align="center"><?php echo $row_datos_controlP['email_repre']; ?>
</TD>

<TD class="miniborder" style="width:32%; height:18px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
