...
<TD class="miniborder" style="width:40%; height:16px; font-size: 14px; color:black;" align="center"><b>Email</b>
</TD>



<TD class="miniborder" style="width:19%; height:16px; font-size: 14px; color:grey;" align="center">
</TD>
...
<TD class="miniborder" style="width:40%; height:16px; font-size: 12px; color:black;" align="center"><b><?php echo $row_datos_control['email_estu']; ?></b>
</TD>
