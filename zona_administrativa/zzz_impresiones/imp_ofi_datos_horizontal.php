...
<TD class="miniborder" style="width:9%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">Ci ó Ci Escolar
</TD>
<TD class="miniborder" style="width:7%; height:16px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">Fecha de Nac.
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">Sexo
</TD>
<TD class="miniborder" style="width:18%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">Apellidos
</TD>
<TD class="miniborder" style="width:18%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">Nombres
</TD>
<TD class="miniborder" style="width:7%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">Ci
</TD>
