...
<TD class="" style="width:1.8%; height:90px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>

<TD class="" style="width:12.825%; height:90px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
...
<TD class="miniborder" style="width:5.674%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="">
    <div style="margin-top: 75px; margin-left: 5px;" ><b><?php echo $row_datos_controlmat['a_abrev'];?></b></div>
</TD>
<TD class="miniborder" style="width:5.674%; height:90px; font-size: 11px; background-color:<?php echo $back_emergency; ?>; 
...
<TD class="miniborderleft" style="width:5.674%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="">
...
<TD class="" style="width:2.055%; height:90px; font-size: 10px; color:<?php echo $color_imp3; ?>;" align=""><div style="margin-top: 75px;"><b>&nbsp;&nbsp;&nbsp;Pro.</b></div>   
</TD>
...
<TD class="miniborder" style="width:1.8%; height:15px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center"><b>N°</b>
</TD>

<TD class="" style="width:14.625%; height:15px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="right">Pond.:&nbsp;&nbsp;
</TD>
...
<TD class="miniborder" style="width:1.39%; height:15px; font-size: 10px; color:<?php echo $color_imp2; ?>;" align="center">1°</TD>
<TD class="miniborder" style="width:1.39%; height:15px; font-size: 10px; color:<?php echo $color_imp2; ?>;" align="center">2°</TD>
<TD class="miniborder" style="width:1.39%; height:15px; font-size: 10px; color:<?php echo $color_imp2; ?>;" align="center">3°</TD>
<TD class="miniborder" style="width:1.486%; height:15px; font-size: 10px; color:<?php echo $color_imp2; ?>;" align="center">DF</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 14px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">
<?php echo $nn2; ?>
</TD>
...
<TD class="miniborderleft" style="width:5.674%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn3; ?>
</TD>
...
<TD class="miniborderleft" style="width:5.674%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn5; ?>
</TD>
...
<TD class="miniborderleft" style="width:5.674%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn7; ?>
</TD>
...
<TD class="miniborderleft" style="width:5.674%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn9; ?>
</TD>
...
<TD class="miniborderleft" style="width:5.674%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn11; ?>
</TD>
...
<TD class="miniborderleft" style="width:5.674%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn13; ?>
</TD>
...
<TD class="miniborderleft" style="width:2.055%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="right">
</TD>
...
<TD class="miniborder" style="width:1.8%; height:15px; font-size: 13px; color:<?php echo $color_imp3; ?>;" align="center">
...
<TD class="miniborder" style="width:14.625%; height:15px; font-size: 11px; color:<?php echo $color_imp1; ?>; padding-left: 4px;" align="left">
...
<TD class="miniborder" style="width:1.39%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
  <?php
     $cuenta_personal ='0';
     $suma_personal = '';
     $entre_cuanto = '';
...
<TD class="miniborder" style="width:1.486%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
...
<TD class="miniborderleft" style="width:1.39%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">
  <?php
...
<TD class="miniborder" style="width:1.39%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">
<?php    
...
<TD class="miniborder" style="width:1.486%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">
...
<TD class="miniborderleft" style="width:1.39%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
  <?php
...
<TD class="miniborderleft" style="width:2.055%; height:15px; font-size: 13px; color:<?php echo $color_imp2; ?>;" align="center">
...
<TD class="miniborder" style="width:14.625%; height:15px; font-size: 11px; color:<?php echo $color_imp1; ?>; padding-left: 4px;" align="right">
 Promedios:                                      
</TD>

<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
    <?php   $pro_todo_M1 = $tot_mat1/$div_mat1; $pro_todo_M1_redond =number_format($pro_todo_M1, 0, ',', '');  echo $pro_todo_M1_redond; ?>
</TD>

<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">      <?php   $pro_todo_M2 = $tot_mat2/$div_mat2; $pro_todo_M2_redond =number_format($pro_todo_M2, 0, ',', '');  echo $pro_todo_M2_redond; ?>
</TD>

<TD class="miniborderleft" style="width:5.674%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
         <?php   $pro_todo_M3 = $tot_mat3/$div_mat3; $pro_todo_M3_redond =number_format($pro_todo_M3, 0, ',', '');  echo $pro_todo_M3_redond; ?>
</TD>

<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">     <?php   $pro_todo_M4 = $tot_mat4/$div_mat4; $pro_todo_M4_redond =number_format($pro_todo_M4, 0, ',', '');  echo $pro_todo_M4_redond; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">     <?php   $pro_todo_M6 = $tot_mat6/$div_mat6; $pro_todo_M6_redond =number_format($pro_todo_M6, 0, ',', '');  echo $pro_todo_M6_redond; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">  <?php   $pro_todo_M8 = $tot_mat8/$div_mat8; $pro_todo_M8_redond =number_format($pro_todo_M8, 0, ',', '');  echo $pro_todo_M8_redond; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">  <?php   $pro_todo_M10 = $tot_mat10/$div_mat10; $pro_todo_M10_redond =number_format($pro_todo_M10, 0, ',', '');  echo $pro_todo_M10_redond; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">  <?php   $pro_todo_M12 = $tot_mat12/$div_mat12; $pro_todo_M12_redond =number_format($pro_todo_M12, 0, ',', '');  echo $pro_todo_M12_redond; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">  <?php   $pro_todo_M14 = $tot_mat14/$div_mat14; $pro_todo_M14_redond =number_format($pro_todo_M14, 0, ',', '');  echo $pro_todo_M14_redond; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat2; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat4; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat6; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat8; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat10; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat12; ?>
</TD>
...
<TD class="miniborder" style="width:5.674%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat14; ?>
</TD>
