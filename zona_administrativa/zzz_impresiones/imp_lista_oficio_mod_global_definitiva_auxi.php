...
<TD class="" style="width:4%; height:90px; font-size: 14px; color:<?php echo $color_imp3; ?>; " align=""><div style="rotate:90; margin-top: 50px;">Asignaturas</div>
</TD>
...
$para_el_porc_V1_M1_L1 = ($V1_M1_L1 * 20)/100;
$para_el_porc_V2_M1_L1 = ($V2_M1_L1 * 20)/100;
$para_el_porc_V3_M1_L1 = ($V3_M1_L1 * 20)/100;
$para_el_porc_V4_M1_L1 = ($V4_M1_L1 * 20)/100;
$para_el_porc_V5_M1_L1 = ($V5_M1_L1 * 20)/100;
$para_el_porc_V6_M1_L1 = ($V6_M1_L1 * 20)/100;
$para_el_porc_V7_M1_L1 = ($V7_M1_L1 * 20)/100;

$para_el_porc_V1_M2_L1 = ($V1_M2_L1 * 20)/100;
$para_el_porc_V2_M2_L1 = ($V2_M2_L1 * 20)/100;
$para_el_porc_V3_M2_L1 = ($V3_M2_L1 * 20)/100;
$para_el_porc_V4_M2_L1 = ($V4_M2_L1 * 20)/100;
$para_el_porc_V5_M2_L1 = ($V5_M2_L1 * 20)/100;
$para_el_porc_V6_M2_L1 = ($V6_M2_L1 * 20)/100;
$para_el_porc_V7_M2_L1 = ($V7_M2_L1 * 20)/100;

$para_el_porc_V1_M3_L1 = ($V1_M3_L1 * 20)/100;
$para_el_porc_V2_M3_L1 = ($V2_M3_L1 * 20)/100;
$para_el_porc_V3_M3_L1 = ($V3_M3_L1 * 20)/100;
$para_el_porc_V4_M3_L1 = ($V4_M3_L1 * 20)/100;
$para_el_porc_V5_M3_L1 = ($V5_M3_L1 * 20)/100;
$para_el_porc_V6_M3_L1 = ($V6_M3_L1 * 20)/100;
$para_el_porc_V7_M3_L1 = ($V7_M3_L1 * 20)/100;

$para_el_porc_V1_M4_L1 = ($V1_M4_L1 * 20)/100;
$para_el_porc_V2_M4_L1 = ($V2_M4_L1 * 20)/100;
$para_el_porc_V3_M4_L1 = ($V3_M4_L1 * 20)/100;
$para_el_porc_V4_M4_L1 = ($V4_M4_L1 * 20)/100;
$para_el_porc_V5_M4_L1 = ($V5_M4_L1 * 20)/100;
$para_el_porc_V6_M4_L1 = ($V6_M4_L1 * 20)/100;
$para_el_porc_V7_M4_L1 = ($V7_M4_L1 * 20)/100;

$para_el_porc_V1_M5_L1 = ($V1_M5_L1 * 20)/100;
$para_el_porc_V2_M5_L1 = ($V2_M5_L1 * 20)/100;
$para_el_porc_V3_M5_L1 = ($V3_M5_L1 * 20)/100;
$para_el_porc_V4_M5_L1 = ($V4_M5_L1 * 20)/100;
$para_el_porc_V5_M5_L1 = ($V5_M5_L1 * 20)/100;
$para_el_porc_V6_M5_L1 = ($V6_M5_L1 * 20)/100;
$para_el_porc_V7_M5_L1 = ($V7_M5_L1 * 20)/100;

$para_el_porc_V1_M6_L1 = ($V1_M6_L1 * 20)/100;
$para_el_porc_V2_M6_L1 = ($V2_M6_L1 * 20)/100;
$para_el_porc_V3_M6_L1 = ($V3_M6_L1 * 20)/100;
$para_el_porc_V4_M6_L1 = ($V4_M6_L1 * 20)/100;
$para_el_porc_V5_M6_L1 = ($V5_M6_L1 * 20)/100;
$para_el_porc_V6_M6_L1 = ($V6_M6_L1 * 20)/100;
$para_el_porc_V7_M6_L1 = ($V7_M6_L1 * 20)/100;

$para_el_porc_V1_M7_L1 = ($V1_M7_L1 * 20)/100;
$para_el_porc_V2_M7_L1 = ($V2_M7_L1 * 20)/100;
$para_el_porc_V3_M7_L1 = ($V3_M7_L1 * 20)/100;
$para_el_porc_V4_M7_L1 = ($V4_M7_L1 * 20)/100;
$para_el_porc_V5_M7_L1 = ($V5_M7_L1 * 20)/100;
$para_el_porc_V6_M7_L1 = ($V6_M7_L1 * 20)/100;
$para_el_porc_V7_M7_L1 = ($V7_M7_L1 * 20)/100;

$para_el_porc_V1_M8_L1 = ($V1_M8_L1 * 20)/100;
$para_el_porc_V2_M8_L1 = ($V2_M8_L1 * 20)/100;
$para_el_porc_V3_M8_L1 = ($V3_M8_L1 * 20)/100;
$para_el_porc_V4_M8_L1 = ($V4_M8_L1 * 20)/100;
$para_el_porc_V5_M8_L1 = ($V5_M8_L1 * 20)/100;
$para_el_porc_V6_M8_L1 = ($V6_M8_L1 * 20)/100;
$para_el_porc_V7_M8_L1 = ($V7_M8_L1 * 20)/100;

$para_el_porc_V1_M9_L1 = ($V1_M9_L1 * 20)/100;
$para_el_porc_V2_M9_L1 = ($V2_M9_L1 * 20)/100;
$para_el_porc_V3_M9_L1 = ($V3_M9_L1 * 20)/100;
$para_el_porc_V4_M9_L1 = ($V4_M9_L1 * 20)/100;
$para_el_porc_V5_M9_L1 = ($V5_M9_L1 * 20)/100;
$para_el_porc_V6_M9_L1 = ($V6_M9_L1 * 20)/100;
$para_el_porc_V7_M9_L1 = ($V7_M9_L1 * 20)/100;

$para_el_porc_V1_M10_L1 = ($V1_M10_L1 * 20)/100;
$para_el_porc_V2_M10_L1 = ($V2_M10_L1 * 20)/100;
$para_el_porc_V3_M10_L1 = ($V3_M10_L1 * 20)/100;
$para_el_porc_V4_M10_L1 = ($V4_M10_L1 * 20)/100;
$para_el_porc_V5_M10_L1 = ($V5_M10_L1 * 20)/100;
$para_el_porc_V6_M10_L1 = ($V6_M10_L1 * 20)/100;
$para_el_porc_V7_M10_L1 = ($V7_M10_L1 * 20)/100;

$para_el_porc_V1_M11_L1 = ($V1_M11_L1 * 20)/100;
$para_el_porc_V2_M11_L1 = ($V2_M11_L1 * 20)/100;
$para_el_porc_V3_M11_L1 = ($V3_M11_L1 * 20)/100;
$para_el_porc_V4_M11_L1 = ($V4_M11_L1 * 20)/100;
$para_el_porc_V5_M11_L1 = ($V5_M11_L1 * 20)/100;
$para_el_porc_V6_M11_L1 = ($V6_M11_L1 * 20)/100;
$para_el_porc_V7_M11_L1 = ($V7_M11_L1 * 20)/100;

$para_el_porc_V1_M12_L1 = ($V1_M12_L1 * 20)/100;
$para_el_porc_V2_M12_L1 = ($V2_M12_L1 * 20)/100;
$para_el_porc_V3_M12_L1 = ($V3_M12_L1 * 20)/100;
$para_el_porc_V4_M12_L1 = ($V4_M12_L1 * 20)/100;
$para_el_porc_V5_M12_L1 = ($V5_M12_L1 * 20)/100;
$para_el_porc_V6_M12_L1 = ($V6_M12_L1 * 20)/100;
$para_el_porc_V7_M12_L1 = ($V7_M12_L1 * 20)/100;

$para_el_porc_V1_M13_L1 = ($V1_M13_L1 * 20)/100;
$para_el_porc_V2_M13_L1 = ($V2_M13_L1 * 20)/100;
$para_el_porc_V3_M13_L1 = ($V3_M13_L1 * 20)/100;
$para_el_porc_V4_M13_L1 = ($V4_M13_L1 * 20)/100;
$para_el_porc_V5_M13_L1 = ($V5_M13_L1 * 20)/100;
$para_el_porc_V6_M13_L1 = ($V6_M13_L1 * 20)/100;
$para_el_porc_V7_M13_L1 = ($V7_M13_L1 * 20)/100;

$para_el_porc_V1_M14_L1 = ($V1_M14_L1 * 20)/100;
$para_el_porc_V2_M14_L1 = ($V2_M14_L1 * 20)/100;
$para_el_porc_V3_M14_L1 = ($V3_M14_L1 * 20)/100;
$para_el_porc_V4_M14_L1 = ($V4_M14_L1 * 20)/100;
$para_el_porc_V5_M14_L1 = ($V5_M14_L1 * 20)/100;
$para_el_porc_V6_M14_L1 = ($V6_M14_L1 * 20)/100;
$para_el_porc_V7_M14_L1 = ($V7_M14_L1 * 20)/100;





$para_el_porc_V1_M1_L2 = ($V1_M1_L2 * 20)/100;
$para_el_porc_V2_M1_L2 = ($V2_M1_L2 * 20)/100;
$para_el_porc_V3_M1_L2 = ($V3_M1_L2 * 20)/100;
$para_el_porc_V4_M1_L2 = ($V4_M1_L2 * 20)/100;
$para_el_porc_V5_M1_L2 = ($V5_M1_L2 * 20)/100;
$para_el_porc_V6_M1_L2 = ($V6_M1_L2 * 20)/100;
$para_el_porc_V7_M1_L2 = ($V7_M1_L2 * 20)/100;

$para_el_porc_V1_M2_L2 = ($V1_M2_L2 * 20)/100;
$para_el_porc_V2_M2_L2 = ($V2_M2_L2 * 20)/100;
$para_el_porc_V3_M2_L2 = ($V3_M2_L2 * 20)/100;
$para_el_porc_V4_M2_L2 = ($V4_M2_L2 * 20)/100;
$para_el_porc_V5_M2_L2 = ($V5_M2_L2 * 20)/100;
$para_el_porc_V6_M2_L2 = ($V6_M2_L2 * 20)/100;
$para_el_porc_V7_M2_L2 = ($V7_M2_L2 * 20)/100;

$para_el_porc_V1_M3_L2 = ($V1_M3_L2 * 20)/100;
$para_el_porc_V2_M3_L2 = ($V2_M3_L2 * 20)/100;
$para_el_porc_V3_M3_L2 = ($V3_M3_L2 * 20)/100;
$para_el_porc_V4_M3_L2 = ($V4_M3_L2 * 20)/100;
$para_el_porc_V5_M3_L2 = ($V5_M3_L2 * 20)/100;
$para_el_porc_V6_M3_L2 = ($V6_M3_L2 * 20)/100;
$para_el_porc_V7_M3_L2 = ($V7_M3_L2 * 20)/100;

$para_el_porc_V1_M4_L2 = ($V1_M4_L2 * 20)/100;
$para_el_porc_V2_M4_L2 = ($V2_M4_L2 * 20)/100;
$para_el_porc_V3_M4_L2 = ($V3_M4_L2 * 20)/100;
$para_el_porc_V4_M4_L2 = ($V4_M4_L2 * 20)/100;
$para_el_porc_V5_M4_L2 = ($V5_M4_L2 * 20)/100;
$para_el_porc_V6_M4_L2 = ($V6_M4_L2 * 20)/100;
$para_el_porc_V7_M4_L2 = ($V7_M4_L2 * 20)/100;

$para_el_porc_V1_M5_L2 = ($V1_M5_L2 * 20)/100;
$para_el_porc_V2_M5_L2 = ($V2_M5_L2 * 20)/100;
$para_el_porc_V3_M5_L2 = ($V3_M5_L2 * 20)/100;
$para_el_porc_V4_M5_L2 = ($V4_M5_L2 * 20)/100;
$para_el_porc_V5_M5_L2 = ($V5_M5_L2 * 20)/100;
$para_el_porc_V6_M5_L2 = ($V6_M5_L2 * 20)/100;
$para_el_porc_V7_M5_L2 = ($V7_M5_L2 * 20)/100;

$para_el_porc_V1_M6_L2 = ($V1_M6_L2 * 20)/100;
$para_el_porc_V2_M6_L2 = ($V2_M6_L2 * 20)/100;
$para_el_porc_V3_M6_L2 = ($V3_M6_L2 * 20)/100;
$para_el_porc_V4_M6_L2 = ($V4_M6_L2 * 20)/100;
$para_el_porc_V5_M6_L2 = ($V5_M6_L2 * 20)/100;
$para_el_porc_V6_M6_L2 = ($V6_M6_L2 * 20)/100;
$para_el_porc_V7_M6_L2 = ($V7_M6_L2 * 20)/100;

$para_el_porc_V1_M7_L2 = ($V1_M7_L2 * 20)/100;
$para_el_porc_V2_M7_L2 = ($V2_M7_L2 * 20)/100;
$para_el_porc_V3_M7_L2 = ($V3_M7_L2 * 20)/100;
$para_el_porc_V4_M7_L2 = ($V4_M7_L2 * 20)/100;
$para_el_porc_V5_M7_L2 = ($V5_M7_L2 * 20)/100;
$para_el_porc_V6_M7_L2 = ($V6_M7_L2 * 20)/100;
$para_el_porc_V7_M7_L2 = ($V7_M7_L2 * 20)/100;

$para_el_porc_V1_M8_L2 = ($V1_M8_L2 * 20)/100;
$para_el_porc_V2_M8_L2 = ($V2_M8_L2 * 20)/100;
$para_el_porc_V3_M8_L2 = ($V3_M8_L2 * 20)/100;
$para_el_porc_V4_M8_L2 = ($V4_M8_L2 * 20)/100;
$para_el_porc_V5_M8_L2 = ($V5_M8_L2 * 20)/100;
$para_el_porc_V6_M8_L2 = ($V6_M8_L2 * 20)/100;
$para_el_porc_V7_M8_L2 = ($V7_M8_L2 * 20)/100;

$para_el_porc_V1_M9_L2 = ($V1_M9_L2 * 20)/100;
$para_el_porc_V2_M9_L2 = ($V2_M9_L2 * 20)/100;
$para_el_porc_V3_M9_L2 = ($V3_M9_L2 * 20)/100;
$para_el_porc_V4_M9_L2 = ($V4_M9_L2 * 20)/100;
$para_el_porc_V5_M9_L2 = ($V5_M9_L2 * 20)/100;
$para_el_porc_V6_M9_L2 = ($V6_M9_L2 * 20)/100;
$para_el_porc_V7_M9_L2 = ($V7_M9_L2 * 20)/100;

$para_el_porc_V1_M10_L2 = ($V1_M10_L2 * 20)/100;
$para_el_porc_V2_M10_L2 = ($V2_M10_L2 * 20)/100;
$para_el_porc_V3_M10_L2 = ($V3_M10_L2 * 20)/100;
$para_el_porc_V4_M10_L2 = ($V4_M10_L2 * 20)/100;
$para_el_porc_V5_M10_L2 = ($V5_M10_L2 * 20)/100;
$para_el_porc_V6_M10_L2 = ($V6_M10_L2 * 20)/100;
$para_el_porc_V7_M10_L2 = ($V7_M10_L2 * 20)/100;

$para_el_porc_V1_M11_L2 = ($V1_M11_L2 * 20)/100;
$para_el_porc_V2_M11_L2 = ($V2_M11_L2 * 20)/100;
$para_el_porc_V3_M11_L2 = ($V3_M11_L2 * 20)/100;
$para_el_porc_V4_M11_L2 = ($V4_M11_L2 * 20)/100;
$para_el_porc_V5_M11_L2 = ($V5_M11_L2 * 20)/100;
$para_el_porc_V6_M11_L2 = ($V6_M11_L2 * 20)/100;
$para_el_porc_V7_M11_L2 = ($V7_M11_L2 * 20)/100;

$para_el_porc_V1_M12_L2 = ($V1_M12_L2 * 20)/100;
$para_el_porc_V2_M12_L2 = ($V2_M12_L2 * 20)/100;
$para_el_porc_V3_M12_L2 = ($V3_M12_L2 * 20)/100;
$para_el_porc_V4_M12_L2 = ($V4_M12_L2 * 20)/100;
$para_el_porc_V5_M12_L2 = ($V5_M12_L2 * 20)/100;
$para_el_porc_V6_M12_L2 = ($V6_M12_L2 * 20)/100;
$para_el_porc_V7_M12_L2 = ($V7_M12_L2 * 20)/100;

$para_el_porc_V1_M13_L2 = ($V1_M13_L2 * 20)/100;
$para_el_porc_V2_M13_L2 = ($V2_M13_L2 * 20)/100;
$para_el_porc_V3_M13_L2 = ($V3_M13_L2 * 20)/100;
$para_el_porc_V4_M13_L2 = ($V4_M13_L2 * 20)/100;
$para_el_porc_V5_M13_L2 = ($V5_M13_L2 * 20)/100;
$para_el_porc_V6_M13_L2 = ($V6_M13_L2 * 20)/100;
$para_el_porc_V7_M13_L2 = ($V7_M13_L2 * 20)/100;

$para_el_porc_V1_M14_L2 = ($V1_M14_L2 * 20)/100;
$para_el_porc_V2_M14_L2 = ($V2_M14_L2 * 20)/100;
$para_el_porc_V3_M14_L2 = ($V3_M14_L2 * 20)/100;
$para_el_porc_V4_M14_L2 = ($V4_M14_L2 * 20)/100;
$para_el_porc_V5_M14_L2 = ($V5_M14_L2 * 20)/100;
$para_el_porc_V6_M14_L2 = ($V6_M14_L2 * 20)/100;
$para_el_porc_V7_M14_L2 = ($V7_M14_L2 * 20)/100;




$para_el_porc_V1_M1_L3 = ($V1_M1_L3 * 20)/100;
$para_el_porc_V2_M1_L3 = ($V2_M1_L3 * 20)/100;
$para_el_porc_V3_M1_L3 = ($V3_M1_L3 * 20)/100;
$para_el_porc_V4_M1_L3 = ($V4_M1_L3 * 20)/100;
$para_el_porc_V5_M1_L3 = ($V5_M1_L3 * 20)/100;
$para_el_porc_V6_M1_L3 = ($V6_M1_L3 * 20)/100;
$para_el_porc_V7_M1_L3 = ($V7_M1_L3 * 20)/100;

$para_el_porc_V1_M2_L3 = ($V1_M2_L3 * 20)/100;
$para_el_porc_V2_M2_L3 = ($V2_M2_L3 * 20)/100;
$para_el_porc_V3_M2_L3 = ($V3_M2_L3 * 20)/100;
$para_el_porc_V4_M2_L3 = ($V4_M2_L3 * 20)/100;
$para_el_porc_V5_M2_L3 = ($V5_M2_L3 * 20)/100;
$para_el_porc_V6_M2_L3 = ($V6_M2_L3 * 20)/100;
$para_el_porc_V7_M2_L3 = ($V7_M2_L3 * 20)/100;

$para_el_porc_V1_M3_L3 = ($V1_M3_L3 * 20)/100;
$para_el_porc_V2_M3_L3 = ($V2_M3_L3 * 20)/100;
$para_el_porc_V3_M3_L3 = ($V3_M3_L3 * 20)/100;
$para_el_porc_V4_M3_L3 = ($V4_M3_L3 * 20)/100;
$para_el_porc_V5_M3_L3 = ($V5_M3_L3 * 20)/100;
$para_el_porc_V6_M3_L3 = ($V6_M3_L3 * 20)/100;
$para_el_porc_V7_M3_L3 = ($V7_M3_L3 * 20)/100;

$para_el_porc_V1_M4_L3 = ($V1_M4_L3 * 20)/100;
$para_el_porc_V2_M4_L3 = ($V2_M4_L3 * 20)/100;
$para_el_porc_V3_M4_L3 = ($V3_M4_L3 * 20)/100;
$para_el_porc_V4_M4_L3 = ($V4_M4_L3 * 20)/100;
$para_el_porc_V5_M4_L3 = ($V5_M4_L3 * 20)/100;
$para_el_porc_V6_M4_L3 = ($V6_M4_L3 * 20)/100;
$para_el_porc_V7_M4_L3 = ($V7_M4_L3 * 20)/100;

$para_el_porc_V1_M5_L3 = ($V1_M5_L3 * 20)/100;
$para_el_porc_V2_M5_L3 = ($V2_M5_L3 * 20)/100;
$para_el_porc_V3_M5_L3 = ($V3_M5_L3 * 20)/100;
$para_el_porc_V4_M5_L3 = ($V4_M5_L3 * 20)/100;
$para_el_porc_V5_M5_L3 = ($V5_M5_L3 * 20)/100;
$para_el_porc_V6_M5_L3 = ($V6_M5_L3 * 20)/100;
$para_el_porc_V7_M5_L3 = ($V7_M5_L3 * 20)/100;

$para_el_porc_V1_M6_L3 = ($V1_M6_L3 * 20)/100;
$para_el_porc_V2_M6_L3 = ($V2_M6_L3 * 20)/100;
$para_el_porc_V3_M6_L3 = ($V3_M6_L3 * 20)/100;
$para_el_porc_V4_M6_L3 = ($V4_M6_L3 * 20)/100;
$para_el_porc_V5_M6_L3 = ($V5_M6_L3 * 20)/100;
$para_el_porc_V6_M6_L3 = ($V6_M6_L3 * 20)/100;
$para_el_porc_V7_M6_L3 = ($V7_M6_L3 * 20)/100;

$para_el_porc_V1_M7_L3 = ($V1_M7_L3 * 20)/100;
$para_el_porc_V2_M7_L3 = ($V2_M7_L3 * 20)/100;
$para_el_porc_V3_M7_L3 = ($V3_M7_L3 * 20)/100;
$para_el_porc_V4_M7_L3 = ($V4_M7_L3 * 20)/100;
$para_el_porc_V5_M7_L3 = ($V5_M7_L3 * 20)/100;
$para_el_porc_V6_M7_L3 = ($V6_M7_L3 * 20)/100;
$para_el_porc_V7_M7_L3 = ($V7_M7_L3 * 20)/100;

$para_el_porc_V1_M8_L3 = ($V1_M8_L3 * 20)/100;
$para_el_porc_V2_M8_L3 = ($V2_M8_L3 * 20)/100;
$para_el_porc_V3_M8_L3 = ($V3_M8_L3 * 20)/100;
$para_el_porc_V4_M8_L3 = ($V4_M8_L3 * 20)/100;
$para_el_porc_V5_M8_L3 = ($V5_M8_L3 * 20)/100;
$para_el_porc_V6_M8_L3 = ($V6_M8_L3 * 20)/100;
$para_el_porc_V7_M8_L3 = ($V7_M8_L3 * 20)/100;

$para_el_porc_V1_M9_L3 = ($V1_M9_L3 * 20)/100;
$para_el_porc_V2_M9_L3 = ($V2_M9_L3 * 20)/100;
$para_el_porc_V3_M9_L3 = ($V3_M9_L3 * 20)/100;
$para_el_porc_V4_M9_L3 = ($V4_M9_L3 * 20)/100;
$para_el_porc_V5_M9_L3 = ($V5_M9_L3 * 20)/100;
$para_el_porc_V6_M9_L3 = ($V6_M9_L3 * 20)/100;
$para_el_porc_V7_M9_L3 = ($V7_M9_L3 * 20)/100;

$para_el_porc_V1_M10_L3 = ($V1_M10_L3 * 20)/100;
$para_el_porc_V2_M10_L3 = ($V2_M10_L3 * 20)/100;
$para_el_porc_V3_M10_L3 = ($V3_M10_L3 * 20)/100;
$para_el_porc_V4_M10_L3 = ($V4_M10_L3 * 20)/100;
$para_el_porc_V5_M10_L3 = ($V5_M10_L3 * 20)/100;
$para_el_porc_V6_M10_L3 = ($V6_M10_L3 * 20)/100;
$para_el_porc_V7_M10_L3 = ($V7_M10_L3 * 20)/100;

$para_el_porc_V1_M11_L3 = ($V1_M11_L3 * 20)/100;
$para_el_porc_V2_M11_L3 = ($V2_M11_L3 * 20)/100;
$para_el_porc_V3_M11_L3 = ($V3_M11_L3 * 20)/100;
$para_el_porc_V4_M11_L3 = ($V4_M11_L3 * 20)/100;
$para_el_porc_V5_M11_L3 = ($V5_M11_L3 * 20)/100;
$para_el_porc_V6_M11_L3 = ($V6_M11_L3 * 20)/100;
$para_el_porc_V7_M11_L3 = ($V7_M11_L3 * 20)/100;

$para_el_porc_V1_M12_L3 = ($V1_M12_L3 * 20)/100;
$para_el_porc_V2_M12_L3 = ($V2_M12_L3 * 20)/100;
$para_el_porc_V3_M12_L3 = ($V3_M12_L3 * 20)/100;
$para_el_porc_V4_M12_L3 = ($V4_M12_L3 * 20)/100;
$para_el_porc_V5_M12_L3 = ($V5_M12_L3 * 20)/100;
$para_el_porc_V6_M12_L3 = ($V6_M12_L3 * 20)/100;
$para_el_porc_V7_M12_L3 = ($V7_M12_L3 * 20)/100;

$para_el_porc_V1_M13_L3 = ($V1_M13_L3 * 20)/100;
$para_el_porc_V2_M13_L3 = ($V2_M13_L3 * 20)/100;
$para_el_porc_V3_M13_L3 = ($V3_M13_L3 * 20)/100;
$para_el_porc_V4_M13_L3 = ($V4_M13_L3 * 20)/100;
$para_el_porc_V5_M13_L3 = ($V5_M13_L3 * 20)/100;
$para_el_porc_V6_M13_L3 = ($V6_M13_L3 * 20)/100;
$para_el_porc_V7_M13_L3 = ($V7_M13_L3 * 20)/100;

$para_el_porc_V1_M14_L3 = ($V1_M14_L3 * 20)/100;
$para_el_porc_V2_M14_L3 = ($V2_M14_L3 * 20)/100;
$para_el_porc_V3_M14_L3 = ($V3_M14_L3 * 20)/100;
$para_el_porc_V4_M14_L3 = ($V4_M14_L3 * 20)/100;
$para_el_porc_V5_M14_L3 = ($V5_M14_L3 * 20)/100;
$para_el_porc_V6_M14_L3 = ($V6_M14_L3 * 20)/100;
$para_el_porc_V7_M14_L3 = ($V7_M14_L3 * 20)/100;


?>


<TD class="miniborder" style="width:3.4%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px; "><b><?php echo $row_datos_controlmat['a_abrev'];?></b></div>
</TD>
<TD class="miniborder" style="width:3.4%; height:90px; font-size: 11px; background-color:<?php echo $back_emergency; ?>; 
color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px;"><b><?php echo $row_datos_controlmat['b_abrev'];?></b></div>
</TD>




<TD class="miniborderleft" style="width:3.4%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px; "><b><?php echo $row_datos_controlmat['c_abrev'];?></b></div>
</TD>
<TD class="miniborder" style="width:3.4%; height:90px; font-size: 11px; background-color:<?php echo $back_emergency; ?>; 
color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px;"><b><?php echo $row_datos_controlmat['d_abrev'];?></b></div>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px; "><b><?php echo $row_datos_controlmat['e_abrev'];?></b></div>
</TD>
<TD class="miniborder" style="width:3.4%; height:90px; font-size: 11px; background-color:<?php echo $back_emergency; ?>; 
color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px;"><b><?php echo $row_datos_controlmat['f_abrev'];?></b></div>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px; "><b><?php echo $row_datos_controlmat['g_abrev'];?></b></div>
</TD>
<TD class="miniborder" style="width:3.4%; height:90px; font-size: 11px; background-color:<?php echo $back_emergency; ?>; 
color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px;"><b><?php echo $row_datos_controlmat['h_abrev'];?></b></div>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px; "><b><?php echo $row_datos_controlmat['i_abrev'];?></b></div>
</TD>
<TD class="miniborder" style="width:3.3%; height:90px; font-size: 11px; background-color:<?php echo $back_emergency; ?>; 
color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px;"><b><?php echo $row_datos_controlmat['j_abrev'];?></b></div>
</TD>




<TD class="miniborderleft" style="width:3.3%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px;"><b><?php echo $row_datos_controlmat['k_abrev'];?></b></div>
</TD>
<TD class="miniborder" style="width:3.4%; height:90px; font-size: 11px; background-color:<?php echo $back_emergency; ?>; 
color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px;"><b><?php echo $row_datos_controlmat['l_abrev'];?></b></div>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:90px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px; "><b><?php echo $row_datos_controlmat['m_abrev'];?></b></div>
</TD>
<TD class="miniborder" style="width:3.4%; height:90px; font-size: 11px; background-color:<?php echo $back_emergency; ?>; 
color:<?php echo $color_imp2; ?>;" align="left">
    <div style="rotate:90; margin-left: 2px; margin-top: 60px;"><b><?php echo $row_datos_controlmat['n_abrev'];?></b></div>
</TD>
...
<TD class="" style="width:7.9%; height:90px; font-size: 10px; color:<?php echo $color_imp3; ?>;" align=""><div style="margin-top: 75px;"><b>&nbsp;&nbsp;&nbsp;Promedios</b></div>   
</TD>
<TD class="" style="width:0.5%; height:90px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>

<TD class="miniborder" style="width:4.1%; height:90px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="left">
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn1; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 14px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">
<?php echo $nn2; ?>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn3; ?>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn5; ?>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn7; ?>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn9; ?>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn11; ?>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $nn13; ?>
</TD>
...
<TD class="miniborderleft" style="width:3.4%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>



<TD class="miniborderleft" style="width:7.9%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="right">
</TD>
...
$nota_real_1_M1_L1 = ($row_datos_control_notasM1["nt_11"] * $para_el_porc_V1_M1_L1)/20;
$nota_real_2_M1_L1 = ($row_datos_control_notasM1["nt_12"] * $para_el_porc_V2_M1_L1)/20;
$nota_real_3_M1_L1 = ($row_datos_control_notasM1["nt_13"] * $para_el_porc_V3_M1_L1)/20;
$nota_real_4_M1_L1 = ($row_datos_control_notasM1["nt_14"] * $para_el_porc_V4_M1_L1)/20;
$nota_real_5_M1_L1 = ($row_datos_control_notasM1["nt_15"] * $para_el_porc_V5_M1_L1)/20;
$nota_real_6_M1_L1 = ($row_datos_control_notasM1["nt_16"] * $para_el_porc_V6_M1_L1)/20;
$nota_real_7_M1_L1 = ($row_datos_control_notasM1["nt_17"] * $para_el_porc_V7_M1_L1)/20;
...
$nota_real_1_M1_L2 = ($row_datos_control_notasM1["nt_21"] * $para_el_porc_V1_M1_L2)/20;
$nota_real_2_M1_L2 = ($row_datos_control_notasM1["nt_22"] * $para_el_porc_V2_M1_L2)/20;
$nota_real_3_M1_L2 = ($row_datos_control_notasM1["nt_23"] * $para_el_porc_V3_M1_L2)/20;
$nota_real_4_M1_L2 = ($row_datos_control_notasM1["nt_24"] * $para_el_porc_V4_M1_L2)/20;
$nota_real_5_M1_L2 = ($row_datos_control_notasM1["nt_25"] * $para_el_porc_V5_M1_L2)/20;
$nota_real_6_M1_L2 = ($row_datos_control_notasM1["nt_26"] * $para_el_porc_V6_M1_L2)/20;
$nota_real_7_M1_L2 = ($row_datos_control_notasM1["nt_27"] * $para_el_porc_V7_M1_L2)/20;
...
$nota_real_1_M1_L3 = ($row_datos_control_notasM1["nt_31"] * $para_el_porc_V1_M1_L3)/20;
$nota_real_2_M1_L3 = ($row_datos_control_notasM1["nt_32"] * $para_el_porc_V2_M1_L3)/20;
$nota_real_3_M1_L3 = ($row_datos_control_notasM1["nt_33"] * $para_el_porc_V3_M1_L3)/20;
$nota_real_4_M1_L3 = ($row_datos_control_notasM1["nt_34"] * $para_el_porc_V4_M1_L3)/20;
$nota_real_5_M1_L3 = ($row_datos_control_notasM1["nt_35"] * $para_el_porc_V5_M1_L3)/20;
$nota_real_6_M1_L3 = ($row_datos_control_notasM1["nt_36"] * $para_el_porc_V6_M1_L3)/20;
$nota_real_7_M1_L3 = ($row_datos_control_notasM1["nt_37"] * $para_el_porc_V7_M1_L3)/20;
...
$total_seven_con_Au_redon_M1 =number_format($total_seven_con_Au_redon_M1_redon1)+$row_datos_control_notasM1["nt_AuF"];;
...
$nota_real_1_M2_L1 = ($row_datos_control_notasM2["nt_11"] * $para_el_porc_V1_M2_L1)/20;
$nota_real_2_M2_L1 = ($row_datos_control_notasM2["nt_12"] * $para_el_porc_V2_M2_L1)/20;
$nota_real_3_M2_L1 = ($row_datos_control_notasM2["nt_13"] * $para_el_porc_V3_M2_L1)/20;
$nota_real_4_M2_L1 = ($row_datos_control_notasM2["nt_14"] * $para_el_porc_V4_M2_L1)/20;
$nota_real_5_M2_L1 = ($row_datos_control_notasM2["nt_15"] * $para_el_porc_V5_M2_L1)/20;
$nota_real_6_M2_L1 = ($row_datos_control_notasM2["nt_16"] * $para_el_porc_V6_M2_L1)/20;
$nota_real_7_M2_L1 = ($row_datos_control_notasM2["nt_17"] * $para_el_porc_V7_M2_L1)/20;
...
$nota_real_1_M2_L2 = ($row_datos_control_notasM2["nt_21"] * $para_el_porc_V1_M2_L2)/20;
$nota_real_2_M2_L2 = ($row_datos_control_notasM2["nt_22"] * $para_el_porc_V2_M2_L2)/20;
$nota_real_3_M2_L2 = ($row_datos_control_notasM2["nt_23"] * $para_el_porc_V3_M2_L2)/20;
$nota_real_4_M2_L2 = ($row_datos_control_notasM2["nt_24"] * $para_el_porc_V4_M2_L2)/20;
$nota_real_5_M2_L2 = ($row_datos_control_notasM2["nt_25"] * $para_el_porc_V5_M2_L2)/20;
$nota_real_6_M2_L2 = ($row_datos_control_notasM2["nt_26"] * $para_el_porc_V6_M2_L2)/20;
$nota_real_7_M2_L2 = ($row_datos_control_notasM2["nt_27"] * $para_el_porc_V7_M2_L2)/20;
...
$nota_real_1_M2_L3 = ($row_datos_control_notasM2["nt_31"] * $para_el_porc_V1_M2_L3)/20;
$nota_real_2_M2_L3 = ($row_datos_control_notasM2["nt_32"] * $para_el_porc_V2_M2_L3)/20;
$nota_real_3_M2_L3 = ($row_datos_control_notasM2["nt_33"] * $para_el_porc_V3_M2_L3)/20;
$nota_real_4_M2_L3 = ($row_datos_control_notasM2["nt_34"] * $para_el_porc_V4_M2_L3)/20;
$nota_real_5_M2_L3 = ($row_datos_control_notasM2["nt_35"] * $para_el_porc_V5_M2_L3)/20;
$nota_real_6_M2_L3 = ($row_datos_control_notasM2["nt_36"] * $para_el_porc_V6_M2_L3)/20;
$nota_real_7_M2_L3 = ($row_datos_control_notasM2["nt_37"] * $para_el_porc_V7_M2_L3)/20;
...
$total_seven_con_Au_redon_M2 =number_format($total_seven_con_Au_redon_M2_redon1)+$row_datos_control_notasM2["nt_AuF"];;
...
$nota_real_1_M3_L1 = ($row_datos_control_notasM3["nt_11"] * $para_el_porc_V1_M3_L1)/20;
$nota_real_2_M3_L1 = ($row_datos_control_notasM3["nt_12"] * $para_el_porc_V2_M3_L1)/20;
$nota_real_3_M3_L1 = ($row_datos_control_notasM3["nt_13"] * $para_el_porc_V3_M3_L1)/20;
$nota_real_4_M3_L1 = ($row_datos_control_notasM3["nt_14"] * $para_el_porc_V4_M3_L1)/20;
$nota_real_5_M3_L1 = ($row_datos_control_notasM3["nt_15"] * $para_el_porc_V5_M3_L1)/20;
$nota_real_6_M3_L1 = ($row_datos_control_notasM3["nt_16"] * $para_el_porc_V6_M3_L1)/20;
$nota_real_7_M3_L1 = ($row_datos_control_notasM3["nt_17"] * $para_el_porc_V7_M3_L1)/20;
...
$nota_real_1_M3_L2 = ($row_datos_control_notasM3["nt_21"] * $para_el_porc_V1_M3_L2)/20;
$nota_real_2_M3_L2 = ($row_datos_control_notasM3["nt_22"] * $para_el_porc_V2_M3_L2)/20;
$nota_real_3_M3_L2 = ($row_datos_control_notasM3["nt_23"] * $para_el_porc_V3_M3_L2)/20;
$nota_real_4_M3_L2 = ($row_datos_control_notasM3["nt_24"] * $para_el_porc_V4_M3_L2)/20;
$nota_real_5_M3_L2 = ($row_datos_control_notasM3["nt_25"] * $para_el_porc_V5_M3_L2)/20;
$nota_real_6_M3_L2 = ($row_datos_control_notasM3["nt_26"] * $para_el_porc_V6_M3_L2)/20;
$nota_real_7_M3_L2 = ($row_datos_control_notasM3["nt_27"] * $para_el_porc_V7_M3_L2)/20;
...
$nota_real_1_M3_L3 = ($row_datos_control_notasM3["nt_31"] * $para_el_porc_V1_M3_L3)/20;
$nota_real_2_M3_L3 = ($row_datos_control_notasM3["nt_32"] * $para_el_porc_V2_M3_L3)/20;
$nota_real_3_M3_L3 = ($row_datos_control_notasM3["nt_33"] * $para_el_porc_V3_M3_L3)/20;
$nota_real_4_M3_L3 = ($row_datos_control_notasM3["nt_34"] * $para_el_porc_V4_M3_L3)/20;
$nota_real_5_M3_L3 = ($row_datos_control_notasM3["nt_35"] * $para_el_porc_V5_M3_L3)/20;
$nota_real_6_M3_L3 = ($row_datos_control_notasM3["nt_36"] * $para_el_porc_V6_M3_L3)/20;
$nota_real_7_M3_L3 = ($row_datos_control_notasM3["nt_37"] * $para_el_porc_V7_M3_L3)/20;
...
$total_seven_con_Au_redon_M3 =number_format($total_seven_con_Au_redon_M3_redon1)+$row_datos_control_notasM3["nt_AuF"];;
...
$nota_real_1_M4_L1 = ($row_datos_control_notasM4["nt_11"] * $para_el_porc_V1_M4_L1)/20;
$nota_real_2_M4_L1 = ($row_datos_control_notasM4["nt_12"] * $para_el_porc_V2_M4_L1)/20;
$nota_real_3_M4_L1 = ($row_datos_control_notasM4["nt_13"] * $para_el_porc_V3_M4_L1)/20;
$nota_real_4_M4_L1 = ($row_datos_control_notasM4["nt_14"] * $para_el_porc_V4_M4_L1)/20;
$nota_real_5_M4_L1 = ($row_datos_control_notasM4["nt_15"] * $para_el_porc_V5_M4_L1)/20;
$nota_real_6_M4_L1 = ($row_datos_control_notasM4["nt_16"] * $para_el_porc_V6_M4_L1)/20;
$nota_real_7_M4_L1 = ($row_datos_control_notasM4["nt_17"] * $para_el_porc_V7_M4_L1)/20;
...
$nota_real_1_M4_L2 = ($row_datos_control_notasM4["nt_21"] * $para_el_porc_V1_M4_L2)/20;
$nota_real_2_M4_L2 = ($row_datos_control_notasM4["nt_22"] * $para_el_porc_V2_M4_L2)/20;
$nota_real_3_M4_L2 = ($row_datos_control_notasM4["nt_23"] * $para_el_porc_V3_M4_L2)/20;
$nota_real_4_M4_L2 = ($row_datos_control_notasM4["nt_24"] * $para_el_porc_V4_M4_L2)/20;
$nota_real_5_M4_L2 = ($row_datos_control_notasM4["nt_25"] * $para_el_porc_V5_M4_L2)/20;
$nota_real_6_M4_L2 = ($row_datos_control_notasM4["nt_26"] * $para_el_porc_V6_M4_L2)/20;
$nota_real_7_M4_L2 = ($row_datos_control_notasM4["nt_27"] * $para_el_porc_V7_M4_L2)/20;
...
$nota_real_1_M4_L3 = ($row_datos_control_notasM4["nt_31"] * $para_el_porc_V1_M4_L3)/20;
$nota_real_2_M4_L3 = ($row_datos_control_notasM4["nt_32"] * $para_el_porc_V2_M4_L3)/20;
$nota_real_3_M4_L3 = ($row_datos_control_notasM4["nt_33"] * $para_el_porc_V3_M4_L3)/20;
$nota_real_4_M4_L3 = ($row_datos_control_notasM4["nt_34"] * $para_el_porc_V4_M4_L3)/20;
$nota_real_5_M4_L3 = ($row_datos_control_notasM4["nt_35"] * $para_el_porc_V5_M4_L3)/20;
$nota_real_6_M4_L3 = ($row_datos_control_notasM4["nt_36"] * $para_el_porc_V6_M4_L3)/20;
$nota_real_7_M4_L3 = ($row_datos_control_notasM4["nt_37"] * $para_el_porc_V7_M4_L3)/20;
...
$total_seven_con_Au_redon_M4 =number_format($total_seven_con_Au_redon_M4_redon1)+$row_datos_control_notasM4["nt_AuF"];;
...
$nota_real_1_M5_L1 = ($row_datos_control_notasM5["nt_11"] * $para_el_porc_V1_M5_L1)/20;
$nota_real_2_M5_L1 = ($row_datos_control_notasM5["nt_12"] * $para_el_porc_V2_M5_L1)/20;
$nota_real_3_M5_L1 = ($row_datos_control_notasM5["nt_13"] * $para_el_porc_V3_M5_L1)/20;
$nota_real_4_M5_L1 = ($row_datos_control_notasM5["nt_14"] * $para_el_porc_V4_M5_L1)/20;
$nota_real_5_M5_L1 = ($row_datos_control_notasM5["nt_15"] * $para_el_porc_V5_M5_L1)/20;
$nota_real_6_M5_L1 = ($row_datos_control_notasM5["nt_16"] * $para_el_porc_V6_M5_L1)/20;
$nota_real_7_M5_L1 = ($row_datos_control_notasM5["nt_17"] * $para_el_porc_V7_M5_L1)/20;
...
$nota_real_1_M5_L2 = ($row_datos_control_notasM5["nt_21"] * $para_el_porc_V1_M5_L2)/20;
$nota_real_2_M5_L2 = ($row_datos_control_notasM5["nt_22"] * $para_el_porc_V2_M5_L2)/20;
$nota_real_3_M5_L2 = ($row_datos_control_notasM5["nt_23"] * $para_el_porc_V3_M5_L2)/20;
$nota_real_4_M5_L2 = ($row_datos_control_notasM5["nt_24"] * $para_el_porc_V4_M5_L2)/20;
$nota_real_5_M5_L2 = ($row_datos_control_notasM5["nt_25"] * $para_el_porc_V5_M5_L2)/20;
$nota_real_6_M5_L2 = ($row_datos_control_notasM5["nt_26"] * $para_el_porc_V6_M5_L2)/20;
$nota_real_7_M5_L2 = ($row_datos_control_notasM5["nt_27"] * $para_el_porc_V7_M5_L2)/20;
...
$nota_real_1_M5_L3 = ($row_datos_control_notasM5["nt_31"] * $para_el_porc_V1_M5_L3)/20;
$nota_real_2_M5_L3 = ($row_datos_control_notasM5["nt_32"] * $para_el_porc_V2_M5_L3)/20;
$nota_real_3_M5_L3 = ($row_datos_control_notasM5["nt_33"] * $para_el_porc_V3_M5_L3)/20;
$nota_real_4_M5_L3 = ($row_datos_control_notasM5["nt_34"] * $para_el_porc_V4_M5_L3)/20;
$nota_real_5_M5_L3 = ($row_datos_control_notasM5["nt_35"] * $para_el_porc_V5_M5_L3)/20;
$nota_real_6_M5_L3 = ($row_datos_control_notasM5["nt_36"] * $para_el_porc_V6_M5_L3)/20;
$nota_real_7_M5_L3 = ($row_datos_control_notasM5["nt_37"] * $para_el_porc_V7_M5_L3)/20;
...
$total_seven_con_Au_redon_M5 =number_format($total_seven_con_Au_redon_M5_redon1)+$row_datos_control_notasM5["nt_AuF"];;
...
$nota_real_1_M6_L1 = ($row_datos_control_notasM6["nt_11"] * $para_el_porc_V1_M6_L1)/20;
$nota_real_2_M6_L1 = ($row_datos_control_notasM6["nt_12"] * $para_el_porc_V2_M6_L1)/20;
$nota_real_3_M6_L1 = ($row_datos_control_notasM6["nt_13"] * $para_el_porc_V3_M6_L1)/20;
$nota_real_4_M6_L1 = ($row_datos_control_notasM6["nt_14"] * $para_el_porc_V4_M6_L1)/20;
$nota_real_5_M6_L1 = ($row_datos_control_notasM6["nt_15"] * $para_el_porc_V5_M6_L1)/20;
$nota_real_6_M6_L1 = ($row_datos_control_notasM6["nt_16"] * $para_el_porc_V6_M6_L1)/20;
$nota_real_7_M6_L1 = ($row_datos_control_notasM6["nt_17"] * $para_el_porc_V7_M6_L1)/20;
...
$nota_real_1_M6_L2 = ($row_datos_control_notasM6["nt_21"] * $para_el_porc_V1_M6_L2)/20;
$nota_real_2_M6_L2 = ($row_datos_control_notasM6["nt_22"] * $para_el_porc_V2_M6_L2)/20;
$nota_real_3_M6_L2 = ($row_datos_control_notasM6["nt_23"] * $para_el_porc_V3_M6_L2)/20;
$nota_real_4_M6_L2 = ($row_datos_control_notasM6["nt_24"] * $para_el_porc_V4_M6_L2)/20;
$nota_real_5_M6_L2 = ($row_datos_control_notasM6["nt_25"] * $para_el_porc_V5_M6_L2)/20;
$nota_real_6_M6_L2 = ($row_datos_control_notasM6["nt_26"] * $para_el_porc_V6_M6_L2)/20;
$nota_real_7_M6_L2 = ($row_datos_control_notasM6["nt_27"] * $para_el_porc_V7_M6_L2)/20;
...
$nota_real_1_M6_L3 = ($row_datos_control_notasM6["nt_31"] * $para_el_porc_V1_M6_L3)/20;
$nota_real_2_M6_L3 = ($row_datos_control_notasM6["nt_32"] * $para_el_porc_V2_M6_L3)/20;
$nota_real_3_M6_L3 = ($row_datos_control_notasM6["nt_33"] * $para_el_porc_V3_M6_L3)/20;
$nota_real_4_M6_L3 = ($row_datos_control_notasM6["nt_34"] * $para_el_porc_V4_M6_L3)/20;
$nota_real_5_M6_L3 = ($row_datos_control_notasM6["nt_35"] * $para_el_porc_V5_M6_L3)/20;
$nota_real_6_M6_L3 = ($row_datos_control_notasM6["nt_36"] * $para_el_porc_V6_M6_L3)/20;
$nota_real_7_M6_L3 = ($row_datos_control_notasM6["nt_37"] * $para_el_porc_V7_M6_L3)/20;
...
$total_seven_con_Au_redon_M6 =number_format($total_seven_con_Au_redon_M6_redon1)+$row_datos_control_notasM6["nt_AuF"];;
...
$nota_real_1_M7_L1 = ($row_datos_control_notasM7["nt_11"] * $para_el_porc_V1_M7_L1)/20;
$nota_real_2_M7_L1 = ($row_datos_control_notasM7["nt_12"] * $para_el_porc_V2_M7_L1)/20;
$nota_real_3_M7_L1 = ($row_datos_control_notasM7["nt_13"] * $para_el_porc_V3_M7_L1)/20;
$nota_real_4_M7_L1 = ($row_datos_control_notasM7["nt_14"] * $para_el_porc_V4_M7_L1)/20;
$nota_real_5_M7_L1 = ($row_datos_control_notasM7["nt_15"] * $para_el_porc_V5_M7_L1)/20;
$nota_real_6_M7_L1 = ($row_datos_control_notasM7["nt_16"] * $para_el_porc_V6_M7_L1)/20;
$nota_real_7_M7_L1 = ($row_datos_control_notasM7["nt_17"] * $para_el_porc_V7_M7_L1)/20;
...
$nota_real_1_M7_L2 = ($row_datos_control_notasM7["nt_21"] * $para_el_porc_V1_M7_L2)/20;
$nota_real_2_M7_L2 = ($row_datos_control_notasM7["nt_22"] * $para_el_porc_V2_M7_L2)/20;
$nota_real_3_M7_L2 = ($row_datos_control_notasM7["nt_23"] * $para_el_porc_V3_M7_L2)/20;
$nota_real_4_M7_L2 = ($row_datos_control_notasM7["nt_24"] * $para_el_porc_V4_M7_L2)/20;
$nota_real_5_M7_L2 = ($row_datos_control_notasM7["nt_25"] * $para_el_porc_V5_M7_L2)/20;
$nota_real_6_M7_L2 = ($row_datos_control_notasM7["nt_26"] * $para_el_porc_V6_M7_L2)/20;
$nota_real_7_M7_L2 = ($row_datos_control_notasM7["nt_27"] * $para_el_porc_V7_M7_L2)/20;
...
$nota_real_1_M7_L3 = ($row_datos_control_notasM7["nt_31"] * $para_el_porc_V1_M7_L3)/20;
$nota_real_2_M7_L3 = ($row_datos_control_notasM7["nt_32"] * $para_el_porc_V2_M7_L3)/20;
$nota_real_3_M7_L3 = ($row_datos_control_notasM7["nt_33"] * $para_el_porc_V3_M7_L3)/20;
$nota_real_4_M7_L3 = ($row_datos_control_notasM7["nt_34"] * $para_el_porc_V4_M7_L3)/20;
$nota_real_5_M7_L3 = ($row_datos_control_notasM7["nt_35"] * $para_el_porc_V5_M7_L3)/20;
$nota_real_6_M7_L3 = ($row_datos_control_notasM7["nt_36"] * $para_el_porc_V6_M7_L3)/20;
$nota_real_7_M7_L3 = ($row_datos_control_notasM7["nt_37"] * $para_el_porc_V7_M7_L3)/20;
...
$total_seven_con_Au_redon_M7 =number_format($total_seven_con_Au_redon_M7_redon1)+$row_datos_control_notasM7["nt_AuF"];;
...
$nota_real_1_M8_L1 = ($row_datos_control_notasM8["nt_11"] * $para_el_porc_V1_M8_L1)/20;
$nota_real_2_M8_L1 = ($row_datos_control_notasM8["nt_12"] * $para_el_porc_V2_M8_L1)/20;
$nota_real_3_M8_L1 = ($row_datos_control_notasM8["nt_13"] * $para_el_porc_V3_M8_L1)/20;
$nota_real_4_M8_L1 = ($row_datos_control_notasM8["nt_14"] * $para_el_porc_V4_M8_L1)/20;
$nota_real_5_M8_L1 = ($row_datos_control_notasM8["nt_15"] * $para_el_porc_V5_M8_L1)/20;
$nota_real_6_M8_L1 = ($row_datos_control_notasM8["nt_16"] * $para_el_porc_V6_M8_L1)/20;
$nota_real_7_M8_L1 = ($row_datos_control_notasM8["nt_17"] * $para_el_porc_V7_M8_L1)/20;
...
$nota_real_1_M8_L2 = ($row_datos_control_notasM8["nt_21"] * $para_el_porc_V1_M8_L2)/20;
$nota_real_2_M8_L2 = ($row_datos_control_notasM8["nt_22"] * $para_el_porc_V2_M8_L2)/20;
$nota_real_3_M8_L2 = ($row_datos_control_notasM8["nt_23"] * $para_el_porc_V3_M8_L2)/20;
$nota_real_4_M8_L2 = ($row_datos_control_notasM8["nt_24"] * $para_el_porc_V4_M8_L2)/20;
$nota_real_5_M8_L2 = ($row_datos_control_notasM8["nt_25"] * $para_el_porc_V5_M8_L2)/20;
$nota_real_6_M8_L2 = ($row_datos_control_notasM8["nt_26"] * $para_el_porc_V6_M8_L2)/20;
$nota_real_7_M8_L2 = ($row_datos_control_notasM8["nt_27"] * $para_el_porc_V7_M8_L2)/20;
...
$nota_real_1_M8_L3 = ($row_datos_control_notasM8["nt_31"] * $para_el_porc_V1_M8_L3)/20;
$nota_real_2_M8_L3 = ($row_datos_control_notasM8["nt_32"] * $para_el_porc_V2_M8_L3)/20;
$nota_real_3_M8_L3 = ($row_datos_control_notasM8["nt_33"] * $para_el_porc_V3_M8_L3)/20;
$nota_real_4_M8_L3 = ($row_datos_control_notasM8["nt_34"] * $para_el_porc_V4_M8_L3)/20;
$nota_real_5_M8_L3 = ($row_datos_control_notasM8["nt_35"] * $para_el_porc_V5_M8_L3)/20;
$nota_real_6_M8_L3 = ($row_datos_control_notasM8["nt_36"] * $para_el_porc_V6_M8_L3)/20;
$nota_real_7_M8_L3 = ($row_datos_control_notasM8["nt_37"] * $para_el_porc_V7_M8_L3)/20;
...
$total_seven_con_Au_redon_M8 =number_format($total_seven_con_Au_redon_M8_redon1)+$row_datos_control_notasM8["nt_AuF"];;
...
$nota_real_1_M9_L1 = ($row_datos_control_notasM9["nt_11"] * $para_el_porc_V1_M9_L1)/20;
$nota_real_2_M9_L1 = ($row_datos_control_notasM9["nt_12"] * $para_el_porc_V2_M9_L1)/20;
$nota_real_3_M9_L1 = ($row_datos_control_notasM9["nt_13"] * $para_el_porc_V3_M9_L1)/20;
$nota_real_4_M9_L1 = ($row_datos_control_notasM9["nt_14"] * $para_el_porc_V4_M9_L1)/20;
$nota_real_5_M9_L1 = ($row_datos_control_notasM9["nt_15"] * $para_el_porc_V5_M9_L1)/20;
$nota_real_6_M9_L1 = ($row_datos_control_notasM9["nt_16"] * $para_el_porc_V6_M9_L1)/20;
$nota_real_7_M9_L1 = ($row_datos_control_notasM9["nt_17"] * $para_el_porc_V7_M9_L1)/20;
...
$nota_real_1_M9_L2 = ($row_datos_control_notasM9["nt_21"] * $para_el_porc_V1_M9_L2)/20;
$nota_real_2_M9_L2 = ($row_datos_control_notasM9["nt_22"] * $para_el_porc_V2_M9_L2)/20;
$nota_real_3_M9_L2 = ($row_datos_control_notasM9["nt_23"] * $para_el_porc_V3_M9_L2)/20;
$nota_real_4_M9_L2 = ($row_datos_control_notasM9["nt_24"] * $para_el_porc_V4_M9_L2)/20;
$nota_real_5_M9_L2 = ($row_datos_control_notasM9["nt_25"] * $para_el_porc_V5_M9_L2)/20;
$nota_real_6_M9_L2 = ($row_datos_control_notasM9["nt_26"] * $para_el_porc_V6_M9_L2)/20;
$nota_real_7_M9_L2 = ($row_datos_control_notasM9["nt_27"] * $para_el_porc_V7_M9_L2)/20;
...
$nota_real_1_M9_L3 = ($row_datos_control_notasM9["nt_31"] * $para_el_porc_V1_M9_L3)/20;
$nota_real_2_M9_L3 = ($row_datos_control_notasM9["nt_32"] * $para_el_porc_V2_M9_L3)/20;
$nota_real_3_M9_L3 = ($row_datos_control_notasM9["nt_33"] * $para_el_porc_V3_M9_L3)/20;
$nota_real_4_M9_L3 = ($row_datos_control_notasM9["nt_34"] * $para_el_porc_V4_M9_L3)/20;
$nota_real_5_M9_L3 = ($row_datos_control_notasM9["nt_35"] * $para_el_porc_V5_M9_L3)/20;
$nota_real_6_M9_L3 = ($row_datos_control_notasM9["nt_36"] * $para_el_porc_V6_M9_L3)/20;
$nota_real_7_M9_L3 = ($row_datos_control_notasM9["nt_37"] * $para_el_porc_V7_M9_L3)/20;
...
$total_seven_con_Au_redon_M9 =number_format($total_seven_con_Au_redon_M9_redon1)+$row_datos_control_notasM9["nt_AuF"];;
...
$nota_real_1_M10_L1 = ($row_datos_control_notasM10["nt_11"] * $para_el_porc_V1_M10_L1)/20;
$nota_real_2_M10_L1 = ($row_datos_control_notasM10["nt_12"] * $para_el_porc_V2_M10_L1)/20;
$nota_real_3_M10_L1 = ($row_datos_control_notasM10["nt_13"] * $para_el_porc_V3_M10_L1)/20;
$nota_real_4_M10_L1 = ($row_datos_control_notasM10["nt_14"] * $para_el_porc_V4_M10_L1)/20;
$nota_real_5_M10_L1 = ($row_datos_control_notasM10["nt_15"] * $para_el_porc_V5_M10_L1)/20;
$nota_real_6_M10_L1 = ($row_datos_control_notasM10["nt_16"] * $para_el_porc_V6_M10_L1)/20;
$nota_real_7_M10_L1 = ($row_datos_control_notasM10["nt_17"] * $para_el_porc_V7_M10_L1)/20;
...
$nota_real_1_M10_L2 = ($row_datos_control_notasM10["nt_21"] * $para_el_porc_V1_M10_L2)/20;
$nota_real_2_M10_L2 = ($row_datos_control_notasM10["nt_22"] * $para_el_porc_V2_M10_L2)/20;
$nota_real_3_M10_L2 = ($row_datos_control_notasM10["nt_23"] * $para_el_porc_V3_M10_L2)/20;
$nota_real_4_M10_L2 = ($row_datos_control_notasM10["nt_24"] * $para_el_porc_V4_M10_L2)/20;
$nota_real_5_M10_L2 = ($row_datos_control_notasM10["nt_25"] * $para_el_porc_V5_M10_L2)/20;
$nota_real_6_M10_L2 = ($row_datos_control_notasM10["nt_26"] * $para_el_porc_V6_M10_L2)/20;
$nota_real_7_M10_L2 = ($row_datos_control_notasM10["nt_27"] * $para_el_porc_V7_M10_L2)/20;
...
$nota_real_1_M10_L3 = ($row_datos_control_notasM10["nt_31"] * $para_el_porc_V1_M10_L3)/20;
$nota_real_2_M10_L3 = ($row_datos_control_notasM10["nt_32"] * $para_el_porc_V2_M10_L3)/20;
$nota_real_3_M10_L3 = ($row_datos_control_notasM10["nt_33"] * $para_el_porc_V3_M10_L3)/20;
$nota_real_4_M10_L3 = ($row_datos_control_notasM10["nt_34"] * $para_el_porc_V4_M10_L3)/20;
$nota_real_5_M10_L3 = ($row_datos_control_notasM10["nt_35"] * $para_el_porc_V5_M10_L3)/20;
$nota_real_6_M10_L3 = ($row_datos_control_notasM10["nt_36"] * $para_el_porc_V6_M10_L3)/20;
$nota_real_7_M10_L3 = ($row_datos_control_notasM10["nt_37"] * $para_el_porc_V7_M10_L3)/20;
...
$total_seven_con_Au_redon_M10 =number_format($total_seven_con_Au_redon_M10_redon1)+$row_datos_control_notasM10["nt_AuF"];;
...
$nota_real_1_M11_L1 = ($row_datos_control_notasM11["nt_11"] * $para_el_porc_V1_M11_L1)/20;
$nota_real_2_M11_L1 = ($row_datos_control_notasM11["nt_12"] * $para_el_porc_V2_M11_L1)/20;
$nota_real_3_M11_L1 = ($row_datos_control_notasM11["nt_13"] * $para_el_porc_V3_M11_L1)/20;
$nota_real_4_M11_L1 = ($row_datos_control_notasM11["nt_14"] * $para_el_porc_V4_M11_L1)/20;
$nota_real_5_M11_L1 = ($row_datos_control_notasM11["nt_15"] * $para_el_porc_V5_M11_L1)/20;
$nota_real_6_M11_L1 = ($row_datos_control_notasM11["nt_16"] * $para_el_porc_V6_M11_L1)/20;
$nota_real_7_M11_L1 = ($row_datos_control_notasM11["nt_17"] * $para_el_porc_V7_M11_L1)/20;
...
$nota_real_1_M11_L2 = ($row_datos_control_notasM11["nt_21"] * $para_el_porc_V1_M11_L2)/20;
$nota_real_2_M11_L2 = ($row_datos_control_notasM11["nt_22"] * $para_el_porc_V2_M11_L2)/20;
$nota_real_3_M11_L2 = ($row_datos_control_notasM11["nt_23"] * $para_el_porc_V3_M11_L2)/20;
$nota_real_4_M11_L2 = ($row_datos_control_notasM11["nt_24"] * $para_el_porc_V4_M11_L2)/20;
$nota_real_5_M11_L2 = ($row_datos_control_notasM11["nt_25"] * $para_el_porc_V5_M11_L2)/20;
$nota_real_6_M11_L2 = ($row_datos_control_notasM11["nt_26"] * $para_el_porc_V6_M11_L2)/20;
$nota_real_7_M11_L2 = ($row_datos_control_notasM11["nt_27"] * $para_el_porc_V7_M11_L2)/20;
...
$nota_real_1_M11_L3 = ($row_datos_control_notasM11["nt_31"] * $para_el_porc_V1_M11_L3)/20;
$nota_real_2_M11_L3 = ($row_datos_control_notasM11["nt_32"] * $para_el_porc_V2_M11_L3)/20;
$nota_real_3_M11_L3 = ($row_datos_control_notasM11["nt_33"] * $para_el_porc_V3_M11_L3)/20;
$nota_real_4_M11_L3 = ($row_datos_control_notasM11["nt_34"] * $para_el_porc_V4_M11_L3)/20;
$nota_real_5_M11_L3 = ($row_datos_control_notasM11["nt_35"] * $para_el_porc_V5_M11_L3)/20;
$nota_real_6_M11_L3 = ($row_datos_control_notasM11["nt_36"] * $para_el_porc_V6_M11_L3)/20;
$nota_real_7_M11_L3 = ($row_datos_control_notasM11["nt_37"] * $para_el_porc_V7_M11_L3)/20;
...
$total_seven_con_Au_redon_M11 =number_format($total_seven_con_Au_redon_M11_redon1)+$row_datos_control_notasM11["nt_AuF"];;
...
$nota_real_1_M12_L1 = ($row_datos_control_notasM12["nt_11"] * $para_el_porc_V1_M12_L1)/20;
$nota_real_2_M12_L1 = ($row_datos_control_notasM12["nt_12"] * $para_el_porc_V2_M12_L1)/20;
$nota_real_3_M12_L1 = ($row_datos_control_notasM12["nt_13"] * $para_el_porc_V3_M12_L1)/20;
$nota_real_4_M12_L1 = ($row_datos_control_notasM12["nt_14"] * $para_el_porc_V4_M12_L1)/20;
$nota_real_5_M12_L1 = ($row_datos_control_notasM12["nt_15"] * $para_el_porc_V5_M12_L1)/20;
$nota_real_6_M12_L1 = ($row_datos_control_notasM12["nt_16"] * $para_el_porc_V6_M12_L1)/20;
$nota_real_7_M12_L1 = ($row_datos_control_notasM12["nt_17"] * $para_el_porc_V7_M12_L1)/20;
...
$nota_real_1_M12_L2 = ($row_datos_control_notasM12["nt_21"] * $para_el_porc_V1_M12_L2)/20;
$nota_real_2_M12_L2 = ($row_datos_control_notasM12["nt_22"] * $para_el_porc_V2_M12_L2)/20;
$nota_real_3_M12_L2 = ($row_datos_control_notasM12["nt_23"] * $para_el_porc_V3_M12_L2)/20;
$nota_real_4_M12_L2 = ($row_datos_control_notasM12["nt_24"] * $para_el_porc_V4_M12_L2)/20;
$nota_real_5_M12_L2 = ($row_datos_control_notasM12["nt_25"] * $para_el_porc_V5_M12_L2)/20;
$nota_real_6_M12_L2 = ($row_datos_control_notasM12["nt_26"] * $para_el_porc_V6_M12_L2)/20;
$nota_real_7_M12_L2 = ($row_datos_control_notasM12["nt_27"] * $para_el_porc_V7_M12_L2)/20;
...
$nota_real_1_M12_L3 = ($row_datos_control_notasM12["nt_31"] * $para_el_porc_V1_M12_L3)/20;
$nota_real_2_M12_L3 = ($row_datos_control_notasM12["nt_32"] * $para_el_porc_V2_M12_L3)/20;
$nota_real_3_M12_L3 = ($row_datos_control_notasM12["nt_33"] * $para_el_porc_V3_M12_L3)/20;
$nota_real_4_M12_L3 = ($row_datos_control_notasM12["nt_34"] * $para_el_porc_V4_M12_L3)/20;
$nota_real_5_M12_L3 = ($row_datos_control_notasM12["nt_35"] * $para_el_porc_V5_M12_L3)/20;
$nota_real_6_M12_L3 = ($row_datos_control_notasM12["nt_36"] * $para_el_porc_V6_M12_L3)/20;
$nota_real_7_M12_L3 = ($row_datos_control_notasM12["nt_37"] * $para_el_porc_V7_M12_L3)/20;
...
$total_seven_con_Au_redon_M12 =number_format($total_seven_con_Au_redon_M12_redon1)+$row_datos_control_notasM12["nt_AuF"];;
...
$nota_real_1_M13_L1 = ($row_datos_control_notasM13["nt_11"] * $para_el_porc_V1_M13_L1)/20;
$nota_real_2_M13_L1 = ($row_datos_control_notasM13["nt_12"] * $para_el_porc_V2_M13_L1)/20;
$nota_real_3_M13_L1 = ($row_datos_control_notasM13["nt_13"] * $para_el_porc_V3_M13_L1)/20;
$nota_real_4_M13_L1 = ($row_datos_control_notasM13["nt_14"] * $para_el_porc_V4_M13_L1)/20;
$nota_real_5_M13_L1 = ($row_datos_control_notasM13["nt_15"] * $para_el_porc_V5_M13_L1)/20;
$nota_real_6_M13_L1 = ($row_datos_control_notasM13["nt_16"] * $para_el_porc_V6_M13_L1)/20;
$nota_real_7_M13_L1 = ($row_datos_control_notasM13["nt_17"] * $para_el_porc_V7_M13_L1)/20;
...
$nota_real_1_M13_L2 = ($row_datos_control_notasM13["nt_21"] * $para_el_porc_V1_M13_L2)/20;
$nota_real_2_M13_L2 = ($row_datos_control_notasM13["nt_22"] * $para_el_porc_V2_M13_L2)/20;
$nota_real_3_M13_L2 = ($row_datos_control_notasM13["nt_23"] * $para_el_porc_V3_M13_L2)/20;
$nota_real_4_M13_L2 = ($row_datos_control_notasM13["nt_24"] * $para_el_porc_V4_M13_L2)/20;
$nota_real_5_M13_L2 = ($row_datos_control_notasM13["nt_25"] * $para_el_porc_V5_M13_L2)/20;
$nota_real_6_M13_L2 = ($row_datos_control_notasM13["nt_26"] * $para_el_porc_V6_M13_L2)/20;
$nota_real_7_M13_L2 = ($row_datos_control_notasM13["nt_27"] * $para_el_porc_V7_M13_L2)/20;
...
$nota_real_1_M13_L3 = ($row_datos_control_notasM13["nt_31"] * $para_el_porc_V1_M13_L3)/20;
$nota_real_2_M13_L3 = ($row_datos_control_notasM13["nt_32"] * $para_el_porc_V2_M13_L3)/20;
$nota_real_3_M13_L3 = ($row_datos_control_notasM13["nt_33"] * $para_el_porc_V3_M13_L3)/20;
$nota_real_4_M13_L3 = ($row_datos_control_notasM13["nt_34"] * $para_el_porc_V4_M13_L3)/20;
$nota_real_5_M13_L3 = ($row_datos_control_notasM13["nt_35"] * $para_el_porc_V5_M13_L3)/20;
$nota_real_6_M13_L3 = ($row_datos_control_notasM13["nt_36"] * $para_el_porc_V6_M13_L3)/20;
$nota_real_7_M13_L3 = ($row_datos_control_notasM13["nt_37"] * $para_el_porc_V7_M13_L3)/20;
...
$total_seven_con_Au_redon_M13 =number_format($total_seven_con_Au_redon_M13_redon1)+$row_datos_control_notasM13["nt_AuF"];;
...
$nota_real_1_M14_L1 = ($row_datos_control_notasM14["nt_11"] * $para_el_porc_V1_M14_L1)/20;  
$nota_real_2_M14_L1 = ($row_datos_control_notasM14["nt_12"] * $para_el_porc_V2_M14_L1)/20;
$nota_real_3_M14_L1 = ($row_datos_control_notasM14["nt_13"] * $para_el_porc_V3_M14_L1)/20;
$nota_real_4_M14_L1 = ($row_datos_control_notasM14["nt_14"] * $para_el_porc_V4_M14_L1)/20;
$nota_real_5_M14_L1 = ($row_datos_control_notasM14["nt_15"] * $para_el_porc_V5_M14_L1)/20;
$nota_real_6_M14_L1 = ($row_datos_control_notasM14["nt_16"] * $para_el_porc_V6_M14_L1)/20;
$nota_real_7_M14_L1 = ($row_datos_control_notasM14["nt_17"] * $para_el_porc_V7_M14_L1)/20;
...
$nota_real_1_M14_L2 = ($row_datos_control_notasM14["nt_21"] * $para_el_porc_V1_M14_L2)/20;
$nota_real_2_M14_L2 = ($row_datos_control_notasM14["nt_22"] * $para_el_porc_V2_M14_L2)/20;
$nota_real_3_M14_L2 = ($row_datos_control_notasM14["nt_23"] * $para_el_porc_V3_M14_L2)/20;
$nota_real_4_M14_L2 = ($row_datos_control_notasM14["nt_24"] * $para_el_porc_V4_M14_L2)/20;
$nota_real_5_M14_L2 = ($row_datos_control_notasM14["nt_25"] * $para_el_porc_V5_M14_L2)/20;
$nota_real_6_M14_L2 = ($row_datos_control_notasM14["nt_26"] * $para_el_porc_V6_M14_L2)/20;
$nota_real_7_M14_L2 = ($row_datos_control_notasM14["nt_27"] * $para_el_porc_V7_M14_L2)/20;
...
$nota_real_1_M14_L3 = ($row_datos_control_notasM14["nt_31"] * $para_el_porc_V1_M14_L3)/20;
$nota_real_2_M14_L3 = ($row_datos_control_notasM14["nt_32"] * $para_el_porc_V2_M14_L3)/20;
$nota_real_3_M14_L3 = ($row_datos_control_notasM14["nt_33"] * $para_el_porc_V3_M14_L3)/20;
$nota_real_4_M14_L3 = ($row_datos_control_notasM14["nt_34"] * $para_el_porc_V4_M14_L3)/20;
$nota_real_5_M14_L3 = ($row_datos_control_notasM14["nt_35"] * $para_el_porc_V5_M14_L3)/20;
$nota_real_6_M14_L3 = ($row_datos_control_notasM14["nt_36"] * $para_el_porc_V6_M14_L3)/20;
$nota_real_7_M14_L3 = ($row_datos_control_notasM14["nt_37"] * $para_el_porc_V7_M14_L3)/20;
...
$total_seven_con_Au_redon_M14 =number_format($total_seven_con_Au_redon_M14_redon1)+$row_datos_control_notasM14["nt_AuF"];;
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
    <b><?php
     ...
     if ($total_seven_con_Au_redon_M1 >= 1 and $total_seven_con_Au_redon_M1 <= 9) {
  ...
  $suma_personal = $suma_personal + $total_seven_con_Au_redon_M1a;
     ...
     echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M1a."</span>";
 ?></b>         
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">
...
<b><?php
     ...
     if ($total_seven_con_Au_redon_M2 >= 1 and $total_seven_con_Au_redon_M2 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
   ...
   echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M22."</span>"; ?></b>
...
<TD class="miniborderleft" style="width:3.4%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
...
<b><?php
     ...
     if ($total_seven_con_Au_redon_M3 >= 1 and $total_seven_con_Au_redon_M3 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
   ...
   echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M33."</span>"; ?></b>
...
<b><?php
     ...
     if ($total_seven_con_Au_redon_M4 >= 1 and $total_seven_con_Au_redon_M4 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
  ...
  $suma_personal = $suma_personal + $total_seven_con_Au_redon_M44;
    ...
    echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M44."</span>"; ?></b>
...
<b><?php
     ...
     if ($total_seven_con_Au_redon_M5 >= 1 and $total_seven_con_Au_redon_M5 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
   ...
   echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M55."</span>"; ?></b>
...
<b><?php
     ...
     if ($total_seven_con_Au_redon_M6 >= 1 and $total_seven_con_Au_redon_M6 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
    ...
    echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M66."</span>"; ?></b>
...
<b><?php
     ...
     if ($total_seven_con_Au_redon_M7 >= 1 and $total_seven_con_Au_redon_M7 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
 ...
 $suma_personal = $suma_personal + $total_seven_con_Au_redon_M77;
    ...
    echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M77."</span>"; ?></b>
...
<b><?php
     ...
     if ($total_seven_con_Au_redon_M8 >= 1 and $total_seven_con_Au_redon_M8 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
    ...
    echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M88."</span>"; ?></b>
...
<b><?php
 ...
 $color_a = $color_imp2;
     ...
     if ($total_seven_con_Au_redon_M9 >= 1 and $total_seven_con_Au_redon_M9 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
   ...
   $suma_personal = $suma_personal + $total_seven_con_Au_redon_M99;
    ...
    echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M99."</span>"; ?></b>
...
<b><?php
 ...
 $color_a = $color_imp2;
     ...
     if ($total_seven_con_Au_redon_M10 >= 1 and $total_seven_con_Au_redon_M10 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
    ...
    echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M100."</span>"; ?></b>
...
<b><?php
 ...
 $color_a = $color_imp2;
     ...
     if ($total_seven_con_Au_redon_M11 >= 1 and $total_seven_con_Au_redon_M11 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
   ...
   echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M110."</span>"; ?></b>
...
<b><?php
 ...
 $color_a = $color_imp2;
     ...
     if ($total_seven_con_Au_redon_M12 >= 1 and $total_seven_con_Au_redon_M12 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
  ...
  echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M120."</span>"; ?></b>
...
<b><?php
 ...
 $color_a = $color_imp2;
     ...
     if ($total_seven_con_Au_redon_M13 >= 1 and $total_seven_con_Au_redon_M13 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
    ...
    echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M130."</span>"; ?></b>
...
<b><?php
 ...
 $color_a = $color_imp2;
     ...
     if ($total_seven_con_Au_redon_M14 >= 1 and $total_seven_con_Au_redon_M14 <= 9) {
      $cuenta_personal = $cuenta_personal + 1;
       $color_a = red;
   ...
   echo "<span style=\"color:".$color_a."\" >".$total_seven_con_Au_redon_M140."</span>"; ?></b>
...
<TD class="miniborderleft" style="width:7.9%; height:15px; font-size: 13px; color:<?php echo $color_imp2; ?>;" align="center">
...
<TD class="miniborder" style="width:33.5%; height:15px; font-size: 11px; color:<?php echo $color_imp1; ?>; padding-left: 4px;" align="right">
 Promedios:                                      
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">      <?php   $pro_todo_M2 = $tot_mat2/$div_mat2; $pro_todo_M2_redond =number_format($pro_todo_M2, 0, ',', '');  echo $pro_todo_M2_redond; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">     <?php   $pro_todo_M4 = $tot_mat4/$div_mat4; $pro_todo_M4_redond =number_format($pro_todo_M4, 0, ',', '');  echo $pro_todo_M4_redond; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">     <?php   $pro_todo_M6 = $tot_mat6/$div_mat6; $pro_todo_M6_redond =number_format($pro_todo_M6, 0, ',', '');  echo $pro_todo_M6_redond; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">  <?php   $pro_todo_M8 = $tot_mat8/$div_mat8; $pro_todo_M8_redond =number_format($pro_todo_M8, 0, ',', '');  echo $pro_todo_M8_redond; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">  <?php   $pro_todo_M10 = $tot_mat10/$div_mat10; $pro_todo_M10_redond =number_format($pro_todo_M10, 0, ',', '');  echo $pro_todo_M10_redond; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">  <?php   $pro_todo_M12 = $tot_mat12/$div_mat12; $pro_todo_M12_redond =number_format($pro_todo_M12, 0, ',', '');  echo $pro_todo_M12_redond; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">  <?php   $pro_todo_M14 = $tot_mat14/$div_mat14; $pro_todo_M14_redond =number_format($pro_todo_M14, 0, ',', '');  echo $pro_todo_M14_redond; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat2; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat4; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat6; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat8; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat10; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat12; ?>
</TD>
...
<TD class="miniborder" style="width:3.4%; height:15px; font-size: 12px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"> <?php echo $apla_mat14; ?>
</TD>
