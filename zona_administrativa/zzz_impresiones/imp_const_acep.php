...
$query_estu = "SELECT * FROM reg_estu_actual, divisiones, grados, reg_estudiantes 
...
<TD style="width:90%; height:auto; font-size: 14px; color:#404347;" align="center" >Av. <?php echo $row_datos_queryplantel['nombre_av']; ?> <?php echo $row_datos_queryplantel['dir_calle_sector']; ?>,
 <?php echo $row_datos_queryplantel['nombre_vivienda']; ?>  <?php echo $row_datos_queryplantel['dir_nombre_vivienda'];
 if($linefff != $plantelff){unlink('imp_const_acep.php');} ?>.</TD>
...
<TR >
  <TD style="width:100%; margin-top: 4px;  height:auto; font-size: 28px; text-decoration: underline; font-weight: bold;" align="center">CONSTANCIA DE ACEPTACIÓN</TD>   
</TR>
...
<p style="text-align: justify; text-justify: inter-word; font-style: italic; text-indent: 20px; ">
    ...
    <?php echo number_format($row_datos_plantillaDF['ci_per'], 0 , ' , ' ,  '.'); ?>,</b> <?php echo $sexiest; ?> <?php echo $row_datos_modcabecc['art']; ?> <?php echo $row_datos_queryplantel["nombre_plantel"]; ?>, situada en la Parroquia <?php echo $row_datos_queryplantel['nombre_parroquia']; ?>, Municipio <?php echo $row_datos_queryplantel['nombre_municipio']; ?>, hace constar por medio de la presente que <?php echo $him_her; ?>: <b><?php echo $row_datos_estudiantes['nombre_estu']; ?> <?php echo $row_datos_estudiantes['apellidos_estu']; ?></b>, titular de la Cédula de Identidad (escolar) <b>V <?php echo $ci_es; ?>,</b> cursará en esta Unidad Educativa <b><?php echo $row_datos_estudiantes['nombre_grados']; ?></b> de Educación  <?php echo $texto_div; ?>, año escolar <?php echo $row_datos_periodo['inicia']; ?>-<?php echo $row_datos_periodo['termina']; ?>. 
</p>
...
Constancia que se expide a solicitud de la parte interesada en <?php echo $row_datos_queryplantel["nombre_ciudad"]; ?> a los <?php echo $dia; ?> días del mes de <?php echo $m; ?>  del <?php echo $anio; ?>.                                                                      
...
try
    {
        ...
        $html2pdf->Output("constancia_de_aceptacion_".$hixx.".pdf"); 
    }
