...
$per3 = "SELECT foto_per_ci FROM plantilla_personal WHERE id_per = '$id_del_per3' Limit 1 ";
...
<TR>
  ...
  <TD class="miniborderlight" style="width:38%; height:auto;" align="center"  ROWSPAN=12>
    ...
    <img style="width:340px; max-height: auto;" src='../<?php echo $row_datos_per3['foto_per_ci']; ?>'/></TD>
