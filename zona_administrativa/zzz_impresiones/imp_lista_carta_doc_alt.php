...
<TD class="miniborder" style="width:20%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center"><b>Doc. de Id.</b>
</TD>

<TD class="miniborder" style="width:39%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
...
<TD class="miniborder" style="width:20%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center"><b><?php echo $row_datos_control['ci_estu']; ?></b>
</TD>
