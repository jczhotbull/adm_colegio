...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 14px; background-color:<?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center">
 <?php
$sistemilla = $_POST['sistema_de_ev'];
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 14px; background-color:<?php echo $back_emergency; ?>;  color:<?php echo $color_imp2; ?>;" align="center"><?php echo $simbolillo; ?>
</TD>
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $simbolillo; ?>
</TD>
...
$querymateria = "SELECT id_asign, A11, A12, A13, A14, A15, A16, A17, A21, A22, A23, A24, A25, A26, A27, A31, A32, A33, A34, A35, A36, A37, a_convertir FROM asignaturas
...
$convertir = $row_datos_controlmat['a_convertir']; 
...
$querymateria = "SELECT id_asign, B11, B12, B13, B14, B15, B16, B17, B21, B22, B23, B24, B25, B26, B27, B31, B32, B33, B34, B35, B36, B37, b_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['b_convertir'];  
...
$querymateria = "SELECT id_asign, C11, C12, C13, C14, C15, C16, C17, C21, C22, C23, C24, C25, C26, C27, C31, C32, C33, C34, C35, C36, C37, c_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['c_convertir'];  
...
$querymateria = "SELECT id_asign, D11, D12, D13, D14, D15, D16, D17, D21, D22, D23, D24, D25, D26, D27, D31, D32, D33, D34, D35, D36, D37, d_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['d_convertir'];  
...
$querymateria = "SELECT id_asign, E11, E12, E13, E14, E15, E16, E17, E21, E22, E23, E24, E25, E26, E27, E31, E32, E33, E34, E35, E36, E37, e_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['e_convertir'];  
...
$querymateria = "SELECT id_asign, F11, F12, F13, F14, F15, F16, F17, F21, F22, F23, F24, F25, F26, F27, F31, F32, F33, F34, F35, F36, F37, f_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['f_convertir'];  
...
$querymateria = "SELECT id_asign, G11, G12, G13, G14, G15, G16, G17, G21, G22, G23, G24, G25, G26, G27, G31, G32, G33, G34, G35, G36, G37, g_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;
...
$querymateria = "SELECT id_asign, H11, H12, H13, H14, H15, H16, H17, H21, H22, H23, H24, H25, H26, H27, H31, H32, H33, H34, H35, H36, H37, h_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['h_convertir']; 
...
$querymateria = "SELECT id_asign, I11, I12, I13, I14, I15, I16, I17, I21, I22, I23, I24, I25, I26, I27, I31, I32, I33, I34, I35, I36, I37, i_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['i_convertir']; 
...
$querymateria = "SELECT id_asign, J11, J12, J13, J14, J15, J16, J17, J21, J22, J23, J24, J25, J26, J27, J31, J32, J33, J34, J35, J36, J37, j_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['j_convertir']; 
...
$querymateria = "SELECT id_asign, K11, K12, K13, K14, K15, K16, K17, K21, K22, K23, K24, K25, K26, K27, K31, K32, K33, K34, K35, K36, K37, k_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['k_convertir']; 
...
$querymateria = "SELECT id_asign, L11, L12, L13, L14, L15, L16, L17, L21, L22, L23, L24, L25, L26, L27, L31, L32, L33, L34, L35, L36, L37, l_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['l_convertir'];  
...
$querymateria = "SELECT id_asign, M11, M12, M13, M14, M15, M16, M17, M21, M22, M23, M24, M25, M26, M27, M31, M32, M33, M34, M35, M36, M37, m_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['m_convertir']; 
...
$querymateria = "SELECT id_asign, N11, N12, N13, N14, N15, N16, N17, N21, N22, N23, N24, N25, N26, N27, N31, N32, N33, N34, N35, N36, N37, n_convertir FROM asignaturas
         WHERE id_asign = $la_asign_es                         
         GROUP BY id_asign Limit 1" ;

$datos_controlmat = mysqli_query($enlace, $querymateria) or die(mysqli_error());
$row_datos_controlmat = mysqli_fetch_array($datos_controlmat);
$convertir = $row_datos_controlmat['n_convertir']; 
...
$para_el_porc_V1 = ($V1 * $el_puntaje_completo_es)/100;
$para_el_porc_V2 = ($V2 * $el_puntaje_completo_es)/100;
$para_el_porc_V3 = ($V3 * $el_puntaje_completo_es)/100;
$para_el_porc_V4 = ($V4 * $el_puntaje_completo_es)/100;
$para_el_porc_V5 = ($V5 * $el_puntaje_completo_es)/100;
$para_el_porc_V6 = ($V6 * $el_puntaje_completo_es)/100;
$para_el_porc_V7 = ($V7 * $el_puntaje_completo_es)/100;
...
$nota_real_1 = ($row_datos_control_notas["nt_11"] * $para_el_porc_V1)/$el_puntaje_completo_es;
$nota_real_2 = ($row_datos_control_notas["nt_12"] * $para_el_porc_V2)/$el_puntaje_completo_es;
$nota_real_3 = ($row_datos_control_notas["nt_13"] * $para_el_porc_V3)/$el_puntaje_completo_es;
$nota_real_4 = ($row_datos_control_notas["nt_14"] * $para_el_porc_V4)/$el_puntaje_completo_es;
$nota_real_5 = ($row_datos_control_notas["nt_15"] * $para_el_porc_V5)/$el_puntaje_completo_es;
$nota_real_6 = ($row_datos_control_notas["nt_16"] * $para_el_porc_V6)/$el_puntaje_completo_es;
$nota_real_7 = ($row_datos_control_notas["nt_17"] * $para_el_porc_V7)/$el_puntaje_completo_es;
...
$nota_real_1 = ($row_datos_control_notas["nt_21"] * $para_el_porc_V1)/$el_puntaje_completo_es;
$nota_real_2 = ($row_datos_control_notas["nt_22"] * $para_el_porc_V2)/$el_puntaje_completo_es;
$nota_real_3 = ($row_datos_control_notas["nt_23"] * $para_el_porc_V3)/$el_puntaje_completo_es;
$nota_real_4 = ($row_datos_control_notas["nt_24"] * $para_el_porc_V4)/$el_puntaje_completo_es;
$nota_real_5 = ($row_datos_control_notas["nt_25"] * $para_el_porc_V5)/$el_puntaje_completo_es;
$nota_real_6 = ($row_datos_control_notas["nt_26"] * $para_el_porc_V6)/$el_puntaje_completo_es;
$nota_real_7 = ($row_datos_control_notas["nt_27"] * $para_el_porc_V7)/$el_puntaje_completo_es;
...
$nota_real_1 = ($row_datos_control_notas["nt_31"] * $para_el_porc_V1)/$el_puntaje_completo_es;
$nota_real_2 = ($row_datos_control_notas["nt_32"] * $para_el_porc_V2)/$el_puntaje_completo_es;
$nota_real_3 = ($row_datos_control_notas["nt_33"] * $para_el_porc_V3)/$el_puntaje_completo_es;
$nota_real_4 = ($row_datos_control_notas["nt_34"] * $para_el_porc_V4)/$el_puntaje_completo_es;
$nota_real_5 = ($row_datos_control_notas["nt_35"] * $para_el_porc_V5)/$el_puntaje_completo_es;
$nota_real_6 = ($row_datos_control_notas["nt_36"] * $para_el_porc_V6)/$el_puntaje_completo_es;
$nota_real_7 = ($row_datos_control_notas["nt_37"] * $para_el_porc_V7)/$el_puntaje_completo_es;
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 10px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"><?php if ($nota_real_1 == 0) { $nota_real_11 = ''; } else {$nota_real_11 = $nota_real_1;} 
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 10px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"><?php if ($nota_real_2 == 0) { $nota_real_22 = ''; } else {$nota_real_22 = $nota_real_2;} $sistemilla = $_POST['sistema_de_ev'];
$name1 = "Procesual";
$name2 = "Sumativa";
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 10px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"><?php if ($nota_real_3 == 0) { $nota_real_33 = ''; } else {$nota_real_33 = $nota_real_3;} $sistemilla = $_POST['sistema_de_ev'];
$name1 = "Procesual";
$name2 = "Sumativa";
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 10px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"><?php if ($nota_real_4 == 0) { $nota_real_44 = ''; } else {$nota_real_44 = $nota_real_4;} $sistemilla = $_POST['sistema_de_ev'];
$name1 = "Procesual";
$name2 = "Sumativa";
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 10px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"><?php if ($nota_real_5 == 0) { $nota_real_55 = ''; } else {$nota_real_55 = $nota_real_5;} $sistemilla = $_POST['sistema_de_ev'];
$name1 = "Procesual";
$name2 = "Sumativa";
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 10px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"><?php if ($nota_real_6 == 0) { $nota_real_66 = ''; } else {$nota_real_66 = $nota_real_6;} $sistemilla = $_POST['sistema_de_ev'];
$name1 = "Procesual";
$name2 = "Sumativa";
...
<TD class="miniborder" style="width:3.2%; height:15px; font-size: 10px; background-color: <?php echo $back_emergency; ?>; color:<?php echo $color_imp2; ?>;" align="center"><?php if ($nota_real_7 == 0) { $nota_real_77 = ''; } else {$nota_real_77 = $nota_real_7;} $sistemilla = $_POST['sistema_de_ev'];
$name1 = "Procesual";
$name2 = "Sumativa";
...
<TD class="miniborderleft" style="width:4.5%; height:15px; font-size: 13px; color:<?php echo $color_imp2; ?>;" align="right">
    <?php if ($total_seven_con_Au == 0) { $total_seven_con_Auu = ''; } else {$total_seven_con_Auu = number_format($total_seven_con_Au, 2, '.', '');} echo $total_seven_con_Auu; ?>
...
$resaltador = '#FFFFFF';
 ...
 if ($total_seven_con_Au >= 0 and $total_seven_con_Au <= $el_puntaje_aprobatorio_aprox  ) {
...
<TD class="miniborder" style="width:4.1%; height:15px; font-size: 14px; background-color:<?php echo $resaltador; ?>;  color:<?php echo $color_imp2; ?>;" align="center">
    ...
    if ($convertir == 1 AND $total_seven_con_Auu_redon != ''  ) {  /* numerico */
       echo $total_seven_con_Auu_redon;
} /* cierre numerico */
if ($convertir == 2 AND $total_seven_con_Auu_redon != '' ) {  /* alfabetico */
   if ($total_seven_con_Auu_redon >= $comparativo_formato_1) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_1;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_2) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_2;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_3) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_3;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_4) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_4;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_5) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_5;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_6) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_6;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_7) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_7;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_8) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_8;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_9) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_9;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_10) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_10;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_11) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_11;  }
   if ($total_seven_con_Auu_redon >= $comparativo_formato_12) { $alfabetico_seven_con_Auu_redon = $alfabetico_formato_12;  }
   echo $alfabetico_seven_con_Auu_redon; } /* cierre alfabetico */

if ($convertir == 3 AND $total_seven_con_Auu_redon != '' ) {  /* literal */
  if ($total_seven_con_Auu_redon >= $comparativo_formato_1) { $literal_seven_con_Auu_redon = $literal_formato_1;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_2) { $literal_seven_con_Auu_redon = $literal_formato_2;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_3) { $literal_seven_con_Auu_redon = $literal_formato_3;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_4) { $literal_seven_con_Auu_redon = $literal_formato_4;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_5) { $literal_seven_con_Auu_redon = $literal_formato_5;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_6) { $literal_seven_con_Auu_redon = $literal_formato_6;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_7) { $literal_seven_con_Auu_redon = $literal_formato_7;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_8) { $literal_seven_con_Auu_redon = $literal_formato_8;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_9) { $literal_seven_con_Auu_redon = $literal_formato_9;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_10) { $literal_seven_con_Auu_redon = $literal_formato_10;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_11) { $literal_seven_con_Auu_redon = $literal_formato_11;  }
  if ($total_seven_con_Auu_redon >= $comparativo_formato_12) { $literal_seven_con_Auu_redon = $literal_formato_12;  } 
  echo $literal_seven_con_Auu_redon; } /* cierre literal */

  if ($total_seven_con_Auu_redon == ''  ) {  /* numerico */
       echo $total_seven_con_Auu_redon;  }
