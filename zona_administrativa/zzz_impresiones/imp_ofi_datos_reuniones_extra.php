...
<TD class="miniborder" style="width:78%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center">Confirmar datos de contacto
</TD>
...
<TD class="miniborder" style="width:19%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center">Apellidos
</TD>



<TD class="miniborder" style="width:23%; height:16px; font-size: 12px; color:<?php echo $color_imp3; ?>;" align="center">Telf.(s)
</TD>


<TD class="miniborder" style="width:28%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center">Email
</TD>

<TD class="miniborder" style="width:27%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center">Anotaciones y/o Firma
</TD>
...
<TD class="miniborder" style="width:19%; height:16px; font-size: 13px; color:<?php echo $color_imp1; ?>; padding-left: 4px;" align="left">
...
<TD class="miniborder" style="width:23%; height:16px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center"><b><?php echo $row_datos_controlP['celular_repre']; ?></b>, <?php echo $row_datos_controlP['telefono_repre']; ?> 
</TD>
...
<TD class="miniborder" style="width:28%; height:16px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center"><?php echo $row_datos_controlP['email_repre']; ?>
</TD>

<TD class="miniborder" style="width:27%; height:18px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
