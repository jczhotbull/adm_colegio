...
<TD class="" style="width:35%; height:16px; font-size: 14px; color:#404347;" align="right">
</TD>

<TD class="miniborder" style="width:10%; height:16px; font-size: 14px; color:black;" align="center"><b>Doc. de Id.</b>
</TD>

<TD class="miniborder" style="width:32%; height:16px; font-size: 14px; color:grey;" align="center"><b>Email</b>
</TD>

<TD class="miniborder" style="width:20%; height:16px; font-size: 14px; color:grey;" align="center">
</TD>
...
<TD class="miniborder" style="width:35%; height:16px; font-size: 13px; color:black; padding-left: 4px;" align="left">
                                    <b><?php echo $row_datos_control['apellidos_estu']; ?></b>, <?php echo $row_datos_control['nombre_estu']; ?>
</TD>

<TD class="miniborder" style="width:10%; height:16px; font-size: 12px; color:black;" align="center"><b><?php echo $row_datos_control['ci_estu']; ?></b>
</TD>


<TD class="miniborder" style="width:32%; height:16px; font-size: 12px; color:grey;" align="center"><b><?php echo $row_datos_control['email_estu']; ?></b>
</TD>
