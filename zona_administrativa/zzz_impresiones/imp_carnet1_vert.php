...
<TD class="" style="width:2%; height:195px; font-size: 16px;" align=""><div style="rotate:90; margin-top: 50px; margin-left: -20px; "><b><?php echo $row_datos_periodo['inicia']; ?>-<?php echo $row_datos_periodo['termina']; ?></b></div>
</TD>
...
<TD class="" style="width:3%; height:195px; font-size: 16px; color: #34312F;" align=""><div style="rotate:90; margin-top: 40px; margin-left: -10px; "><b><?php echo $row_datos_plantilla1['ci_per']; ?></b></div>   
</TD> 


<TD class="" style="width:3%; height:195px; font-size: 16px; color:#006bb3;" align="">

<div style="rotate:90; margin-top: 50px; margin-left: -8px; ">

<?php  $string_r = str_replace(' ', '&nbsp;', $el_puesto_es) ?>
<B><?php echo $string_r; ?></B>
...
try
    {
        ...
        $html2pdf->Output("carnet1_vert.pdf"); 
    }
