...
<TD class="miniborder" style="width:7%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -20px;">Talla Camisa</div>
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:7%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -20px;">Talla Pantalón</div>
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:7%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -20px;">Talla Zapatos</div>
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:1%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:1%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
...
<TD class="" style="width:5%; height:65px; font-size: 16px; color:<?php echo $color_imp3; ?>;" align=""><div style="margin-top: 50px;">&nbsp;&nbsp;&nbsp;<b>.</b></div>  
</TD>
<TD class="" style="width:1%; height:65px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>

<TD class="" style="width:5%; height:65px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align=""><div style="margin-top: 50px;"><b>.</b></div>  
</TD>
...
<TD class="miniborder" style="width:7%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
...
<TD class="miniborder" style="width:1%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:1%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
...
$query = "SELECT * FROM reg_estu_actual, divisiones, grados, tall_cam, tall_pant, tall_zap, reg_estudiantes 
...
<TD class="miniborder" style="width:7%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['talla_camisa']; ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:7%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['nombre_pantalon']; ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:7%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['talla_zapato']; ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
...
try
    {
        ...
        $html2pdf->Output("Hoja_datos_camisa_pantalon_".$hixx.".pdf"); 
    }
