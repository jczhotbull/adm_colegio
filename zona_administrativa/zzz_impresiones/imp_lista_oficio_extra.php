...
<TD class="" style="width:35%; height:auto; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">&nbsp;&nbsp;______________________________
...
<TD class="" style="width:32%; height:auto; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">______________________________
</TD>
...
<TD class="" style="width:3%; height:105px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>

<TD class="" style="width:34%; height:105px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
...
<TD class="miniborder" style="width:4%; height:105px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:105px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:105px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
...
<TD class="" style="width:1%; height:105px; font-size: 12px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
...
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
...
<TD class="miniborder" style="width:5%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="right">
</TD>
<TD class="" style="width:1%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:5%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
...
<TD class="miniborder" style="width:4%; height:20px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:20px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:20px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center">
...
<TD class="miniborder" style="width:5%; height:20px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="right">
</TD>
<TD class="" style="width:1%; height:20px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:5%; height:20px; font-size: 13px; color:<?php echo $color_imp1; ?>;" align="center">
</TD>
