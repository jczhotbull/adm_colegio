...
<TD class="miniborder" style="width:54%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center"><b>Datos del Estudiante</b>
</TD>

<TD class="miniborder" style="width:43%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center">Datos del Representante
</TD>
...
<TD class="miniborder" style="width:17%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center">Apellidos
</TD>

<TD class="miniborder" style="width:17%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="center">Nombres
</TD>

<TD class="miniborder" style="width:9%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">Ci ó Ci Escolar
</TD>
<TD class="miniborder" style="width:7%; height:16px; font-size: 12px; color:<?php echo $color_imp1; ?>;" align="center">Fecha de Nac.
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">Sexo
</TD>
<TD class="miniborder" style="width:18%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">Apellidos
</TD>
<TD class="miniborder" style="width:18%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">Nombres
</TD>
<TD class="miniborder" style="width:7%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">Ci
</TD>
...
<TD class="miniborder" style="width:17%; height:16px; font-size: 13px; color:<?php echo $color_imp1; ?>; padding-left: 4px;" align="left">
...
<TD class="miniborder" style="width:9%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center"> V<?php echo $row_datos_control['ci_estu']; ?> 
</TD>
...
<TD class="miniborder" style="width:7%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">  <?php echo $date->format('d/m/Y'); ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center"><?php


if ($row_datos_control['id_sexo'] == '1') {
        $him_her = 'F';
      }

      if ($row_datos_control['id_sexo'] == '2') {
        $him_her = 'M';
      }
...
<TD class="miniborder" style="width:18%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center">
...
echo $row_datos_controlP['apellido_repre'];
...
<TD class="miniborder" style="width:7%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center"><?php echo $row_datos_controlP['ci_repre']; ?>
</TD>
