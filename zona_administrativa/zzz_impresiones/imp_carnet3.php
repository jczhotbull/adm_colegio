...
<td style="width:15%;" align="center" height="18" ROWSPAN=6><img style="width:82px;  max-height: auto;" src='../<?php echo $row_datos_plantilla3['foto_per']; ?>'/></td>


<td style="width:14%;" align="left" height="18" ROWSPAN=6><img style="width:110px;  max-height: auto;" src='../../000 Temporales/<?php echo $contenido3; ?>QR.png'/></td>
        <td style="width:25%;" align="center" height="18"></td>
        ...
        <TR>
        <td style="width:5%;" align="center" height="18"></td>
        <td style="width:20%; font-size: 12px;" align="center" height="18"><b><?php echo $row_datos_plantilla3['nombre_per']; ?></b></td>
        ...
        <TR>
        <td style="width:5%;" align="center" height="18"></td>
        <td style="width:20%; font-size: 12px;" align="center" height="18"><b><?php echo $row_datos_plantilla3['apellido_per']; ?></b></td>
        ...
        <TR>
        <td style="width:5%;" align="center" height="18"></td>
        <td style="width:20%; font-size: 14px;" align="center" height="18"><b>Ci: <?php echo $row_datos_plantilla3['ci_per']; ?></b></td>
       ...
       <td style="width:21% font-size: 12px; color:gray;" align="center" height="18">color, o con muy buena</td>      
        ...
        <TR>
       <td style="width:5%;" align="center" height="18"></td>
        <td style="width:20%; font-size: 18px; color:#006bb3;" align="center" height="18"><?php  $string_r3 = str_replace(' ', '&nbsp;', $el_puesto_es3) ?>
<B><?php echo $string_r3; ?></B></td>
