...
<TR>
 ...
 <table class="table1">
            ...
            <tr>
               ...
               <th colspan="3" BGCOLOR="<?php echo $color3;?>">Alumno</th>
            ...
            <tr>
                ...
                <th style="width:125px;height:10px;" BGCOLOR="<?php echo $color3b;?>">Apellidos</th>
                <th style="width:125px;height:10px;" BGCOLOR="<?php echo $color3b;?>">Nombres</th>
                <th style="width:125px;height:10px;" BGCOLOR="<?php echo $color3b;?>">Doc de Id.</th>

                <th class="dl" style="width:125px;height:10px;" BGCOLOR="<?php echo $color0;?>">Apellidos</th>
                <th style="width:125px;height:10px;" BGCOLOR="<?php echo $color0;?>">Nombres</th>
             
            </tr>

            <tr>
                <td style="width:125px;height:24px; font-size: 12px;"><b><?php echo $row_datos_control['apellidos_estu']; ?></b></td> 
                <td style="width:125px;height:24px; font-size: 12px;"><?php echo $row_datos_control['nombre_estu']; ?></td>
                <td style="width:125px;height:24px; font-size: 12px;"><?php echo $row_datos_control['ci_estu']; ?></td>
                <td style="width:125px;height:24px; font-size: 12px;"><b><?php echo $row_datos_estudiantes_YYY['apellido_repre']; ?></b></td>
                <td style="width:125px;height:24px; font-size: 12px;"><?php echo $row_datos_estudiantes_YYY['nombre_repre']; ?></td>
            </tr>

            <tr>
                
                <th style="width:125px;height:10px; font-size: 12px;" BGCOLOR="<?php echo $color3b;?>">Año - Ciclo Escolar</th>
 ...
 <table style="margin-top: 4px;" class="table2">
                <tr>
                    <th style="width:144px;height:10px;" BGCOLOR="<?php echo $color0;?>">Asignaturas</th>
                    <th style="height:10px;"  colspan="2" BGCOLOR="<?php echo $color1;?>">&nbsp;
                        <span style="color:grey; font-size: 10px;">Nota</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1°&nbsp;&nbsp;&nbsp;<span style="color:grey; font-size: 10px;">Promedio</span><br>



                        <span style="color:grey;">Alumno</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: grey;">&nbsp;&nbsp;&nbsp;&nbsp;Aula</span>&nbsp;&nbsp;&nbsp;&nbsp;

                    </th>
                    <th style="height:10px;" colspan="2" BGCOLOR="<?php echo $color2;?>">2°<br><span style="color:grey;">Alumno</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: grey;">&nbsp;&nbsp;&nbsp;&nbsp;Aula</span>&nbsp;&nbsp;&nbsp;&nbsp;</th>
                    <th style="height:10px;" colspan="2" BGCOLOR="<?php echo $color3;?>">3°<br><span style="color:grey;">Alumno</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: grey;">&nbsp;&nbsp;&nbsp;&nbsp;Aula</span>&nbsp;&nbsp;&nbsp;&nbsp;</th>


                    <th style="height:10px;" colspan="2" BGCOLOR="<?php echo $color5;?>">Definitiva<br><span style="color:grey;">Alumno</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: grey;">&nbsp;&nbsp;&nbsp;&nbsp;Aula</span>&nbsp;&nbsp;&nbsp;&nbsp;</th>
                </tr>
                <tr style="font-size: 12px;">
                <td style="width:144px;height:10px;"><?php echo $row_datos_controlmat['a_aaa'];?>
...
?>
                    ...
                    <td style="width:72px;height:10px; background-color: #E5F8DC;"  ><b><?php echo $total_seven_con_Au_redon_M1_L1xx;?></b></td> <!-- marca la primera primera nota -->
...
if ($row_datos_controlmat['a_suma'] != 1)
 ...
 echo $lap1_pro_todo_M1_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #FDFAE1; "><b><?php echo $total_seven_con_Au_redon_M1_L2xx;?></b></td>
                    <td style="width:72px;height:10px;">
<?php 
if ($lap2_div_mat1 == '') {
...
// error incierto arriba
 ...
 echo $lap2_pro_todo_M1_redond; ?>
                    ...
                    <td style="width:72px;height:10px;  background-color: #FDEDDA; "><b><?php echo $total_seven_con_Au_redon_M1_L3xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
// error incierto arriba
 ...
 echo $lap3_pro_todo_M1_redond; ?>   
                    ...
                    <td style="width:72px;height:10px; background-color: #E8F3FB; ">
...
$pruebass1 = $row_datos_control_notasM1["rev_uno"];

$pruebass2 = $row_datos_control_notasM1["rev_dos"];


if ($pruebass1 != '' or $pruebass2 != '') {
   


        if ($pruebass1 > $pruebass2) {

        $pruebass_redond =number_format($pruebass1);
        ...
        $pruebass_redond =number_format($pruebass2);

        $fraseee = 'Rv2.= ';

        }

echo $fraseee; echo $pruebass_redond;
...
?>
                      ...
                      <tr style="font-size: 12px;"   >
                    <td style="width:144px;height:10px; background-color: #F4F3F3;"><?php echo $row_datos_controlmat['b_bbb'];?>
               ...
               $b_ayuda = '';
                ...
                echo $b_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M2_L1xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($row_datos_controlmat['b_suma'] != 1)
 ...
 echo $lap1_pro_todo_M2_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M2_L2xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($lap2_div_mat2 == '') {
 ...
 echo $lap2_pro_todo_M2_redond;   ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M2_L3xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
$pruebass1 = $row_datos_control_notasM2["rev_uno"];

$pruebass2 = $row_datos_control_notasM2["rev_dos"];
...
?>
                ...
                <tr style="font-size: 12px;"  >
                    <td style="width:144px;height:10px;"><?php echo $row_datos_controlmat['c_ccc'];?>
...
<span style="color:red;"><b> <?php
               ...
               $c_ayuda = '';
                ...
                echo $c_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px;  background-color: #E5F8DC; "><b><?php echo $total_seven_con_Au_redon_M3_L1xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($row_datos_controlmat['c_suma'] != 1)
 ...
 echo $lap1_pro_todo_M3_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #FDFAE1; "><b><?php echo $total_seven_con_Au_redon_M3_L2xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($lap2_div_mat3 == '') {
 ...
 echo $lap2_pro_todo_M3_redond; ?>
                    ...
                    <td style="width:72px;height:10px;  background-color: #FDF0E1; "><b><?php echo $total_seven_con_Au_redon_M3_L3xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
$pruebass1 = $row_datos_control_notasM3["rev_uno"];

$pruebass2 = $row_datos_control_notasM3["rev_dos"];
...
?>     
                  ...
                  <tr style="font-size: 12px;"  >
                    <td style="width:144px;height:10px; background-color: #F4F3F3;"><?php echo $row_datos_controlmat['d_ddd'];?>
...
<span style="color:red;"><b> <?php
               ...
               $d_ayuda = '';
                ...
                echo $d_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M4_L1xx;?></b></td>
                     <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($lap1_div_mat4 == '') {
 ...
 echo $lap1_pro_todo_M4_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M4_L2xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($lap2_div_mat4 == '') {
 ...
 echo $lap2_pro_todo_M4_redond; ?>   
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M4_L3xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
$pruebass1 = $row_datos_control_notasM4["rev_uno"];

$pruebass2 = $row_datos_control_notasM4["rev_dos"];
...
?>  
                ...
                <tr  style="font-size: 12px;"   >
                    <td style="width:144px;height:10px;"><?php echo $row_datos_controlmat['e_eee'];?>
...
<span style="color:red;"><b> <?php
               ...
               $e_ayuda = '';
                ...
                echo $e_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #E5F8DC; "><b><?php echo $total_seven_con_Au_redon_M5_L1xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($lap1_div_mat5 == '') {
  ...
  $lap1_pro_todo_M5_redondeado =number_format($lap1_pro_todo_M5, 1, '.', ''); 

    $lap1_pro_todo_M5_redond =number_format($lap1_pro_todo_M5_redondeado); 
...
if ($row_datos_controlmat['e_suma'] != 1)
 ...
 echo $lap1_pro_todo_M5_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #FDFAE1; "><b><?php echo $total_seven_con_Au_redon_M5_L2xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($lap2_div_mat5 == '') {
 ...
 echo $lap2_pro_todo_M5_redond; ?>  
                    ...
                    <td style="width:72px;height:10px;  background-color: #FDF0E1; "><b><?php echo $total_seven_con_Au_redon_M5_L3xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
$pruebass1 = $row_datos_control_notasM5["rev_uno"];

$pruebass2 = $row_datos_control_notasM5["rev_dos"];
...
?> 
                ...
                <tr style="font-size: 12px;"  >
                    <td style="width:144px;height:10px; background-color: #F4F3F3;"><?php echo $row_datos_controlmat['f_fff'];?>
...
<span style="color:red;"><b> <?php
               ...
               $f_ayuda = '';
                ...
                echo $f_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M6_L1xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
// tiene problemas arriba
 ...
 echo $lap1_pro_todo_M6_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M6_L2xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($row_datos_controlmat['f_suma'] != 1)
 ...
 echo $lap2_pro_todo_M6_redond; ?>   
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M6_L3xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
$pruebass1 = $row_datos_control_notasM6["rev_uno"];

$pruebass2 = $row_datos_control_notasM6["rev_dos"];
...
?> 
                ...
                <tr  style="font-size: 12px;"  >
                    <td style="width:144px;height:10px;"><?php echo $row_datos_controlmat['g_ggg'];?>
...
<span style="color:red;"><b> <?php
               ...
               $g_ayuda = '';
                ...
                echo $g_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #E5F8DC; "><b><?php echo $total_seven_con_Au_redon_M7_L1xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($lap1_div_mat7 == '') {
 ...
 echo $lap1_pro_todo_M7_redond; ?>
                    ...
                    <td style="width:72px;height:10px;  background-color: #FDFAE1; "><b><?php echo $total_seven_con_Au_redon_M7_L2xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($row_datos_controlmat['g_suma'] != 1)
 ...
 echo $lap2_pro_todo_M7_redond; ?>
                    ...
                    <td style="width:72px;height:10px;  background-color: #FDF0E1; "><b><?php echo $total_seven_con_Au_redon_M7_L3xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
// error incierto arriba
 ...
 echo $lap3_pro_todo_M7_redond; ?> 
                    ...
                    <td style="width:72px;height:10px; background-color: #E8F3FB;" ><b><?php
...
$pruebass1 = $row_datos_control_notasM7["rev_uno"];

$pruebass2 = $row_datos_control_notasM7["rev_dos"];
...
?> 
                ...
                <tr style="font-size: 12px;"  >
                    <td style="width:144px;height:10px; background-color: #F4F3F3;"><?php echo $row_datos_controlmat['h_hhh'];?>
                        <span style="color:red;"><b> <?php
               ...
               $h_ayuda = '';
                ...
                echo $h_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M8_L1xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($lap1_div_mat8 == '') {
 ...
 echo $lap1_pro_todo_M8_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M8_L2xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($row_datos_controlmat['h_suma'] != 1)
 ...
 echo $lap2_pro_todo_M8_redond; ?>   
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M8_L3xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
$pruebass1 = $row_datos_control_notasM8["rev_uno"];

$pruebass2 = $row_datos_control_notasM8["rev_dos"];
...
?> 
                ...
                <tr style="font-size: 12px;" >
                    <td style="width:144px;height:10px;"><?php echo $row_datos_controlmat['i_iii'];?>
                        <span style="color:red;"><b> <?php
               ...
               $i_ayuda = '';
                ...
                echo $i_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #E5F8DC; "><b><?php echo $total_seven_con_Au_redon_M9_L1xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($lap1_div_mat9 == '') {
 ...
 echo $lap1_pro_todo_M9_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #FDFAE1; "><b><?php echo $total_seven_con_Au_redon_M9_L2xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($row_datos_controlmat['i_suma'] != 1)
 ...
 echo $lap2_pro_todo_M9_redond; ?>   
                    ...
                    <td style="width:72px;height:10px; background-color: #FDF0E1; "><b><?php echo $total_seven_con_Au_redon_M9_L3xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
$pruebass1 = $row_datos_control_notasM9["rev_uno"];

$pruebass2 = $row_datos_control_notasM9["rev_dos"];
...
?> 
                                ...
                                <tr  style="font-size: 12px;" >
                    <td style="width:144px;height:10px; background-color: #F4F3F3;"><?php echo $row_datos_controlmat['j_jjj'];?>
...
<span style="color:red;"><b> <?php
               ...
               $j_ayuda = '';
                ...
                echo $j_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M10_L1xx;?></b></td>
                     <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($lap1_div_mat10 == '') {
 ...
 echo $lap1_pro_todo_M10_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M10_L2xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($row_datos_controlmat['j_suma'] != 1)
 ...
 echo $lap2_pro_todo_M10_redond; ?>   
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M10_L3xx;?></b></td>
                     <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
$pruebass1 = $row_datos_control_notasM10["rev_uno"];

$pruebass2 = $row_datos_control_notasM10["rev_dos"];
...
?> 
                ...
                <tr style="font-size: 12px;"  >
                    <td style="width:144px;height:10px;"><?php echo $row_datos_controlmat['k_kkk'];?>
...
<span style="color:red;"><b> <?php
               ...
               $k_ayuda = '';
                ...
                echo $k_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #E5F8DC; "><b><?php echo $total_seven_con_Au_redon_M11_L1xx;?></b></td>
                     <td style="width:72px;height:10px;">
...
if ($lap1_div_mat11 == '') {
 ...
 echo $lap1_pro_todo_M11_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #FDFAE1; "><b><?php echo $total_seven_con_Au_redon_M11_L2xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($row_datos_controlmat['k_suma'] != 1)
 ...
 echo $lap2_pro_todo_M11_redond; ?>   
                    ...
                    <td style="width:72px;height:10px; background-color: #FDF0E1; "><b><?php echo $total_seven_con_Au_redon_M11_L3xx;?></b></td>
                     <td style="width:72px;height:10px;">
...
$pruebass1 = $row_datos_control_notasM11["rev_uno"];

$pruebass2 = $row_datos_control_notasM11["rev_dos"];
...
?> 
                ...
                <tr  style="font-size: 12px;"  >
                    <td style="width:144px;height:10px; background-color: #F4F3F3;"><?php echo $row_datos_controlmat['l_lll'];?>
                        <span style="color:red;"><b> <?php
               ...
               $l_ayuda = '';
                ...
                echo $l_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M12_L1xx;?></b></td>
                     <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($lap1_div_mat12 == '') {
 ...
 echo $lap1_pro_todo_M12_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M12_L2xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($row_datos_controlmat['l_suma'] != 1)
 ...
 echo $lap2_pro_todo_M12_redond; ?>  
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M12_L3xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
$pruebass1 = $row_datos_control_notasM12["rev_uno"];

$pruebass2 = $row_datos_control_notasM12["rev_dos"];
...
?> 
                ...
                <tr style="font-size: 12px;" >
                    <td style="width:144px;height:10px;"><?php echo $row_datos_controlmat['m_mmm'];?>
...
<span style="color:red;"><b> <?php
               ...
               $m_ayuda = '';
                ...
                echo $m_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #E5F8DC; "><b><?php echo $total_seven_con_Au_redon_M13_L1xx;?></b></td>
                      <td style="width:72px;height:10px;">
...
$lap1_pro_todo_M13_redondeado1 =number_format($lap1_pro_todo_M13, 1, '.', ''); 
 ...
 echo $lap1_pro_todo_M13_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #FDFAE1; "><b><?php echo $total_seven_con_Au_redon_M13_L2xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
if ($row_datos_controlmat['m_suma'] != 1)
 ...
 echo $lap2_pro_todo_M13_redond; ?>  
                    ...
                    <td style="width:72px;height:10px; background-color: #FDF0E1; "><b><?php echo $total_seven_con_Au_redon_M13_L3xx;?></b></td>
                    <td style="width:72px;height:10px;">
...
$pruebass1 = $row_datos_control_notasM13["rev_uno"];

$pruebass2 = $row_datos_control_notasM13["rev_dos"];
...
?> 
                ...
                <tr style="font-size: 12px;"  >
                    <td style="width:144px;height:10px; background-color: #F4F3F3;"><?php echo $row_datos_controlmat['n_nnn'];?>
...
<span style="color:red;"><b> <?php
               ...
               $n_ayuda = '';
                ...
                echo $n_ayuda;?></b></span>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M14_L1xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
$lap1_pro_todo_M14_redondeado1 =number_format($lap1_pro_todo_M14, 1, '.', ''); 
 ...
 echo $lap1_pro_todo_M14_redond; ?>
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M14_L2xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
if ($row_datos_controlmat['n_suma'] != 1)
 ...
 echo $lap2_pro_todo_M14_redond; ?>   
                    ...
                    <td style="width:72px;height:10px; background-color: #F4F3F3;"><b><?php echo $total_seven_con_Au_redon_M14_L3xx;?></b></td>
                    <td style="width:72px;height:10px; background-color: #F4F3F3;">
...
$pruebass1 = $row_datos_control_notasM14["rev_uno"];

$pruebass2 = $row_datos_control_notasM14["rev_dos"];
...
<!--  por revisar de aqui en adelanteeeeeeeeeeeeeeeeeeeeeeeeeee -->
...
?>
                ...
                <tr>
                    ...
                    <td style="width:72px;height:10px;" BGCOLOR="#9EEC7A" ><b><?php echo $general_1xx;?></b></td>
                    <td style="width:72px;height:10px;" BGCOLOR="<?php echo $color1;?>" >
...
?></span>
                    ...
                    <td style="width:72px;height:10px;" BGCOLOR="#FAE087" ><b><?php echo $general_2xx;?></b></td>
                    <td style="width:72px;height:10px;" BGCOLOR="<?php echo $color2;?>" >
        <span style="font-size: 11px;">                
...
?></span>
                    ...
                    <td style="width:72px;height:10px;" BGCOLOR="#F1A96A" ><b><?php echo $general_3xx;?></b></td>
                    <td style="width:72px;height:10px;" BGCOLOR="<?php echo $color3;?>" >
...
?></span>
                    ...
                    <td style="width:72px;height:10px;" BGCOLOR="#ABC9F0" ><b><span style="font-size: 11px;"><?php echo $general_defxxx;?> =</span> <?php echo $general_defxxxE;?></b></td>
                    <td style="width:72px;height:10px;" BGCOLOR="<?php echo $color5;?>" >
...
echo $gran_promedio123xxx;

?> =</span> <?php echo $gran_promedio123xxxneto;?>
               ...
               <tr>
                    ...
                    <td colspan="2" style="width:144px;height:10px;" BGCOLOR="<?php echo $color1;?>" >
...
$lugar_aaa = ' '.$calificacion1.' de '.$lap3_totalRows_datos_control.' ';
 ...
 echo $lugar_aaa ;?>
                    ...
                    <td colspan="2" style="width:144px;height:10px;" BGCOLOR="<?php echo $color2;?>" >
...
$lugar_bbb = ' '.$calificacion2.' de '.$lap3_totalRows_datos_control.' ';
 ...
 echo $lugar_bbb ;?>
                    ...
                    <td colspan="2" style="width:144px;height:10px;" BGCOLOR="<?php echo $color3;?>" >
...
$lugar_ccc = ' '.$calificacion3.' de '.$lap3_totalRows_datos_control.' ';
 ...
 echo $lugar_ccc ;?>
                    ...
                    <td colspan="2" style="width:144px;height:10px;" BGCOLOR="<?php echo $color5;?>" >
...
$lugar_ddd = ' '.$calificacion4.' de '.$lap3_totalRows_datos_control.' ';
 ...
 echo $lugar_ddd; ?> 
        ...
        <table style="margin-top: 4px;">
            <tr>
                <td style="width:60%;height:22px; font-size: 12px;" class="table1" align="left" >&nbsp; <b>Observación:</b> "<b style="color:red;">#</b>" la materia no suma en el promedio.<br> <span style="color: white;">_____________________________________________________________________________</span>  </td>
