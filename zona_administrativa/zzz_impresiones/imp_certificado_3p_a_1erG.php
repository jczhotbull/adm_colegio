...
<TR >
  <TD style="width:100%; margin-top: 4px;  height:auto; font-size: 21px; font-weight: bold;" align="center">CERTIFICACIÓN DE ESTUDIOS</TD>   
</TR>

<TR >
  <TD style="width:100%; margin-top: 4px;  height:auto; font-size: 21px; font-weight: bold;" align="center">DEL NIVEL DE EDUCACIÓN INICIAL</TD>   
</TR>
...
if ($row_datos_estudiantes['nombre_grados'] == 'Pre Esc. 3° Nivel' ) {
 $pre_fijo_grado = 'III';
 $next_grado = '1er';
}
