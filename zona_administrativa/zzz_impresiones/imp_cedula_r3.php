...
$per1 = "SELECT foto_ci_repre FROM reg_representante WHERE id_repre = '$id_del_per' Limit 1 ";
...
$per2 = "SELECT foto_ci_repre FROM reg_representante WHERE id_repre = '$id_del_per2' Limit 1 ";
...
$per3 = "SELECT foto_ci_repre FROM reg_representante WHERE id_repre = '$id_del_per3' Limit 1 ";
$datos_per3 = mysqli_query($enlace, $per3) or die(mysqli_error());
$row_datos_per3 = mysqli_fetch_assoc($datos_per3);
...
<TR>
  ...
  <TD class="miniborderlight" style="width:38%; height:auto;" align="center"  ROWSPAN=12>
    ...
    <img style="width:340px; max-height: auto;" src='../<?php echo $row_datos_per1['foto_ci_repre']; ?>'/></TD>
...
<TR>
  ...
  <TD class="miniborderlight" style="width:38%; height:auto;" align="center"  ROWSPAN=12>
    ...
    <img style="width:340px; max-height: auto;" src='../<?php echo $row_datos_per2['foto_ci_repre']; ?>'/></TD>
...
<TR>
  ...
  <TD class="miniborderlight" style="width:38%; height:auto;" align="center"  ROWSPAN=12>
    ...
    <img style="width:340px; max-height: auto;" src='../<?php echo $row_datos_per3['foto_ci_repre']; ?>'/></TD>
