...
<TR >
  <TD style="width:100%; margin-top: 4px;  height:auto; font-size: 21px; font-weight: bold;" align="center">EN EL NIVEL DE EDUCACIÓN PRIMARIA</TD>   
</TR>
...
if ($row_datos_estudiantes['nombre_grados'] == '1er Grado' ) {
 $pre_fijo_grado = '1er';
 $next_grado = '2do';
}

if ($row_datos_estudiantes['nombre_grados'] == '2do Grado' ) {
 $pre_fijo_grado = '2do';
 $next_grado = '3er';
}


if ($row_datos_estudiantes['nombre_grados'] == '3er Grado' ) {
 $pre_fijo_grado = '3er';
 $next_grado = '4to';
}


if ($row_datos_estudiantes['nombre_grados'] == '4to Grado' ) {
 $pre_fijo_grado = '4to';
 $next_grado = '5to';
}


if ($row_datos_estudiantes['nombre_grados'] == '5to Grado' ) {
 $pre_fijo_grado = '5to';
 $next_grado = '6to';
}
...
Quien suscribe&nbsp;<u><b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row_datos_modcabecc['firma_1']; ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </b></u> titular de la Cédula de Identidad N°&nbsp;<u><b> &nbsp; &nbsp; &nbsp; &nbsp; <?php echo number_format($row_datos_plantillaDF['ci_per'], 0 , ' , ' ,  '.'); ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </b></u> en su condición de Director(a) (E) del&nbsp;<u><b> &nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row_datos_queryplantel["nombre_plantel"]; ?> &nbsp; &nbsp; &nbsp; &nbsp; </b></u> ubicado en el municipio&nbsp;<u><b> &nbsp; &nbsp; &nbsp; <?php echo $row_datos_queryplantel['nombre_municipio']; ?> &nbsp; &nbsp; &nbsp; </b></u> de la parroquia&nbsp;<u><b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row_datos_queryplantel['nombre_parroquia']; ?>, &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </b></u> adscrito a la Zona Educativa del estado&nbsp;<u> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row_datos_modcabecc['zona_e']; ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </u> certifica por medio de la presente que el(la) estudiante  &nbsp;<u><b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row_datos_estudiantes['apellidos_estu']; ?> <?php echo $row_datos_estudiantes['nombre_estu']; ?>, &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </b></u> Cédula de Identidad escolar N° <u><b> &nbsp; &nbsp; &nbsp; V <?php echo $ci_es; ?> &nbsp; &nbsp; &nbsp; </b></u> nacido(a) en&nbsp;<u><b> &nbsp; &nbsp; <?php echo $row_datos_estudiantes['nombre_ciudad']; ?> - Municipio <?php echo $row_datos_estudiantes['municipio_est']; ?> &nbsp; &nbsp; &nbsp; </b></u> en fecha&nbsp;<u><b> &nbsp; &nbsp; <?php echo $fecha_formateadAAA; ?>, &nbsp; &nbsp; </b></u> cursó el &nbsp;<u><b> &nbsp; &nbsp; <?php echo $pre_fijo_grado; ?> Grado &nbsp; &nbsp; </b></u>, correspondiéndole el literal &nbsp;<u><b> &nbsp; &nbsp; "<?php echo $este_es_la_nota; ?>" &nbsp; &nbsp; </b></u>, durante el período escolar &nbsp;<u><b> &nbsp; &nbsp; <?php echo $row_datos_estudiantes['periodo_escolar']; ?>&nbsp; &nbsp; </b></u>, <b> siendo promovido (a)  &nbsp;<u><b> &nbsp; &nbsp; <?php echo $next_grado; ?> Grado &nbsp; &nbsp; </b></u>,  del Nivel de Educación Primaria</b>; previo cumplimiento de los requisitos exigidos en la normativa legal vigente.             
...
try
    {
        ...
        $html2pdf->Output("constancia_de_prosecucion_".$hixx.".pdf"); 
    }
