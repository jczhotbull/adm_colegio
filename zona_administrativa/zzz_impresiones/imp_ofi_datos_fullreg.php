...
include("../../conectar.php");
$el_id = $row_datos_control['id_estud'];
$queryMa = "SELECT tlf_contacto_madre, email_madre FROM reg_madre
...
<?php  echo $firstnam; ?> <?php echo $firstCharacterlastnam; ?>. (Ma)
...
include("../../conectar.php");
$el_id = $row_datos_control['id_estud'];
$queryPa = "SELECT tlf_contacto_padre, email_padre FROM reg_padre
         WHERE   id_estud = '$el_id'  
...
<?php  echo $firstnam; ?> <?php echo $firstCharacterlastnam; ?>. (Pa)
...
<TD class="miniborder" style="width:30%; height:16px; font-size: 11px; color:<?php echo $color_imp1; ?>;" align="center"><?php echo $row_datos_controlPa['email_padre']; ?>
</TD>
