...
if($linefff != $plantelff){unlink('imp_plantilla.php');}
...
<TABLE class="basetabla" >
    ...
    <TR>
       <TD style="width:85%; height:auto; font-size: 16px;" align="center" > <b> HISTORIAL DEL DOCENTE </b></TD>
    </TR>
     <TR>
       <TD style="width:85%; height:auto;" align="center" > <b> (PARA USO DEL PERSONAL DIRECTIVO Y DOCENTES) </b> </TD> 
    </TR>
    <TR>
...
<TR>
    ...
    <TR>
        ...
        <TD  align="center" COLSPAN=2 height="18"><?php echo $_POST['nombre_cargoxz']; ?></TD>
    </TR>

    
</TABLE>

<span style="margin-top: 3px; font-size: 12px;"> SEÑALE LAS HORAS POR GRADO Y ASIGNATURAS QUE ATIENDE SEMANALMENTE EN ESTE PLANTEL </span>
...
<table class="basetabla bordecompleto" style="margin-top: 6px;" cellspacing="-1">
  ...
  <tr>
    ...
    <th style="width:30%;" align="center" height="24">ASIGNATURA</th>
    <th style="width:20%;" align="center" height="24">GRADO O AÑO</th>
    <th style="width:20%;" align="center" height="24">TURNO</th>
    <th style="width:20%;" align="center" height="24">SECCIÓN</th>
    <th style="width:12%;" align="center" height="24">HORAS</th>
...
while( $row_datos_plantillaTRA = mysqli_fetch_array($datos_plantillaTRA)){ 
...
<tr>
    ...
    <td style="width:30%;" align="center" height="18"> <?php echo $row_datos_plantillaTRA['nombre_area']; ?> </td>
    <td style="width:20%;" align="center" height="18"> <?php echo $row_datos_plantillaTRA['nombre_grados']; ?> </td>
    <td style="width:20%;" align="center" height="18"> <?php echo $row_datos_plantillaTRA['nombre_turno']; ?> </td>
    <td style="width:20%;" align="center" height="18"> <?php echo $row_datos_plantillaTRA['nombre_seccion']; ?> </td>
    <td style="width:12%;" align="center" height="18"> <?php echo $row_datos_plantillaTRA['nombre_hora']; ?> </td>
...
/* $totalhoras += $row_datos_plantillaTRA['nombre_hora'];  */
                }
                ?>  
                
<tr>

<TD style="width:90%; border: white; border-top:  1px solid black;" align="right" height="18" COLSPAN=4 cellspacing="1"> TOTAL HORAS SEMANALES&nbsp;</TD>        

<TD style="width:12%; font-size: 14px;" align="center" height="18" ><b><?php echo $_POST["tiempo_de_trabajoxz"]; ?></b></TD>
...
<span style="margin-top: 3px; font-size: 12px;"> CREDENCIALES PROFESIONALES QUE POSEE: </span>
...
<table class="basetabla" style="margin-top: 16px;" cellspacing="-1">
  ...
  <tr>
  	 <td style="width:40%;" align="center" height="18">FIRMA DEL PROFESOR</td>
  	 <td style="width:10%;" align="center" height="18"></td>
...
try
    {
        ...
        $html2pdf = new HTML2PDF('P', 'LEGAL', 'es', true, 'UTF-8', 3);   // el ultimo valor indica el margen izq, der, sup, aba en mm
        $html2pdf->pdf->SetDisplayMode('fullpage');         // carta =  'LETTER' 216 x 279,   'LEGAL'  216 x 356  extra A4_LONG
