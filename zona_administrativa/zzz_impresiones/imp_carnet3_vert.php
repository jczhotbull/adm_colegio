...
$id_del_per3 = $_POST['id_per3'];

$query3 = "SELECT * FROM plantilla_contratados, plantilla_personal, cargos_all, plantilla_cargos
                        
         WHERE  plantilla_contratados.id_per = plantilla_personal.id_per
         and cargos_all.id_contrato = plantilla_contratados.id_contrato
         and plantilla_cargos.id_cargo = cargos_all.id_cargo

            and plantilla_personal.id_per = '$id_del_per3' Limit 1 ";

$datos_plantilla3 = mysqli_query($enlace, $query3) or die(mysqli_error());
$row_datos_plantilla3 = mysqli_fetch_assoc($datos_plantilla3); 


$trab3 = $row_datos_plantilla3['id_cargo'];

$query30003 = "SELECT * FROM plantilla_cargos WHERE id_cargo = '$trab3'    Limit 1 ";

$datos_30003 = mysqli_query($enlace, $query30003) or die(mysqli_error());
$row_datos_30003 = mysqli_fetch_assoc($datos_30003); 

$el_puesto_es3 = $row_datos_30003['nombre_cargo'];
...
<TD class="" style="width:2%; height:195px; font-size: 14px;" align=""><div style="rotate:90; margin-top: 43px; margin-left: -10px; "><b><?php echo $firstnam1; ?></b></div>
</TD>

<TD class="" style="width:2%; height:195px; font-size: 14px;" align=""><div style="rotate:90; margin-top: 43px; margin-left: -10px; "><b><?php echo $firstape1; ?> </b></div>
</TD>

<TD class="" style="width:3%; height:195px; font-size: 16px; color: #34312F;" align=""><div style="rotate:90; margin-top: 46px; margin-left: -10px; "><b><?php echo $row_datos_plantilla1['ci_per']; ?></b></div>   
</TD> 
...
<TD class="" style="width:2%; height:195px; font-size: 14px;" align=""><div style="rotate:90; margin-top: 43px; margin-left: -10px; "><b><?php echo $firstnam2; ?></b></div>
</TD>

<TD class="" style="width:2%; height:195px; font-size: 14px;" align=""><div style="rotate:90; margin-top: 43px; margin-left: -10px; "><b><?php echo $firstape2; ?> </b></div>
</TD>

<TD class="" style="width:3%; height:195px; font-size: 16px; color: #34312F;" align=""><div style="rotate:90; margin-top: 46px; margin-left: -10px; "><b><?php echo $row_datos_plantilla2['ci_per']; ?></b></div>   
</TD> 


<TD class="" style="width:3%; height:195px; font-size: 18px; color:#006bb3;" align=""><div style="rotate:90; margin-top: 53px; margin-left: -8px; "><?php  $string_r2 = str_replace(' ', '&nbsp;', $el_puesto_es2) ?>
...
<div style="rotate:90; margin-left: -12px; margin-top: -55px;">
         <img style="width:82px;  max-height: auto;" src='../<?php echo $row_datos_plantilla3['foto_per']; ?>'/ > </div>  </td>
...
<TD class="" style="width:2%; height:195px; font-size: 16px;" align=""><div style="rotate:90; margin-top: 48px; margin-left: -10px; "><b><?php echo $row_datos_periodo['inicia']; ?>-<?php echo $row_datos_periodo['termina']; ?></b></div>
</TD>


<?php 

$firstnam3 = strtok($row_datos_plantilla3['nombre_per'], ' ');

$lastnam3 = strstr($row_datos_plantilla3['nombre_per'], ' ');

$firstCharacterlastnam3 = $lastnam3[1]; 

$firstape3 = strtok($row_datos_plantilla3['apellido_per'], ' ');

$lastape3 = strstr($row_datos_plantilla3['apellido_per'], ' ');

$firstCharacterlastape3 = $lastape3[1];  ?> 

<TD class="" style="width:2%; height:195px; font-size: 14px;" align=""><div style="rotate:90; margin-top: 40px; margin-left: -10px; "><b><?php echo $firstnam3; ?></b></div>
</TD>

<TD class="" style="width:2%; height:195px; font-size: 14px;" align=""><div style="rotate:90; margin-top: 40px; margin-left: -10px; "><b><?php echo $firstape3; ?> </b></div>
</TD>

<TD class="" style="width:3%; height:195px; font-size: 16px; color: #34312F;" align=""><div style="rotate:90; margin-top: 46px; margin-left: -10px; "><b><?php echo $row_datos_plantilla3['ci_per']; ?></b></div>   
</TD> 


<TD class="" style="width:3%; height:195px; font-size: 18px; color:#006bb3;" align=""><div style="rotate:90; margin-top: 50px; margin-left: -8px; "><?php  $string_r3 = str_replace(' ', '&nbsp;', $el_puesto_es3) ?>
<B><?php echo $string_r3; ?></B></div>
</TD>
...
<?php
  ...
  $dir3 = '../../000 Temporales/';
      ...
      $la_doc_id_es3 = $row_datos_plantilla3['ci_per'];
  
        //Declaramos la ruta y nombre del archivo a generar
  $filename3 = $dir3.''.$la_doc_id_es3.'QR.png';
 
        //Parametros de Condiguración
  
  $tamaño3 = 10; //Tamaño de Pixel
  $level3 = 'M'; //Precisión Baja
  $framSize3 = 1; //Tamaño espacio blanco
  $contenido3 = $la_doc_id_es3; //Texto
  
        //Enviamos los parametros a la Función para generar código QR 
  QRcode::png($contenido3, $filename3, $level3, $tamaño3, $framSize3); 
...
<div style="rotate:-90; margin-left: -34px; margin-top: -57px;">
         <img style="width:88px;  max-height: auto;" src='../../000 Temporales/<?php echo $contenido3; ?>QR.png'/> </div>  </td>
...
try
    {
        ...
        $html2pdf->Output("carnet3_vert.pdf"); 
    }
