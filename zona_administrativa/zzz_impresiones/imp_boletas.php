...
$desdexxx = $_POST['desdeeee'] - 1;

$hastaxxx = $_POST['hastaaaa']- $desdexxx;
...
if ($row_datos_controlmat['a_convertir'] == 3 ) {  /* literal */
 ...
 ?>
                    ...
                    <td style="width:60px;height:10px; background-color: #FDFAE1; "><b> <?php 
if ($row_datos_controlmat['a_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M1_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['a_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M1_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['a_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M1_L2xx; } /* cierre literal */
                    ?> </b></td>
...
if ($row_datos_controlmat['a_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M1_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['a_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M1_redond; } /* cierre literal */ ?>
                        
                    </td>

                    <td style="width:60px;height:10px;  background-color: #FDEDDA; "><b> <?php 
if ($row_datos_controlmat['a_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M1_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['a_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M1_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['a_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M1_L3xx; } /* cierre literal */
                    ?> </b></td>
                    <td style="width:60px;height:10px;">
...
if ($row_datos_controlmat['a_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M1_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['a_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M1_redond; } /* cierre literal */ ?>   
...
if ($row_datos_controlmat['a_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M1; } /* cierre alfabetico */
...
if ($row_datos_controlmat['a_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M1; } /* cierre literal */
                    ?> 
...
if ($row_datos_controlmat['a_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M1_form; } /* cierre alfabetico */
...
<?php  
$pruebass_M1_1 = $row_datos_control_notasM1["rev_uno"];  // el primero del a_aaa
...
<!-- nuevo añadido 1 -->
  <td style="width:30px; height:10px; " BGCOLOR="<?php echo $color0;?>" > <b>
<?php

if ($pruebass_M1_1 != '') {  
    if ($row_datos_controlmat['a_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M1_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['a_convertir'] == 2 ) {  /* alfabetico */
       ...
       echo $alfabetico_pruebass_redond_M1_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['a_convertir'] == 3 ) {  /* literal */
      ...
      echo $literal_pruebass_redond_M1_1;   }
}
?> </b>
   </td>
...
if ($pruebass_M1_2 != '') {  
    ...
    if ($row_datos_controlmat['a_convertir'] == 2 ) {  /* alfabetico */
       ...
       echo $alfabetico_pruebass_redond_M1_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['a_convertir'] == 3 ) {  /* literal */
      ...
      echo $literal_pruebass_redond_M1_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['b_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap1_pro_todo_M2_redond; } /* cierre literal */ ?>
                    ...
                    <td style="width:60px;height:10px; background-color: #F4F3F3;"><b><?php 

if ($row_datos_controlmat['b_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M2_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['b_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M2_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['b_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M2_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['b_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M2_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['b_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M2_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['b_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M2_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['b_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M2_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['b_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M2_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['b_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M2_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['b_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M2_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['b_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M2; } /* cierre alfabetico */
...
if ($row_datos_controlmat['b_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M2; } /* cierre literal */
...
if ($row_datos_controlmat['b_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M2_form; } /* cierre alfabetico */
...
if ($pruebass_M2_1 != '') {  
    ...
    if ($row_datos_controlmat['b_convertir'] == 2 ) {  /* alfabetico */
       ...
       echo $alfabetico_pruebass_redond_M2_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['b_convertir'] == 3 ) {  /* literal */
      ...
      echo $literal_pruebass_redond_M2_1;   }
}
?> </b>
   </td>
...
if ($pruebass_M2_2 != '') {  
    ...
    if ($row_datos_controlmat['b_convertir'] == 2 ) {  /* alfabetico */
       ...
       echo $alfabetico_pruebass_redond_M2_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['b_convertir'] == 3 ) {  /* literal */
      ...
      echo $literal_pruebass_redond_M2_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['c_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M3_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['c_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M3_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['c_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M3_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['c_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M3_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['c_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M3_redond; } /* cierre literal */   ?>
                    ...
                    <td style="width:60px;height:10px; background-color: #FDF0E1;"><b><?php 

if ($row_datos_controlmat['c_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M3_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['c_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M3_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['c_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M3_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['c_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M3_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['c_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M3_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['c_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M3; } /* cierre alfabetico */
...
if ($row_datos_controlmat['c_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M3; } /* cierre literal */
...
if ($row_datos_controlmat['c_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M3_form; } /* cierre alfabetico */
...
if ($pruebass_M3_1 != '') {  
    ...
    if ($row_datos_controlmat['c_convertir'] == 2 ) {  /* alfabetico */
       ...
       echo $alfabetico_pruebass_redond_M3_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['c_convertir'] == 3 ) {  /* literal */
      ...
      echo $literal_pruebass_redond_M3_1;   }
}
?> </b>
   </td>
...
if ($pruebass_M3_2 != '') {  
    ...
    if ($row_datos_controlmat['c_convertir'] == 2 ) {  /* alfabetico */
       ...
       echo $alfabetico_pruebass_redond_M3_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['c_convertir'] == 3 ) {  /* literal */
      ...
      echo $literal_pruebass_redond_M3_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['d_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M4_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['d_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M4_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['d_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M4_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['d_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M4_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['d_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M4_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['d_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M4_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['d_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M4_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['d_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M4_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['d_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M4_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['d_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M4_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['d_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M4; } /* cierre alfabetico */
...
if ($row_datos_controlmat['d_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M4; } /* cierre literal */
...
if ($row_datos_controlmat['d_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M4_form; } /* cierre alfabetico */
...
if ($pruebass_M4_1 != '') {  
    ...
    if ($row_datos_controlmat['d_convertir'] == 2 ) {  /* alfabetico */
       ...
       echo $alfabetico_pruebass_redond_M4_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['d_convertir'] == 3 ) {  /* literal */
      ...
      echo $literal_pruebass_redond_M4_1;   }
}
?> </b>
   </td>
...
if ($pruebass_M4_2 != '') {  
    ...
    if ($row_datos_controlmat['d_convertir'] == 2 ) {  /* alfabetico */
       ...
       echo $alfabetico_pruebass_redond_M4_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['d_convertir'] == 3 ) {  /* literal */
      ...
      echo $literal_pruebass_redond_M4_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['e_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M5_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['e_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M5_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['e_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M5_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['e_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M5_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['e_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M5_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['e_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M5_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['e_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M5_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['e_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M5_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['e_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M5_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['e_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M5_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['e_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M5; } /* cierre alfabetico */
...
if ($row_datos_controlmat['e_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M5; } /* cierre literal */
...
if ($row_datos_controlmat['e_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M5_form; } /* cierre alfabetico */
...
$pruebass_redond_M5_1 =number_format($pruebass_M5_1);
$pruebass_redond_M5_2 =number_format($pruebass_M5_2); 
  ?>
...
if ($pruebass_M5_1 != '') {  
    if ($row_datos_controlmat['e_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M5_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['e_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M5_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M5_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M5_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M5_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['e_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M5_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M5_1 = $literal_formato_1;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M5_1 = $literal_formato_2;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M5_1 = $literal_formato_3;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M5_1 = $literal_formato_4;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M5_1 = $literal_formato_5;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M5_1 = $literal_formato_6;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M5_1 = $literal_formato_7;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M5_1 = $literal_formato_8;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M5_1 = $literal_formato_9;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M5_1 = $literal_formato_10;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M5_1 = $literal_formato_11;  }
      if ($pruebass_redond_M5_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M5_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M5_1;   }
}
?></b>
   </td>
...
if ($pruebass_M5_2 != '') {  
    if ($row_datos_controlmat['e_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M5_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['e_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M5_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M5_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M5_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M5_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['e_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M5_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M5_2 = $literal_formato_1;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M5_2 = $literal_formato_2;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M5_2 = $literal_formato_3;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M5_2 = $literal_formato_4;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M5_2 = $literal_formato_5;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M5_2 = $literal_formato_6;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M5_2 = $literal_formato_7;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M5_2 = $literal_formato_8;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M5_2 = $literal_formato_9;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M5_2 = $literal_formato_10;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M5_2 = $literal_formato_11;  }
      if ($pruebass_redond_M5_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M5_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M5_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['f_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M6_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['f_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M6_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['f_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M6_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['f_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M6_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['f_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M6_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['f_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M6_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['f_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M6_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['f_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M6_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['f_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M6_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['f_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M6_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['f_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M6; } /* cierre alfabetico */
...
if ($row_datos_controlmat['f_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M6; } /* cierre literal */
...
if ($row_datos_controlmat['f_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M6_form; } /* cierre alfabetico */
...
$pruebass_redond_M6_1 =number_format($pruebass_M6_1);
$pruebass_redond_M6_2 =number_format($pruebass_M6_2); 
  ?>
...
if ($pruebass_M6_1 != '') {  
    if ($row_datos_controlmat['f_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M6_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['f_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M6_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M6_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M6_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M6_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['f_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M6_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M6_1 = $literal_formato_1;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M6_1 = $literal_formato_2;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M6_1 = $literal_formato_3;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M6_1 = $literal_formato_4;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M6_1 = $literal_formato_5;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M6_1 = $literal_formato_6;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M6_1 = $literal_formato_7;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M6_1 = $literal_formato_8;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M6_1 = $literal_formato_9;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M6_1 = $literal_formato_10;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M6_1 = $literal_formato_11;  }
      if ($pruebass_redond_M6_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M6_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M6_1;   }
}
?>   </b>
   </td>
...
if ($pruebass_M6_2 != '') {  
    if ($row_datos_controlmat['f_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M6_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['f_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M6_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M6_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M6_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M6_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['f_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M6_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M6_2 = $literal_formato_1;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M6_2 = $literal_formato_2;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M6_2 = $literal_formato_3;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M6_2 = $literal_formato_4;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M6_2 = $literal_formato_5;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M6_2 = $literal_formato_6;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M6_2 = $literal_formato_7;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M6_2 = $literal_formato_8;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M6_2 = $literal_formato_9;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M6_2 = $literal_formato_10;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M6_2 = $literal_formato_11;  }
      if ($pruebass_redond_M6_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M6_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M6_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['g_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M7_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['g_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M7_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['g_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M7_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['g_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M7_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['g_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M7_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['g_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M7_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['g_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M7_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['g_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M7_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['g_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M7_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['g_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M7_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['g_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M7; } /* cierre alfabetico */
...
if ($row_datos_controlmat['g_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M7; } /* cierre literal */
...
if ($row_datos_controlmat['g_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M7_form; } /* cierre alfabetico */
...
$pruebass_redond_M7_1 =number_format($pruebass_M7_1);
$pruebass_redond_M7_2 =number_format($pruebass_M7_2); 
  ?>
...
if ($pruebass_M7_1 != '') {  
    if ($row_datos_controlmat['g_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M7_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['g_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M7_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M7_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M7_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M7_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['g_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M7_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M7_1 = $literal_formato_1;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M7_1 = $literal_formato_2;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M7_1 = $literal_formato_3;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M7_1 = $literal_formato_4;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M7_1 = $literal_formato_5;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M7_1 = $literal_formato_6;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M7_1 = $literal_formato_7;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M7_1 = $literal_formato_8;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M7_1 = $literal_formato_9;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M7_1 = $literal_formato_10;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M7_1 = $literal_formato_11;  }
      if ($pruebass_redond_M7_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M7_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M7_1;   }
}
?>  </b>
   </td>
...
if ($pruebass_M7_2 != '') {  
    if ($row_datos_controlmat['g_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M7_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['g_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M7_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M7_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M7_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M7_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['g_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M7_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M7_2 = $literal_formato_1;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M7_2 = $literal_formato_2;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M7_2 = $literal_formato_3;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M7_2 = $literal_formato_4;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M7_2 = $literal_formato_5;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M7_2 = $literal_formato_6;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M7_2 = $literal_formato_7;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M7_2 = $literal_formato_8;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M7_2 = $literal_formato_9;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M7_2 = $literal_formato_10;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M7_2 = $literal_formato_11;  }
      if ($pruebass_redond_M7_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M7_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M7_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['h_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M8_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['h_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M8_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['h_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M8_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['h_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M8_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['h_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M8_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['h_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M8_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['h_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M8_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['h_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M8_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['h_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M8_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['h_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M8_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['h_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M8; } /* cierre alfabetico */
...
if ($row_datos_controlmat['h_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M8; } /* cierre literal */
...
if ($row_datos_controlmat['h_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M8_form; } /* cierre alfabetico */
...
$pruebass_redond_M8_1 =number_format($pruebass_M8_1);
$pruebass_redond_M8_2 =number_format($pruebass_M8_2); 
  ?>
...
if ($pruebass_M8_1 != '') {  
    if ($row_datos_controlmat['h_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M8_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['h_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M8_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M8_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M8_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M8_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['h_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M8_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M8_1 = $literal_formato_1;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M8_1 = $literal_formato_2;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M8_1 = $literal_formato_3;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M8_1 = $literal_formato_4;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M8_1 = $literal_formato_5;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M8_1 = $literal_formato_6;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M8_1 = $literal_formato_7;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M8_1 = $literal_formato_8;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M8_1 = $literal_formato_9;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M8_1 = $literal_formato_10;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M8_1 = $literal_formato_11;  }
      if ($pruebass_redond_M8_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M8_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M8_1;   }
}
?> </b>
   </td>
...
if ($pruebass_M8_2 != '') {  
    if ($row_datos_controlmat['h_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M8_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['h_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M8_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M8_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M8_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M8_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['h_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M8_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M8_2 = $literal_formato_1;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M8_2 = $literal_formato_2;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M8_2 = $literal_formato_3;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M8_2 = $literal_formato_4;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M8_2 = $literal_formato_5;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M8_2 = $literal_formato_6;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M8_2 = $literal_formato_7;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M8_2 = $literal_formato_8;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M8_2 = $literal_formato_9;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M8_2 = $literal_formato_10;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M8_2 = $literal_formato_11;  }
      if ($pruebass_redond_M8_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M8_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M8_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['i_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M9_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['i_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M9_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['i_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M9_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['i_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M9_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['i_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M9_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['i_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M9_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['i_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M9_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['i_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M9_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['i_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M9_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['i_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M9_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['i_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M9; } /* cierre alfabetico */
...
if ($row_datos_controlmat['i_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M9; } /* cierre literal */
...
if ($row_datos_controlmat['i_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M9_form; } /* cierre alfabetico */
...
$pruebass_redond_M9_1 =number_format($pruebass_M9_1);
$pruebass_redond_M9_2 =number_format($pruebass_M9_2); 
  ?>
...
if ($pruebass_M9_1 != '') {  
    if ($row_datos_controlmat['i_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M9_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['i_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M9_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M9_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M9_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M9_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['i_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M9_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M9_1 = $literal_formato_1;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M9_1 = $literal_formato_2;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M9_1 = $literal_formato_3;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M9_1 = $literal_formato_4;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M9_1 = $literal_formato_5;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M9_1 = $literal_formato_6;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M9_1 = $literal_formato_7;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M9_1 = $literal_formato_8;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M9_1 = $literal_formato_9;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M9_1 = $literal_formato_10;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M9_1 = $literal_formato_11;  }
      if ($pruebass_redond_M9_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M9_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M9_1;   }
}
?>  </b>
   </td>
...
if ($pruebass_M9_2 != '') {  
    if ($row_datos_controlmat['i_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M9_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['i_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M9_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M9_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M9_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M9_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['i_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M9_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M9_2 = $literal_formato_1;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M9_2 = $literal_formato_2;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M9_2 = $literal_formato_3;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M9_2 = $literal_formato_4;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M9_2 = $literal_formato_5;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M9_2 = $literal_formato_6;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M9_2 = $literal_formato_7;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M9_2 = $literal_formato_8;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M9_2 = $literal_formato_9;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M9_2 = $literal_formato_10;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M9_2 = $literal_formato_11;  }
      if ($pruebass_redond_M9_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M9_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M9_2;   }
}
?>  </b>
   </td>
...
if ($row_datos_controlmat['j_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M10_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['j_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M10_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['j_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M10_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['j_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M10_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['j_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M10_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['j_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M10_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['j_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M10_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['j_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M10_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['j_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M10_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['j_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M10_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['j_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M10; } /* cierre alfabetico */
...
if ($row_datos_controlmat['j_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M10; } /* cierre literal */
...
if ($row_datos_controlmat['j_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M10_form; } /* cierre alfabetico */
...
$pruebass_redond_M10_1 =number_format($pruebass_M10_1);
$pruebass_redond_M10_2 =number_format($pruebass_M10_2); 
  ?>
...
if ($pruebass_M10_1 != '') {  
    if ($row_datos_controlmat['j_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M10_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['j_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M10_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M10_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M10_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M10_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['j_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M10_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M10_1 = $literal_formato_1;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M10_1 = $literal_formato_2;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M10_1 = $literal_formato_3;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M10_1 = $literal_formato_4;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M10_1 = $literal_formato_5;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M10_1 = $literal_formato_6;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M10_1 = $literal_formato_7;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M10_1 = $literal_formato_8;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M10_1 = $literal_formato_9;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M10_1 = $literal_formato_10;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M10_1 = $literal_formato_11;  }
      if ($pruebass_redond_M10_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M10_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M10_1;   }
}
?>  </b>
   </td>
...
if ($pruebass_M10_2 != '') {  
    if ($row_datos_controlmat['j_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M10_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['j_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M10_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M10_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M10_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M10_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['j_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M10_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M10_2 = $literal_formato_1;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M10_2 = $literal_formato_2;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M10_2 = $literal_formato_3;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M10_2 = $literal_formato_4;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M10_2 = $literal_formato_5;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M10_2 = $literal_formato_6;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M10_2 = $literal_formato_7;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M10_2 = $literal_formato_8;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M10_2 = $literal_formato_9;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M10_2 = $literal_formato_10;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M10_2 = $literal_formato_11;  }
      if ($pruebass_redond_M10_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M10_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M10_2;   }
}
?>  </b>
   </td>
...
if ($row_datos_controlmat['k_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M11_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['k_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M11_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['k_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M11_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['k_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M11_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['k_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M11_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['k_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M11_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['k_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M11_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['k_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M11_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['k_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M11_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['k_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M11_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['k_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M11; } /* cierre alfabetico */
...
if ($row_datos_controlmat['k_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M11; } /* cierre literal */
...
if ($row_datos_controlmat['k_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M11_form; } /* cierre alfabetico */
...
$pruebass_redond_M11_1 =number_format($pruebass_M11_1);
$pruebass_redond_M11_2 =number_format($pruebass_M11_2); 
  ?>
...
if ($pruebass_M11_1 != '') {  
    if ($row_datos_controlmat['k_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M11_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['k_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M11_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M11_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M11_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M11_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['k_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M11_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M11_1 = $literal_formato_1;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M11_1 = $literal_formato_2;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M11_1 = $literal_formato_3;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M11_1 = $literal_formato_4;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M11_1 = $literal_formato_5;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M11_1 = $literal_formato_6;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M11_1 = $literal_formato_7;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M11_1 = $literal_formato_8;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M11_1 = $literal_formato_9;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M11_1 = $literal_formato_10;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M11_1 = $literal_formato_11;  }
      if ($pruebass_redond_M11_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M11_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M11_1;   }
}
?>  </b>
   </td>
...
if ($pruebass_M11_2 != '') {  
    if ($row_datos_controlmat['k_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M11_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['k_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M11_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M11_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M11_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M11_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['k_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M11_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M11_2 = $literal_formato_1;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M11_2 = $literal_formato_2;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M11_2 = $literal_formato_3;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M11_2 = $literal_formato_4;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M11_2 = $literal_formato_5;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M11_2 = $literal_formato_6;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M11_2 = $literal_formato_7;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M11_2 = $literal_formato_8;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M11_2 = $literal_formato_9;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M11_2 = $literal_formato_10;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M11_2 = $literal_formato_11;  }
      if ($pruebass_redond_M11_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M11_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M11_2;   }
}
?>   </b>
   </td>
...
if ($row_datos_controlmat['l_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M12_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['l_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M12_L2xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['l_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M12_L2xx; } /* cierre literal */
...
if ($row_datos_controlmat['l_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M12_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['l_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap2_pro_todo_M12_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['l_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M12_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['l_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_seven_con_Au_redon_M12_L3xx; } /* cierre alfabetico */
...
if ($row_datos_controlmat['l_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_seven_con_Au_redon_M12_L3xx; } /* cierre literal */
...
if ($row_datos_controlmat['l_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M12_redond; } /* cierre alfabetico */
...
if ($row_datos_controlmat['l_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_lap3_pro_todo_M12_redond; } /* cierre literal */ ?> 
...
if ($row_datos_controlmat['l_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M12; } /* cierre alfabetico */
...
if ($row_datos_controlmat['l_convertir'] == 3 ) {  /* literal */
  ...
  echo $literal_totalcito_M12; } /* cierre literal */
...
if ($row_datos_controlmat['l_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M12_form; } /* cierre alfabetico */
...
$pruebass_redond_M12_1 =number_format($pruebass_M12_1);
$pruebass_redond_M12_2 =number_format($pruebass_M12_2); 
  ?>
...
if ($pruebass_M12_1 != '') {  
    if ($row_datos_controlmat['l_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M12_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['l_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M12_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M12_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M12_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M12_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['l_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M12_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M12_1 = $literal_formato_1;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M12_1 = $literal_formato_2;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M12_1 = $literal_formato_3;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M12_1 = $literal_formato_4;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M12_1 = $literal_formato_5;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M12_1 = $literal_formato_6;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M12_1 = $literal_formato_7;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M12_1 = $literal_formato_8;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M12_1 = $literal_formato_9;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M12_1 = $literal_formato_10;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M12_1 = $literal_formato_11;  }
      if ($pruebass_redond_M12_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M12_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M12_1;   }
}
?> </b>
   </td>
...
if ($pruebass_M12_2 != '') {  
    if ($row_datos_controlmat['l_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M12_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['l_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M12_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M12_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M12_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M12_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['l_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M12_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M12_2 = $literal_formato_1;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M12_2 = $literal_formato_2;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M12_2 = $literal_formato_3;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M12_2 = $literal_formato_4;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M12_2 = $literal_formato_5;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M12_2 = $literal_formato_6;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M12_2 = $literal_formato_7;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M12_2 = $literal_formato_8;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M12_2 = $literal_formato_9;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M12_2 = $literal_formato_10;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M12_2 = $literal_formato_11;  }
      if ($pruebass_redond_M12_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M12_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M12_2;   }
}
?> </b>
   </td>
...
if ($row_datos_controlmat['m_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M13_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['m_convertir'] == 2 ) {  /* alfabetico */
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_1) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_1;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_2) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_2;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_3) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_3;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_4) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_4;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_5) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_5;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_6) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_6;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_7) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_7;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_8) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_8;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_9) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_9;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_10) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_10;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_11) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_11;  }
   if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_12) { $alfabetico_seven_con_Au_redon_M13_L2xx = $alfabetico_formato_12;  }
   echo $alfabetico_seven_con_Au_redon_M13_L2xx; } /* cierre alfabetico */

if ($row_datos_controlmat['m_convertir'] == 3 ) {  /* literal */
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_1) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_1;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_2) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_2;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_3) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_3;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_4) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_4;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_5) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_5;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_6) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_6;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_7) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_7;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_8) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_8;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_9) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_9;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_10) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_10;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_11) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_11;  }
  if ($total_seven_con_Au_redon_M13_L2xx >= $comparativo_formato_12) { $literal_seven_con_Au_redon_M13_L2xx = $literal_formato_12;  } 
  echo $literal_seven_con_Au_redon_M13_L2xx; } /* cierre literal */
...
if ($lap2_div_mat13 == '') {
  ...
  $lap2_pro_todo_M13_redondeado1 =number_format($lap2_pro_todo_M13, 1, '.', '');
    ...
    $lap_divisor_promedio_Lap_2 =  $lap_divisor_promedio_Lap_2 + 1;   //  lleva el conteo de la division para el promedio del salon del 2do lapso
    $lap_suma_total_promedio_Lap_2 = $lap_suma_total_promedio_Lap_2 + $lap2_pro_todo_M13_redond;  // lleva el divisor para el promedio del salon 2do lapso


    if ($row_datos_controlmat['m_suma'] != 1)
 {  $lap_suma_total_promedio_Lap_2 =  $lap_suma_total_promedio_Lap_2 - $lap2_pro_todo_M13_redond; $lap_divisor_promedio_Lap_2 =  $lap_divisor_promedio_Lap_2 - 1;  }
...
if ($row_datos_controlmat['m_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M13_redond; } /* cierre alfabetico */

if ($row_datos_controlmat['m_convertir'] == 3 ) {  /* literal */
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_1) { $literal_lap2_pro_todo_M13_redond = $literal_formato_1;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_2) { $literal_lap2_pro_todo_M13_redond = $literal_formato_2;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_3) { $literal_lap2_pro_todo_M13_redond = $literal_formato_3;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_4) { $literal_lap2_pro_todo_M13_redond = $literal_formato_4;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_5) { $literal_lap2_pro_todo_M13_redond = $literal_formato_5;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_6) { $literal_lap2_pro_todo_M13_redond = $literal_formato_6;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_7) { $literal_lap2_pro_todo_M13_redond = $literal_formato_7;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_8) { $literal_lap2_pro_todo_M13_redond = $literal_formato_8;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_9) { $literal_lap2_pro_todo_M13_redond = $literal_formato_9;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_10) { $literal_lap2_pro_todo_M13_redond = $literal_formato_10;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_11) { $literal_lap2_pro_todo_M13_redond = $literal_formato_11;  }
  if ($lap2_pro_todo_M13_redond >= $comparativo_formato_12) { $literal_lap2_pro_todo_M13_redond = $literal_formato_12;  } 
  echo $literal_lap2_pro_todo_M13_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['m_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M13_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['m_convertir'] == 2 ) {  /* alfabetico */
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_1) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_1;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_2) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_2;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_3) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_3;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_4) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_4;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_5) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_5;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_6) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_6;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_7) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_7;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_8) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_8;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_9) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_9;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_10) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_10;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_11) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_11;  }
   if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_12) { $alfabetico_seven_con_Au_redon_M13_L3xx = $alfabetico_formato_12;  }
   echo $alfabetico_seven_con_Au_redon_M13_L3xx; } /* cierre alfabetico */

if ($row_datos_controlmat['m_convertir'] == 3 ) {  /* literal */
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_1) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_1;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_2) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_2;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_3) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_3;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_4) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_4;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_5) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_5;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_6) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_6;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_7) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_7;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_8) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_8;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_9) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_9;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_10) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_10;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_11) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_11;  }
  if ($total_seven_con_Au_redon_M13_L3xx >= $comparativo_formato_12) { $literal_seven_con_Au_redon_M13_L3xx = $literal_formato_12;  } 
  echo $literal_seven_con_Au_redon_M13_L3xx; } /* cierre literal */
...
if ($lap3_div_mat13 == '') {
 ...
 $lap3_pro_todo_M13_redondeado1 =number_format($lap3_pro_todo_M13, 1, '.', '');
    ...
    $lap_divisor_promedio_Lap_3 =  $lap_divisor_promedio_Lap_3 + 1;   //  lleva el conteo de la division para el promedio del salon del 3er lapso
    $lap_suma_total_promedio_Lap_3 = $lap_suma_total_promedio_Lap_3 + $lap3_pro_todo_M13_redond;  // lleva el divisor para el promedio del salon 2do lapso


if ($row_datos_controlmat['m_suma'] != 1)
 {  $lap_suma_total_promedio_Lap_3 =  $lap_suma_total_promedio_Lap_3 - $lap3_pro_todo_M13_redond; $lap_divisor_promedio_Lap_3 =  $lap_divisor_promedio_Lap_3 - 1;  }
...
if ($row_datos_controlmat['m_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M13_redond; } /* cierre alfabetico */

if ($row_datos_controlmat['m_convertir'] == 3 ) {  /* literal */
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_1) { $literal_lap3_pro_todo_M13_redond = $literal_formato_1;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_2) { $literal_lap3_pro_todo_M13_redond = $literal_formato_2;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_3) { $literal_lap3_pro_todo_M13_redond = $literal_formato_3;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_4) { $literal_lap3_pro_todo_M13_redond = $literal_formato_4;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_5) { $literal_lap3_pro_todo_M13_redond = $literal_formato_5;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_6) { $literal_lap3_pro_todo_M13_redond = $literal_formato_6;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_7) { $literal_lap3_pro_todo_M13_redond = $literal_formato_7;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_8) { $literal_lap3_pro_todo_M13_redond = $literal_formato_8;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_9) { $literal_lap3_pro_todo_M13_redond = $literal_formato_9;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_10) { $literal_lap3_pro_todo_M13_redond = $literal_formato_10;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_11) { $literal_lap3_pro_todo_M13_redond = $literal_formato_11;  }
  if ($lap3_pro_todo_M13_redond >= $comparativo_formato_12) { $literal_lap3_pro_todo_M13_redond = $literal_formato_12;  } 
  echo $literal_lap3_pro_todo_M13_redond; } /* cierre literal */ ?> 
...
if ($lap1_pro_todo_M13_redond== '' && $lap2_pro_todo_M13_redond== ''  && $lap3_pro_todo_M13_redond== '') {
    ...
    $totalcito_M13 = $total_seven_con_Au_redon_M13_aproxxx + $row_datos_control_notasM13["nt_AuF"];
}
...
if ($row_datos_controlmat['m_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M13; } /* cierre alfabetico */

if ($row_datos_controlmat['m_convertir'] == 3 ) {  /* literal */
  if ($totalcito_M13 >= $comparativo_formato_1) { $literal_totalcito_M13 = $literal_formato_1;  }
  if ($totalcito_M13 >= $comparativo_formato_2) { $literal_totalcito_M13 = $literal_formato_2;  }
  if ($totalcito_M13 >= $comparativo_formato_3) { $literal_totalcito_M13 = $literal_formato_3;  }
  if ($totalcito_M13 >= $comparativo_formato_4) { $literal_totalcito_M13 = $literal_formato_4;  }
  if ($totalcito_M13 >= $comparativo_formato_5) { $literal_totalcito_M13 = $literal_formato_5;  }
  if ($totalcito_M13 >= $comparativo_formato_6) { $literal_totalcito_M13 = $literal_formato_6;  }
  if ($totalcito_M13 >= $comparativo_formato_7) { $literal_totalcito_M13 = $literal_formato_7;  }
  if ($totalcito_M13 >= $comparativo_formato_8) { $literal_totalcito_M13 = $literal_formato_8;  }
  if ($totalcito_M13 >= $comparativo_formato_9) { $literal_totalcito_M13 = $literal_formato_9;  }
  if ($totalcito_M13 >= $comparativo_formato_10) { $literal_totalcito_M13 = $literal_formato_10;  }
  if ($totalcito_M13 >= $comparativo_formato_11) { $literal_totalcito_M13 = $literal_formato_11;  }
  if ($totalcito_M13 >= $comparativo_formato_12) { $literal_totalcito_M13 = $literal_formato_12;  } 
  echo $literal_totalcito_M13; } /* cierre literal */
...
if ($row_datos_controlmat['m_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M13_form; } /* cierre alfabetico */

if ($row_datos_controlmat['m_convertir'] == 3 ) {  /* literal */
  if ($tot123_M13_form >= $comparativo_formato_1) { $literal_tot123_M13_form = $literal_formato_1;  }
  if ($tot123_M13_form >= $comparativo_formato_2) { $literal_tot123_M13_form = $literal_formato_2;  }
  if ($tot123_M13_form >= $comparativo_formato_3) { $literal_tot123_M13_form = $literal_formato_3;  }
  if ($tot123_M13_form >= $comparativo_formato_4) { $literal_tot123_M13_form = $literal_formato_4;  }
  if ($tot123_M13_form >= $comparativo_formato_5) { $literal_tot123_M13_form = $literal_formato_5;  }
  if ($tot123_M13_form >= $comparativo_formato_6) { $literal_tot123_M13_form = $literal_formato_6;  }
  if ($tot123_M13_form >= $comparativo_formato_7) { $literal_tot123_M13_form = $literal_formato_7;  }
  if ($tot123_M13_form >= $comparativo_formato_8) { $literal_tot123_M13_form = $literal_formato_8;  }
  if ($tot123_M13_form >= $comparativo_formato_9) { $literal_tot123_M13_form = $literal_formato_9;  }
  if ($tot123_M13_form >= $comparativo_formato_10) { $literal_tot123_M13_form = $literal_formato_10;  }
  if ($tot123_M13_form >= $comparativo_formato_11) { $literal_tot123_M13_form = $literal_formato_11;  }
  if ($tot123_M13_form >= $comparativo_formato_12) { $literal_tot123_M13_form = $literal_formato_12;  } 
  echo $literal_tot123_M13_form;   }
...
<?php  
$pruebass_M13_1 = $row_datos_control_notasM13["rev_uno"];
$pruebass_M13_2 = $row_datos_control_notasM13["rev_dos"];
$pruebass_redond_M13_1 =number_format($pruebass_M13_1);
$pruebass_redond_M13_2 =number_format($pruebass_M13_2); 
  ?>
...
if ($pruebass_M13_1 != '') {  
    if ($row_datos_controlmat['m_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M13_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['m_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M13_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M13_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M13_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M13_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['m_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M13_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M13_1 = $literal_formato_1;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M13_1 = $literal_formato_2;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M13_1 = $literal_formato_3;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M13_1 = $literal_formato_4;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M13_1 = $literal_formato_5;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M13_1 = $literal_formato_6;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M13_1 = $literal_formato_7;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M13_1 = $literal_formato_8;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M13_1 = $literal_formato_9;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M13_1 = $literal_formato_10;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M13_1 = $literal_formato_11;  }
      if ($pruebass_redond_M13_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M13_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M13_1;   }
}
?> </b>
   </td>
...
if ($pruebass_M13_2 != '') {  
    if ($row_datos_controlmat['m_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M13_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['m_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M13_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M13_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M13_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M13_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['m_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M13_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M13_2 = $literal_formato_1;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M13_2 = $literal_formato_2;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M13_2 = $literal_formato_3;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M13_2 = $literal_formato_4;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M13_2 = $literal_formato_5;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M13_2 = $literal_formato_6;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M13_2 = $literal_formato_7;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M13_2 = $literal_formato_8;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M13_2 = $literal_formato_9;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M13_2 = $literal_formato_10;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M13_2 = $literal_formato_11;  }
      if ($pruebass_redond_M13_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M13_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M13_2;   }
}
?>  </b>
   </td>
...
if ($row_datos_controlmat['n_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M14_L2xx;
} /* cierre numerico */
if ($row_datos_controlmat['n_convertir'] == 2 ) {  /* alfabetico */
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_1) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_1;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_2) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_2;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_3) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_3;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_4) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_4;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_5) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_5;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_6) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_6;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_7) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_7;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_8) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_8;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_9) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_9;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_10) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_10;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_11) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_11;  }
   if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_12) { $alfabetico_seven_con_Au_redon_M14_L2xx = $alfabetico_formato_12;  }
   echo $alfabetico_seven_con_Au_redon_M14_L2xx; } /* cierre alfabetico */

if ($row_datos_controlmat['n_convertir'] == 3 ) {  /* literal */
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_1) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_1;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_2) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_2;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_3) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_3;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_4) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_4;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_5) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_5;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_6) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_6;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_7) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_7;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_8) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_8;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_9) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_9;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_10) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_10;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_11) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_11;  }
  if ($total_seven_con_Au_redon_M14_L2xx >= $comparativo_formato_12) { $literal_seven_con_Au_redon_M14_L2xx = $literal_formato_12;  } 
  echo $literal_seven_con_Au_redon_M14_L2xx; } /* cierre literal */
...
if ($lap2_div_mat14 == '') {
  ...
  $lap2_pro_todo_M14_redondeado1 =number_format($lap2_pro_todo_M14, 1, '.', '');
    ...
    $lap_divisor_promedio_Lap_2 =  $lap_divisor_promedio_Lap_2 + 1;   //  lleva el conteo de la division para el promedio del salon del 2do lapso
    $lap_suma_total_promedio_Lap_2 = $lap_suma_total_promedio_Lap_2 + $lap2_pro_todo_M14_redond;  // lleva el divisor para el promedio del salon 2do lapso


    if ($row_datos_controlmat['n_suma'] != 1)
 {  $lap_suma_total_promedio_Lap_2 =  $lap_suma_total_promedio_Lap_2 - $lap2_pro_todo_M14_redond; $lap_divisor_promedio_Lap_2 =  $lap_divisor_promedio_Lap_2 - 1;  }
...
if ($row_datos_controlmat['n_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap2_pro_todo_M14_redond; } /* cierre alfabetico */

if ($row_datos_controlmat['n_convertir'] == 3 ) {  /* literal */
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_1) { $literal_lap2_pro_todo_M14_redond = $literal_formato_1;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_2) { $literal_lap2_pro_todo_M14_redond = $literal_formato_2;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_3) { $literal_lap2_pro_todo_M14_redond = $literal_formato_3;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_4) { $literal_lap2_pro_todo_M14_redond = $literal_formato_4;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_5) { $literal_lap2_pro_todo_M14_redond = $literal_formato_5;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_6) { $literal_lap2_pro_todo_M14_redond = $literal_formato_6;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_7) { $literal_lap2_pro_todo_M14_redond = $literal_formato_7;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_8) { $literal_lap2_pro_todo_M14_redond = $literal_formato_8;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_9) { $literal_lap2_pro_todo_M14_redond = $literal_formato_9;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_10) { $literal_lap2_pro_todo_M14_redond = $literal_formato_10;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_11) { $literal_lap2_pro_todo_M14_redond = $literal_formato_11;  }
  if ($lap2_pro_todo_M14_redond >= $comparativo_formato_12) { $literal_lap2_pro_todo_M14_redond = $literal_formato_12;  } 
  echo $literal_lap2_pro_todo_M14_redond; } /* cierre literal */   ?>
...
if ($row_datos_controlmat['n_convertir'] == 1 ) {  /* numerico */
       echo $total_seven_con_Au_redon_M14_L3xx;
} /* cierre numerico */
if ($row_datos_controlmat['n_convertir'] == 2 ) {  /* alfabetico */
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_1) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_1;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_2) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_2;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_3) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_3;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_4) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_4;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_5) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_5;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_6) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_6;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_7) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_7;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_8) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_8;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_9) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_9;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_10) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_10;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_11) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_11;  }
   if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_12) { $alfabetico_seven_con_Au_redon_M14_L3xx = $alfabetico_formato_12;  }
   echo $alfabetico_seven_con_Au_redon_M14_L3xx; } /* cierre alfabetico */

if ($row_datos_controlmat['n_convertir'] == 3 ) {  /* literal */
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_1) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_1;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_2) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_2;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_3) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_3;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_4) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_4;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_5) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_5;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_6) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_6;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_7) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_7;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_8) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_8;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_9) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_9;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_10) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_10;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_11) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_11;  }
  if ($total_seven_con_Au_redon_M14_L3xx >= $comparativo_formato_12) { $literal_seven_con_Au_redon_M14_L3xx = $literal_formato_12;  } 
  echo $literal_seven_con_Au_redon_M14_L3xx; } /* cierre literal */
...
if ($lap3_div_mat14 == '') {
 ...
 $lap3_pro_todo_M14_redondeado1 =number_format($lap3_pro_todo_M14, 1, '.', '');
    ...
    $lap_divisor_promedio_Lap_3 =  $lap_divisor_promedio_Lap_3 + 1;   //  lleva el conteo de la division para el promedio del salon del 3er lapso
    $lap_suma_total_promedio_Lap_3 = $lap_suma_total_promedio_Lap_3 + $lap3_pro_todo_M14_redond;  // lleva el divisor para el promedio del salon 2do lapso


if ($row_datos_controlmat['n_suma'] != 1)
 {  $lap_suma_total_promedio_Lap_3 =  $lap_suma_total_promedio_Lap_3 - $lap3_pro_todo_M14_redond; $lap_divisor_promedio_Lap_3 =  $lap_divisor_promedio_Lap_3 - 1;  }
...
if ($row_datos_controlmat['n_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_lap3_pro_todo_M14_redond; } /* cierre alfabetico */

if ($row_datos_controlmat['n_convertir'] == 3 ) {  /* literal */
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_1) { $literal_lap3_pro_todo_M14_redond = $literal_formato_1;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_2) { $literal_lap3_pro_todo_M14_redond = $literal_formato_2;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_3) { $literal_lap3_pro_todo_M14_redond = $literal_formato_3;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_4) { $literal_lap3_pro_todo_M14_redond = $literal_formato_4;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_5) { $literal_lap3_pro_todo_M14_redond = $literal_formato_5;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_6) { $literal_lap3_pro_todo_M14_redond = $literal_formato_6;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_7) { $literal_lap3_pro_todo_M14_redond = $literal_formato_7;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_8) { $literal_lap3_pro_todo_M14_redond = $literal_formato_8;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_9) { $literal_lap3_pro_todo_M14_redond = $literal_formato_9;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_10) { $literal_lap3_pro_todo_M14_redond = $literal_formato_10;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_11) { $literal_lap3_pro_todo_M14_redond = $literal_formato_11;  }
  if ($lap3_pro_todo_M14_redond >= $comparativo_formato_12) { $literal_lap3_pro_todo_M14_redond = $literal_formato_12;  } 
  echo $literal_lap3_pro_todo_M14_redond; } /* cierre literal */ ?> 
...
if ($lap1_pro_todo_M14_redond== '' && $lap2_pro_todo_M14_redond== ''  && $lap3_pro_todo_M14_redond== '') {
    ...
    $totalcito_M14 = $total_seven_con_Au_redon_M14_aproxxx + $row_datos_control_notasM14["nt_AuF"];
}
...
if ($row_datos_controlmat['n_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_totalcito_M14; } /* cierre alfabetico */

if ($row_datos_controlmat['n_convertir'] == 3 ) {  /* literal */
  if ($totalcito_M14 >= $comparativo_formato_1) { $literal_totalcito_M14 = $literal_formato_1;  }
  if ($totalcito_M14 >= $comparativo_formato_2) { $literal_totalcito_M14 = $literal_formato_2;  }
  if ($totalcito_M14 >= $comparativo_formato_3) { $literal_totalcito_M14 = $literal_formato_3;  }
  if ($totalcito_M14 >= $comparativo_formato_4) { $literal_totalcito_M14 = $literal_formato_4;  }
  if ($totalcito_M14 >= $comparativo_formato_5) { $literal_totalcito_M14 = $literal_formato_5;  }
  if ($totalcito_M14 >= $comparativo_formato_6) { $literal_totalcito_M14 = $literal_formato_6;  }
  if ($totalcito_M14 >= $comparativo_formato_7) { $literal_totalcito_M14 = $literal_formato_7;  }
  if ($totalcito_M14 >= $comparativo_formato_8) { $literal_totalcito_M14 = $literal_formato_8;  }
  if ($totalcito_M14 >= $comparativo_formato_9) { $literal_totalcito_M14 = $literal_formato_9;  }
  if ($totalcito_M14 >= $comparativo_formato_10) { $literal_totalcito_M14 = $literal_formato_10;  }
  if ($totalcito_M14 >= $comparativo_formato_11) { $literal_totalcito_M14 = $literal_formato_11;  }
  if ($totalcito_M14 >= $comparativo_formato_12) { $literal_totalcito_M14 = $literal_formato_12;  } 
  echo $literal_totalcito_M14; } /* cierre literal */
...
$tot123_M14_form_redondeado1 = number_format($tot123_M14, 1, '.', '');
    $tot123_M14_form = number_format($tot123_M14_form_redondeado1);
...
if ($row_datos_controlmat['n_convertir'] == 2 ) {  /* alfabetico */
   ...
   echo $alfabetico_tot123_M14_form; } /* cierre alfabetico */

if ($row_datos_controlmat['n_convertir'] == 3 ) {  /* literal */
  if ($tot123_M14_form >= $comparativo_formato_1) { $literal_tot123_M14_form = $literal_formato_1;  }
  if ($tot123_M14_form >= $comparativo_formato_2) { $literal_tot123_M14_form = $literal_formato_2;  }
  if ($tot123_M14_form >= $comparativo_formato_3) { $literal_tot123_M14_form = $literal_formato_3;  }
  if ($tot123_M14_form >= $comparativo_formato_4) { $literal_tot123_M14_form = $literal_formato_4;  }
  if ($tot123_M14_form >= $comparativo_formato_5) { $literal_tot123_M14_form = $literal_formato_5;  }
  if ($tot123_M14_form >= $comparativo_formato_6) { $literal_tot123_M14_form = $literal_formato_6;  }
  if ($tot123_M14_form >= $comparativo_formato_7) { $literal_tot123_M14_form = $literal_formato_7;  }
  if ($tot123_M14_form >= $comparativo_formato_8) { $literal_tot123_M14_form = $literal_formato_8;  }
  if ($tot123_M14_form >= $comparativo_formato_9) { $literal_tot123_M14_form = $literal_formato_9;  }
  if ($tot123_M14_form >= $comparativo_formato_10) { $literal_tot123_M14_form = $literal_formato_10;  }
  if ($tot123_M14_form >= $comparativo_formato_11) { $literal_tot123_M14_form = $literal_formato_11;  }
  if ($tot123_M14_form >= $comparativo_formato_12) { $literal_tot123_M14_form = $literal_formato_12;  } 
  echo $literal_tot123_M14_form;   }
...
<?php  
$pruebass_M14_1 = $row_datos_control_notasM14["rev_uno"];
$pruebass_M14_2 = $row_datos_control_notasM14["rev_dos"];
$pruebass_redond_M14_1 =number_format($pruebass_M14_1);
$pruebass_redond_M14_2 =number_format($pruebass_M14_2); 
  ?>
...
if ($pruebass_M14_1 != '') {  
    if ($row_datos_controlmat['n_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M14_1;
    } /* cierre numerico */
    if ($row_datos_controlmat['n_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M14_1 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M14_1 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M14_1 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M14_1; } /* cierre alfabetico */
    if ($row_datos_controlmat['n_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M14_1 >= $comparativo_formato_1) { $literal_pruebass_redond_M14_1 = $literal_formato_1;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_2) { $literal_pruebass_redond_M14_1 = $literal_formato_2;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_3) { $literal_pruebass_redond_M14_1 = $literal_formato_3;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_4) { $literal_pruebass_redond_M14_1 = $literal_formato_4;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_5) { $literal_pruebass_redond_M14_1 = $literal_formato_5;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_6) { $literal_pruebass_redond_M14_1 = $literal_formato_6;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_7) { $literal_pruebass_redond_M14_1 = $literal_formato_7;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_8) { $literal_pruebass_redond_M14_1 = $literal_formato_8;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_9) { $literal_pruebass_redond_M14_1 = $literal_formato_9;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_10) { $literal_pruebass_redond_M14_1 = $literal_formato_10;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_11) { $literal_pruebass_redond_M14_1 = $literal_formato_11;  }
      if ($pruebass_redond_M14_1 >= $comparativo_formato_12) { $literal_pruebass_redond_M14_1 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M14_1;   }
}
?></b>
   </td>
...
if ($pruebass_M14_2 != '') {  
    if ($row_datos_controlmat['n_convertir'] == 1 ) {  /* numerico */
           echo $pruebass_redond_M14_2;
    } /* cierre numerico */
    if ($row_datos_controlmat['n_convertir'] == 2 ) {  /* alfabetico */
       if ($pruebass_redond_M14_2 >= $comparativo_formato_1) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_1;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_2) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_2;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_3) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_3;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_4) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_4;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_5) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_5;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_6) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_6;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_7) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_7;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_8) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_8;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_9) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_9;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_10) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_10;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_11) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_11;  }
       if ($pruebass_redond_M14_2 >= $comparativo_formato_12) { $alfabetico_pruebass_redond_M14_2 = $alfabetico_formato_12;  }
       echo $alfabetico_pruebass_redond_M14_2; } /* cierre alfabetico */
    if ($row_datos_controlmat['n_convertir'] == 3 ) {  /* literal */
      if ($pruebass_redond_M14_2 >= $comparativo_formato_1) { $literal_pruebass_redond_M14_2 = $literal_formato_1;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_2) { $literal_pruebass_redond_M14_2 = $literal_formato_2;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_3) { $literal_pruebass_redond_M14_2 = $literal_formato_3;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_4) { $literal_pruebass_redond_M14_2 = $literal_formato_4;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_5) { $literal_pruebass_redond_M14_2 = $literal_formato_5;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_6) { $literal_pruebass_redond_M14_2 = $literal_formato_6;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_7) { $literal_pruebass_redond_M14_2 = $literal_formato_7;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_8) { $literal_pruebass_redond_M14_2 = $literal_formato_8;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_9) { $literal_pruebass_redond_M14_2 = $literal_formato_9;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_10) { $literal_pruebass_redond_M14_2 = $literal_formato_10;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_11) { $literal_pruebass_redond_M14_2 = $literal_formato_11;  }
      if ($pruebass_redond_M14_2 >= $comparativo_formato_12) { $literal_pruebass_redond_M14_2 = $literal_formato_12;  } 
      echo $literal_pruebass_redond_M14_2;   }
}
?>  </b>
   </td>
...
?></span>
                    ...
                    <td style="width:60px;height:10px;" BGCOLOR="#FAE087" ><b><?php 
...
if ($dominio_alfabetico >= 4 ) {  /* alfabetico */
   ...
   echo $alfabetico_general_2xx_entero; } /* cierre alfabetico */
...
if ($dominio_literal >= 4  ) {  /* literal */
  ...
  echo $literal_general_2xx_entero; }
?></b></td>
...
if ($dominio_alfabetico >= 4 ) {  /* alfabetico */
   ...
   echo $alfabetico_aula_L2xxx_entero; } /* cierre alfabetico */
...
if ($dominio_literal >= 4  ) {  /* literal */
  ...
  echo $literal_aula_L2xxx_entero; }
...
?></span>
                    ...
                    <td style="width:60px;height:10px;" BGCOLOR="#F1A96A" ><b><?php 
...
if ($dominio_alfabetico >= 4 ) {  /* alfabetico */
   ...
   echo $alfabetico_general_3xx_entero; } /* cierre alfabetico */
...
if ($dominio_literal >= 4  ) {  /* literal */
  ...
  echo $literal_general_3xx_entero; }?></b></td>
...
if ($dominio_alfabetico >= 4 ) {  /* alfabetico */
   ...
   echo $alfabetico_aula_L3xxx_entero; } /* cierre alfabetico */
...
if ($dominio_literal >= 4  ) {  /* literal */
  ...
  echo $literal_aula_L3xxx_entero; }
...
?></span>
                    ...
                    <td style="width:60px;height:10px;" BGCOLOR="#ABC9F0" ><b><span style="font-size: 11px;">
                        ...
                        <?php   $signito = '=';
if ( $dominio_numerico >= 4  )  {echo $general_defxxx; echo $signito; }  ?> </span><?php  if ( $dominio_numerico >= 4  ) 
...
if ($dominio_alfabetico >= 4 ) {  /* alfabetico */
   ...
   echo $alfabetico_general_defxxxE; } /* cierre alfabetico */
...
if ($dominio_literal >= 4  ) {  /* literal */
  ...
  echo $literal_general_defxxxE; }?>    </b></td>
...
$signito = '=';
if ( $dominio_numerico >= 4  )  {echo $gran_promedio123xxx; echo $signito; }  ?> </span><?php  if ( $dominio_numerico >= 4  ) 
                       
                        {  /* numerico */
       echo $gran_promedio123xxxneto;
} /* cierre numerico */
...
if ($dominio_alfabetico >= 4 ) {  /* alfabetico */
   ...
   echo $alfabetico_promedio123xxxneto; } /* cierre alfabetico */
...
if ($dominio_literal >= 4  ) {  /* literal */
  ...
  echo $literal_promedio123xxxneto; }  ?>
...
$calificacion2 =  $row_datos_control['cla_2'];
...
$lugar_bbb = ' '.$calificacion2.' de '.$lap3_totalRows_datos_control.' ';
...
$calificacion3 =  $row_datos_control['cla_3'];
...
$lugar_ccc = ' '.$calificacion3.' de '.$lap3_totalRows_datos_control.' ';
...
$calificacion4 =  $row_datos_control['cla_4'];

$lugar_ddd = ' '.$calificacion4.' de '.$lap3_totalRows_datos_control.' ';
 ...
 echo $lugar_ddd; ?> 
        ...
        <table style="margin-top: 4px;">
            <tr>
                <td style="width:60%;height:22px; font-size: 12px;" class="table1" align="left" >&nbsp; <b>Observación:</b> "<b style="color:red;">#</b>" la asignatura y/o materia no suma en el promedio.<br> <span style="color: white;">_____________________________________________________________________________</span>  </td>
                <td style="width:38%;height:22px;" align="left" >&nbsp;&nbsp;&nbsp;Firma Prof. <br>&nbsp;&nbsp;&nbsp;encargado: ___________________.</td>
            </tr>
