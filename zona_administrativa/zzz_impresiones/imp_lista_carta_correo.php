...
<TD class="miniborder" style="width:40%; height:16px; font-size: 14px; color:<?php echo $color_imp1; ?>;" align="center"><b>Email</b>
</TD>



<TD class="miniborder" style="width:19%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
...
<TD class="miniborder" style="width:40%; height:16px; font-size: 12px; color:<?php echo $color_imp1; ?>;" align="center"><b><?php echo $row_datos_control['email_estu']; ?></b>
</TD>
