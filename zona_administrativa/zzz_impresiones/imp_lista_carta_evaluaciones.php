...
<TD class="miniborder" style="width:6.8%; height:105px; font-size: 13px; color:<?php echo $color_imp2; ?>;" align="center">
    <div style="rotate:90; margin-left: 5px;"><?php echo $primer_ind; ?></div>
</TD>

<TD class="miniborderleft" style="width:6.8%; height:105px; font-size: 13px; color:<?php echo $color_imp2; ?>;" align="center">
    <div style="rotate:90; margin-left: 5px;"><?php echo $segunda_ind; ?></div>
</TD>


<TD class="miniborderleft" style="width:6.8%; height:105px; font-size: 13px; color:<?php echo $color_imp2; ?>;" align="center">
    <div style="rotate:90; margin-left: 5px;"><?php echo $tercer_ind; ?></div>
</TD>


<TD class="miniborder" style="width:6.8%; height:105px; font-size: 13px; color:<?php echo $color_imp2; ?>;" align="center">
    <div style="rotate:90; margin-left: 5px;"><?php echo $cuarto_ind; ?></div>
</TD>



<TD class="miniborderleft" style="width:10%; height:105px; font-size: 13px; color:<?php echo $color_imp2; ?>;" >
    <div style="rotate:90; margin-left: 5px;"><?php echo $quinto_ind; ?></div>
</TD>
