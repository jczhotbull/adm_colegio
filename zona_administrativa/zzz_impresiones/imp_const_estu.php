...
<TR >
  <TD style="width:100%; margin-top: 4px;  height:auto; font-size: 28px; text-decoration: underline; font-weight: bold;" align="center">CONSTANCIA DE ESTUDIOS</TD>   
</TR>
...
<p style="text-align: justify; text-justify: inter-word; font-style: italic; text-indent: 20px; ">
    ...
    Quien suscribe <b><?php echo $row_datos_modcabecc['firma_1']; ?>, C.I. Nº 
      <?php echo number_format($row_datos_plantillaDF['ci_per'], 0 , ' , ' ,  '.'); ?>,</b> <?php echo $sexiest; ?> <?php echo $row_datos_modcabecc['art']; ?> <?php echo $row_datos_queryplantel["nombre_plantel"]; ?>, situada en la Parroquia <?php echo $row_datos_queryplantel['nombre_parroquia']; ?>, Municipio <?php echo $row_datos_queryplantel['nombre_municipio']; ?>, informa por medio de la presente que  <?php echo $him_her; ?>: <b><?php echo $row_datos_estudiantes['nombre_estu']; ?> <?php echo $row_datos_estudiantes['apellidos_estu']; ?></b>, titular de la Cédula de Identidad (escolar) <b>V <?php echo $ci_es; ?>,</b> cursa en esta Unidad Educativa <b><?php echo $row_datos_estudiantes['nombre_grados']; ?></b> de Educación  <?php echo $texto_div; ?>, año escolar <?php echo $row_datos_periodo['inicia']; ?>-<?php echo $row_datos_periodo['termina']; ?>. 
</p>
