...
<TD class="" style="width:3%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>

<TD class="" style="width:34%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>

<TD class="" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp3; ?>; " align=""><div style="rotate:90; margin-top: 10px;">...</div>
</TD>

<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -16px;">Talla Camisa</div>
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -16px;">Talla Pantalón</div>
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -16px;">Talla_de Zapatos</div>
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -16px;">Peso (Kg)</div>
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -16px;">Estatura (cms)</div>
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:65px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><div style="rotate:90; margin-top: -16px;">Edad</div>
</TD>


<TD class="" style="width:5%; height:65px; font-size: 16px; color:<?php echo $color_imp3; ?>;" align=""><div style="margin-top: 10px;">&nbsp;&nbsp;&nbsp;<b>.</b></div>  
</TD>
<TD class="" style="width:1%; height:65px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>

<TD class="" style="width:5%; height:65px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align=""><div style="margin-top: 10px;"><b>.</b></div>  
</TD>
...
<TD class="" style="width:38%; height:16px; font-size: 14px; color:<?php echo $color_imp3; ?>;" align="right">.&nbsp;&nbsp;
</TD>
...
$query = "SELECT * FROM reg_estu_actual, divisiones, grados, tall_cam, tall_pant, tall_zap, edades, pesos, alturas, reg_estudiantes 
...
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['talla_camisa']; ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['nombre_pantalon']; ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['talla_zapato']; ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['nombre_peso']; ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['nombre_altura']; ?>
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center">
</TD>
<TD class="miniborder" style="width:4%; height:16px; font-size: 14px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_control['nombre_edad']; ?>
</TD>
