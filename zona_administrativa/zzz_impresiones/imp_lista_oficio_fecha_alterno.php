...
<TD class="miniborder" style="width:34%; height:15px; font-size: 11px; color:<?php echo $color_imp1; ?>; padding-left: 4px;" align="left">
                                  <?php $fecha_insc_corre = date('d/m/Y', strtotime($row_datos_control['fecha_inscripcion'])); ?>
...
$firstCharacterlastnam = $lastnam[1];    
                                     ...
                                     echo $firstnam; ?>  - <b><?php echo $fecha_insc_corre; ?></b>
</TD>
