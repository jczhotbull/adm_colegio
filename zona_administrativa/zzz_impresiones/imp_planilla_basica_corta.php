...
<TR >
  ...
  <TD style="width:15%; margin-top: 4px;  height:auto; color: gray; font-size: 10px;" align="center"> </TD>
...
<TR >
  ...
  <img style="width:12px; font-size: 8px; max-height: auto;" src='medic.png'/> <?php echo $_POST["padece_estuxxx"]; ?> </TD>
...
<table class="basetabla" style="margin-top: 46px;" cellspacing="-1">
