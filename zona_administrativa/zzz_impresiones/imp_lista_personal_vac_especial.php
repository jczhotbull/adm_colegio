...
<TD class="miniborder" style="width:23%; height:15px; font-size: 11px; color:<?php echo $color_imp1; ?>;" align="center"><b>Email</b>
</TD>
<TD class="miniborder" style="width:20%; height:15px; font-size: 11px; color:<?php echo $color_imp1; ?>;" align="center"><b>Teléfono(s)</b>
</TD>

<TD class="miniborder" style="width:7%; height:15px; font-size: 11px; color:<?php echo $color_imp1; ?>;" align="center"><b>F. Nac.</b>
</TD>

<TD class="miniborder" style="width:20%; height:15px; font-size: 11px; color:<?php echo $color_imp1; ?>;" align="center"><b>Tiempo Laborando</b>
</TD>
...
<TD class="miniborder" style="width:23%; height:15px; font-size: 11px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $row_datos_plantilla['email_per']; ?>
</TD>
...
$date = new DateTime($row_datos_plantilla['nacimiento_per']);
   
       ?>


<TD class="miniborder" style="width:7%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center"><?php echo $date->format('d/m'); ?></TD>

<TD class="miniborder" style="width:20%; height:15px; font-size: 12px; color:<?php echo $color_imp2; ?>;" align="center">
    
<?php


$este_id = $row_datos_plantilla['id_per'];
...
$query_cont = "SELECT * FROM plantilla_contratados, plantilla_personal
                        
         WHERE  plantilla_contratados.id_per = plantilla_personal.id_per 

         and  plantilla_personal.id_per = '$este_id'

 LIMIT 1 ";


$datos_plantilla_cont = mysqli_query($enlace, $query_cont) or die(mysqli_error());

$row_datos_plantilla_cont = mysqli_fetch_array($datos_plantilla_cont); 
...
$dateOfwork = $row_datos_plantilla_cont['contratado_desde'];
$today = date("Y-m-d");
$diff = date_diff(date_create($dateOfwork), date_create($today));
echo $diff->format('%y').' años ' .$diff->format('%m').' meses y ' .$diff->format('%d').' días. ';
