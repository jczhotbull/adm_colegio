...
<div class="form-row">
 ...
 <img class="img-thumbnail border border-info"  src="<?php echo $row_datos_doc['foto_estu']; ?>?nocache=<?php echo time(); ?>"
 ...
 <input type="hidden" id="id_estu_GHJ"  name="id_estu_GHJ"
    value="<?php echo $row_datos_doc['id_estud']; ?>">  <!-- para saber donde guardar el cambio -->
...
value="<?php echo $row_datos_doc['nombre_estu']; ?>" required> 
...
value="<?php echo $row_datos_doc['apellidos_estu']; ?>" required> 
...
value="<?php echo $row_datos_doc['estu_expediente']; ?>" required> 
...
value="<?php echo $row_datos_doc['ci_estu']; ?>"> 
...
$id_del_estud = $row_datos_doc['id_estud'];
...
<input type="date" class="form-control form-control-sm" id="mod_nacimiento_estud" name="mod_nacimiento_estud" value="<?php echo $row_datos_doc['nacimiento_estu']; ?>" >
        </div>
...
mysqli_close($enlace);
  ...
  <div class="form-row">  <!-- row cero-->
                  <div class="col-md-12 text-left mt-3 mb-2">
                  <b class="text-secondary"> Observaciones en la hoja de vida:</b>  (No guardan relación con las citaciones)
                  </div>
  </div>   
...
<div class="form-row">  <!-- row cero-->
                  <div class="col-md-12 text-left mt-3 mb-2">
                  <h3 class="text-danger"> Agendar nueva cita:</h3>
                  </div>
  </div>   
 ...
 <div class="form-row"> 
         ...
         <div class="input-group input-group-sm col-md-3 mb-2">
                  <div class="input-group-prepend">
                    <span class="input-group-text alert-danger" id="basic-addon1"><i class="far fa-calendar-alt"></i></span>  
                  </div>
     
<input type="date" class="form-control form-control-sm" id="mod_fecha_cita" name="mod_fecha_cita" value="" required>
        </div>
...
<div class="input-group input-group-sm col-md-3 mb-2">
                  ...
                  <div class="input-group-prepend">
                    <span class="input-group-text alert-danger" id="basic-addon1"><i class="far fa-clock"></i></span>  
                  </div>


        
            <input id="timepicker<?php echo $row_datos_plantilla_estud['id_estud']; ?>" type="text" name="time" class="form-control form-control-sm " required>
...
<div class="input-group input-group-sm col-md-6 mb-2">
                    <div class="input-group-prepend">
                          <span class="input-group-text alert-danger" id="basic-addon1"><i class="fas fa-broadcast-tower"></i><i>&nbsp; Causa:</i></span>  
                        </div>
                        
                     
                                <select class="form-control form-control-sm" id="mod_causa" name="mod_causa" required>
    ...
    <option disabled></option>
                                    ...
                                    <option>Deuda Administrativa</option>
                                    <option>Inasistencia</option>
                                    <option>Llegar tarde a clases</option>
                                    <option>Materia Pendiente</option>
                                    <option>Rendimiento</option>
                                    <option>Salud y/o Enfermedad</option> 
 ...
 <div class="form-row">
  ...
  <div class="input-group input-group-sm col-md-9 mb-2">
                  <div class="input-group-prepend">
                    <span class="input-group-text alert-danger" id="basic-addon1"><i><b>Nota breve:</b></i></span>  
                  </div>
     
<input maxlength="135" type="text" class="form-control form-control-sm" id="mod_nota_cita" name="mod_nota_cita" value="" required>
        </div>


       <div class="input-group input-group-sm col-md-3 mb-2">
                    <div class="input-group-prepend">
                          <span class="input-group-text alert-danger" id="basic-addon1"><i>Responsable:</i></span>  
                        </div>
                        
                     
                                <select class="form-control form-control-sm" id="mod_responsable_cita" name="mod_responsable_cita" required>
