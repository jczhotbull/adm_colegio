...
<?php 
  ...
  $q_ciclo = "SELECT * FROM temporada_escolar WHERE periodo_escolar != '.' ORDER BY periodo_escolar DESC Limit 3";
...
<div class="alert alert-danger" role="alert">
 Ha ingresado como <b>administrador</b>, usted puede modificar todos los datos de esta lista, use con precaución.
</div>
