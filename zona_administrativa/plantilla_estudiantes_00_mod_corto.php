...
<option value="<?php echo $row_datos_control['municipio_est']; ?>" selected><?php echo $row_datos_control['municipio_est']; ?></option>
<option disabled></option>
                                <optgroup label="Cambiar a...">
                                <option disabled></option>
...
<option value="<?php echo $row_datos_control['vive_con']; ?>" selected><?php echo $row_datos_control['vive_con']; ?></option>
<option disabled></option>
                                <optgroup label="Cambiar a...">
                                <option disabled></option>
...
<option value="<?php echo $row_datos_control['se_traslada_en']; ?>" selected><?php echo $row_datos_control['se_traslada_en']; ?></option>
<option disabled></option>
                                <optgroup label="Cambiar a...">
                                <option disabled></option>
...
value="<?php echo $row_datos_control['alergico_a']; ?>" required>   
...
value="<?php echo $row_datos_control['enf_padecidas']; ?>" required> 
  ...
  and nombre_grados != '3er y 4to Año' and nombre_grados != '4to y 5to Año' and nombre_grados != '2do y 3er Año'
   and nombre_grados != 'Todos' ORDER BY nombre_division ASC";
    ...
    <?php
      ...
      <div class="input-group-prepend">
                    <span class="input-group-text alert-danger" id="basic-addon1"><i>en la sección:</i></span>
    </div> 
