...
<div class="form-row">
 ...
 <img class="img-thumbnail border border-info"  src="<?php echo $row_datos_control['foto_estu']; ?>?nocache=<?php echo time(); ?>"
                  alt="FOTO POR CARGAR"  onerror="this.src='../zz_fotos_p/ZZvacio5.jpg';" width="120px" />-->  
 ...
 <input type="hidden" id="id_estu_GHJ"  name="id_estu_GHJ"
    value="<?php echo $row_datos_control['id_estud']; ?>">  <!-- para saber donde guardar el cambio -->
...
value="<?php echo $row_datos_control['nombre_estu']; ?>" required> 
...
value="<?php echo $row_datos_control['apellidos_estu']; ?>" required> 
...
value="<?php echo $row_datos_control['estu_expediente']; ?>" required> 
...
value="<?php echo $row_datos_control['ci_estu']; ?>"> 
...
$id_del_estud = $row_datos_control['id_estud'];
...
<!--<div class="input-group input-group-sm col-md-4 mb-2">
                <div class="input-group-prepend">
                      <span class="input-group-text alert-info" id="basic-addon1"><i>Lugar de Nac.:</i></span>  
                            ...
                            <select disabled class="form-control form-control-sm" id="mod_ciudad_nac_estud" name="mod_ciudad_nac_estud">
...
<input type="date" class="form-control form-control-sm" id="mod_nacimiento_estud" name="mod_nacimiento_estud" value="<?php echo $row_datos_control['nacimiento_estu']; ?>" >
        </div>-->
...
<div class="input-group input-group-sm col-md-3 mb-2">
                <div class="input-group-prepend">
                      <span class="input-group-text alert-info" id="basic-addon1"><i class="fas fa-syringe"></i></span>  
                    </div>
...
<div class="input-group-prepend">
  <span class="input-group-text alert-danger" id="basic-addon1">&nbsp;<b>Email:</b></span> 
</div>

  <input maxlength="39" type="email" class="form-control form-control-sm " id="mod_email_estud" name="mod_email_estud"
value="<?php echo $row_datos_control['email_estu']; ?>" placeholder="Necesario para alumnos cursantes desde 4to Año."> 
...
<!--<div class="form-row">
 ...
 <input type="hidden" id="id_reg_estu_sobre_GHJ"  name="id_reg_estu_sobre_GHJ"
    value="<?php echo $row_datos_estu_sob['id_reg_estu_sobre']; ?>">
...
<!--<hr class="mt-0 mb-1" style="background-color: green; height: 1px; border: 0;">
...
<div class="form-row">
 ...
 <input type="hidden" id="id_reg_estu_actual_hoy"  name="id_reg_estu_actual_hoy"
    value="<?php echo $r_d_reg_estu_actual_HOY['id_reg_estu_actual']; ?>">
     ...
     <select disabled class="form-control form-control-sm" id="mod_grado_actual" name="mod_grado_actual">
...
and nombre_grados != 'Varios Media General' and nombre_grados != 'Pre Escolar 1er Nivel' and nombre_grados != 'Pre Escolar 2do Nivel'
  and nombre_grados != 'Pre Escolar 3er Nivel' ORDER BY nombre_grados ASC";
    ...
    <?php
      ...
      <div class="input-group-prepend">
                    <span class="input-group-text alert-danger" id="basic-addon1"><i>en el grupo, sección ó nivel:</i></span>
    </div> 


     <select disabled class="form-control form-control-sm" id="mod_seccion_actual" name="mod_seccion_actual">
...
<option value="<?php echo $r_d_reg_estu_actual_HOY['id_seccion']; ?>" selected><?php echo $r_d_reg_estu_actual_HOY['nombre_seccion']; ?></option>
    <option disabled></option>
                  ...
                  $querymod2 = "SELECT * FROM secciones WHERE nombre_seccion != '.' and nombre_seccion != '1er a 3er Nivel'  and nombre_seccion != 'A y B'
                   and nombre_seccion != '1er Nivel' and nombre_seccion != '2do Nivel' and nombre_seccion != '3er Nivel' and nombre_seccion != 'Todas' ORDER BY nombre_seccion ASC";
    ...
    <?php
     ...
     <select disabled class="form-control form-control-sm" id="mod_ciclo_actual" name="mod_ciclo_actual">
...
mysqli_close($enlace);
  ...
  <div class="form-row">  <!-- row cero-->
                  <div class="col-md-12 text-left mt-0 mb-1">
                  <b class="text-secondary"> Notas:</b>
                  </div>
  </div>   
...
<table>
  <tr>
    <td BGCOLOR="#94F990">1er Lapso</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
    ...
    <td></td><!-- 2do lapso-->
    <td></td><!-- 2do lapso-->
    <td BGCOLOR="#F9F790">2do Lapso</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
    ...
    <td></td><!-- 3er lapso-->
    <td></td><!-- 3er lapso-->
    <td BGCOLOR="#F9B990">3er Lapso</td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
    <td></td><!-- Calificación Final-->
    <td></td><!-- Calificación Final-->
    <td></td><!-- Calificación Final-->
  </tr>
  <tr>
...
<!--<input type="hidden" id="id_obs_estud"  name="id_obs_estud" value="<?php echo $row_datos_plantillaOBS['id_obs_estu']; ?>">
