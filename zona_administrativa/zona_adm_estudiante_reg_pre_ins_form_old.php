...
<input type="text" class="form-control form-control-sm" id="mod_nombre_plantel_estud" name="mod_nombre_plantel_estud" value="<?php echo $row_datos_estu_sob['nombre_plantel_pro']; ?>" >
   ...
   <div class="form-row">  <!-- row cero-->
    ...
    <option disabled></option>
                  ...
                  $querymod2 = "SELECT * FROM grados WHERE nombre_grados != '.'
...
<input type="hidden" id="id_repre"  name="id_repre" value="<?php echo $row_datos_estudiantes['id_repre']; ?>">
  ...
  <div class="col-md-12 mt-2">
    <button type="submit" name="editar_selecc" class="btn btn-success" value="<?php echo $row_datos_estudiantes['id_estud']; ?>">
    Actualizar Los Cambios &nbsp;&nbsp;<i class="far fa-edit fa-lg"></i></button></div>  </form>
...
<div class="input-group col-md-4 mb-2">
                    <div class="input-group-prepend">
                      <span class="input-group-text " id="basic-addon1">&nbsp;<i>Año escolar:</i></span>  
                            ...
                            <select class="form-control importantex" id="mod_new_ciclo_actual" name="mod_new_ciclo_actual">
