...
$query_doc_inicial = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
...
$query_doc_inicialf = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
         WHERE reg_estu_actual.id_estud = reg_estudiantes.id_estud
         and  obs_estu.id_estud = reg_estudiantes.id_estud
         and  divisiones.id_division = grados.id_division
         and  grados.id_grado = reg_estu_actual.grado_actual        
...
$query_doc_basica = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
         WHERE reg_estu_actual.id_estud = reg_estudiantes.id_estud
         and  obs_estu.id_estud = reg_estudiantes.id_estud
         and  divisiones.id_division = grados.id_division
         and  grados.id_grado = reg_estu_actual.grado_actual        
...
$query_doc_basicaf = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
         WHERE reg_estu_actual.id_estud = reg_estudiantes.id_estud
         and  obs_estu.id_estud = reg_estudiantes.id_estud
         and  divisiones.id_division = grados.id_division
         and  grados.id_grado = reg_estu_actual.grado_actual        
...
$query_doc_media = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
         WHERE reg_estu_actual.id_estud = reg_estudiantes.id_estud
         and  obs_estu.id_estud = reg_estudiantes.id_estud
         and  divisiones.id_division = grados.id_division
         and  grados.id_grado = reg_estu_actual.grado_actual        
...
$query_doc_mediaf = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
         WHERE reg_estu_actual.id_estud = reg_estudiantes.id_estud
         and  obs_estu.id_estud = reg_estudiantes.id_estud
         and  divisiones.id_division = grados.id_division
         and  grados.id_grado = reg_estu_actual.grado_actual        
...
$query_doc_mediag = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
         WHERE reg_estu_actual.id_estud = reg_estudiantes.id_estud
         and  obs_estu.id_estud = reg_estudiantes.id_estud
         and  divisiones.id_division = grados.id_division
         and  grados.id_grado = reg_estu_actual.grado_actual        
...
$query_doc_mediagf = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
         WHERE reg_estu_actual.id_estud = reg_estudiantes.id_estud
         and  obs_estu.id_estud = reg_estudiantes.id_estud
         and  divisiones.id_division = grados.id_division
         and  grados.id_grado = reg_estu_actual.grado_actual        
...
if ($dividivi == '1' or $dividivi == '2' or $dividivi == '5' or $dividivi == '3' ) {
   ...
   $query_doc = "SELECT * FROM reg_estu_actual, divisiones, grados, obs_estu, reg_estudiantes 
         WHERE reg_estu_actual.id_estud = reg_estudiantes.id_estud
         and  obs_estu.id_estud = reg_estudiantes.id_estud
         and  divisiones.id_division = grados.id_division
         and  grados.id_grado = reg_estu_actual.grado_actual        
