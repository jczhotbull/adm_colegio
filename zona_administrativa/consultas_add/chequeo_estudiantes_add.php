...
if ($_POST['plantel_pro1'])      // si tiene algo
			...
			{   $errorZ .= "- Nombre del plantel de procedencia 1, invalido. "; }
...
if ($_POST['plantel_pro2'])      // si tiene algo
			...
			{   $errorZ .= "- Nombre del plantel de procedencia 2, invalido. "; }
...
if ($_POST['plantel_pro3'])      // si tiene algo
			...
			{   $errorZ .= "- Nombre del plantel de procedencia 3, invalido. "; }
...
if ($_POST['plantel_pro4'])      // si tiene algo
			...
			{   $errorZ .= "- Nombre del plantel de procedencia 4, invalido. "; }
...
if ($_POST['plantel_pro5'])      // si tiene algo
			...
			{   $errorZ .= "- Nombre del plantel de procedencia 5, invalido. "; }
