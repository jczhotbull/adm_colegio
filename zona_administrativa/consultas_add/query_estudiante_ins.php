...
$query_seccion2 = "SELECT * FROM secciones WHERE nombre_seccion != '.' and nombre_seccion != '1er a 3er Nivel'  and nombre_seccion != 'A y B'
                  and nombre_seccion != '1er Nivel' and nombre_seccion != '2do Nivel' and nombre_seccion != '3er Nivel' and nombre_seccion != 'Todas'
                   ORDER BY nombre_seccion ASC";
$datos_seccion2 = mysqli_query($enlace, $query_seccion2) or die(mysqli_error());
$row_datos_seccion2 = mysqli_fetch_assoc($datos_seccion2);



$query_seccion3 = "SELECT * FROM secciones WHERE nombre_seccion != '.' and nombre_seccion != '1er a 3er Nivel'  and nombre_seccion != 'A y B'
                  and nombre_seccion != '1er Nivel' and nombre_seccion != '2do Nivel' and nombre_seccion != '3er Nivel' and nombre_seccion != 'Todas'
                   ORDER BY nombre_seccion ASC";
$datos_seccion3 = mysqli_query($enlace, $query_seccion3) or die(mysqli_error());
$row_datos_seccion3 = mysqli_fetch_assoc($datos_seccion3);



$query_seccion4 = "SELECT * FROM secciones WHERE nombre_seccion != '.' and nombre_seccion != '1er a 3er Nivel'  and nombre_seccion != 'A y B'
                  and nombre_seccion != '1er Nivel' and nombre_seccion != '2do Nivel' and nombre_seccion != '3er Nivel' and nombre_seccion != 'Todas'
                   ORDER BY nombre_seccion ASC";
$datos_seccion4 = mysqli_query($enlace, $query_seccion4) or die(mysqli_error());
$row_datos_seccion4 = mysqli_fetch_assoc($datos_seccion4);



$query_seccion5 = "SELECT * FROM secciones WHERE nombre_seccion != '.' and nombre_seccion != '1er a 3er Nivel'  and nombre_seccion != 'A y B'
                  and nombre_seccion != '1er Nivel' and nombre_seccion != '2do Nivel' and nombre_seccion != '3er Nivel' and nombre_seccion != 'Todas'
                   ORDER BY nombre_seccion ASC";
$datos_seccion5 = mysqli_query($enlace, $query_seccion5) or die(mysqli_error());
$row_datos_seccion5 = mysqli_fetch_assoc($datos_seccion5);
