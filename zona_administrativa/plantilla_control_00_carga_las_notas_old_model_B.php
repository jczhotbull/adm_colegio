...
<td class="align-middle borde_negro" align="center" style="font-size: 14px; height: 28px; width:3%;"><span data-toggle="tooltip" data-placement="top" title="Promedio+Aux = (<?php echo $total_def_dec; ?> + <?php echo $row_datos_control_notas["nt_AuF"]; ?>) ... Redondeado = <?php echo $total_def_prom; ?> ">
 ...
 <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L1_N1" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L1_N2" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L1_N3" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L1_N4" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L1_N5" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L1_N6" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L1_N7" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->

     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_ZA_Au1" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     ...
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L2_N1" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L2_N2" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L2_N3" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L2_N4" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L2_N5" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L2_N6" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L2_N7" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->

     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_ZB_Au2" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     ...
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L3_N1" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L3_N2" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L3_N3" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L3_N4" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L3_N5" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L3_N6" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_L3_N7" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->

     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_ZC_Au3" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->


     <input type="hidden" id="conteo_global"  name="conteo_global"    form="save_Aux_final_ZZZ" 
    value="<?php echo $totalRows_control; ?>">  <!-- para saber el total de filas -->
