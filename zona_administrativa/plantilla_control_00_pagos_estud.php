...
<?php include ("listas_imp_php/lista_control_ins_pagos_estud.php"); ?>  <!-- ayuda a hacer el listado -->
  ...
  <div class="container-fluid">
    ...
    <div class="form-row">  
          ...
          <div class="col-md-4 col-lg-4 mb-2">
            ...
            <i><b><?php echo $tituloJKL; ?></b></i>  &nbsp; Para el Ciclo Escolar:&nbsp; <b><?php echo $row_datos_periodo_act1['periodo_escolar']; ?></b>  </div> 
