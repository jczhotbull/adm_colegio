...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal_prof.php" method="POST">
...
<!--    <input type="hidden" id=""   name=""   value="">
  ...
  <div data-toggle="tooltip" data-placement="top" title="Lista con nombres" >
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal_vac_prof.php" method="POST">
