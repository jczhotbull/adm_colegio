...
<?php include ("listas_imp_php/lista_plantilla_servicio_all.php"); ?>  <!-- hace la lista -->
            ...
            <table class="table table-bordered table-sm table-hover" id="dataTable" width="100%" cellspacing="0"  >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="display:none;"><?php echo $row_datos_plantilla['contratado_desde']; ?></td>

                  <td class="align-middle" align="center"><?php


$dateOfwork = $row_datos_plantilla['contratado_desde'];
$today = date("Y-m-d");
...
echo $diff->format('%y').' años ' .$diff->format('%m').' meses y ' .$diff->format('%d').' días. ';
 ...
 ?> </td>
                  ...
                  <td class="align-middle" align="center">   
                    ...
                    <?php
                  $fecha_formateadaX = date('d-m-Y', strtotime($row_datos_plantilla['contratado_desde']));
                   echo $fecha_formateadaX; ?></td>  
