...
<?php include ("listas_imp_php/lista_estudiantes_pre_0a.php"); ?>  <!-- ayuda a hacer el listado -->
 ...
 <!--   update fotos  
  ...
  <div class="col-lg-6" data-toggle="tooltip" data-placement="top"
     ...
     data-target="#foto_update<?php echo $row_datos_estudiantes['id_estud']; ?>" data-backdrop="static" data-keyboard="false">
      ...
      <!--  <div class="card-footer text-muted"><b>Info:</b> Puede incorporar y retirar de la lista a un estudiante.
        </div>  -->
