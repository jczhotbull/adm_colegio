...
include("consultas_add/chequeo_estudiantes_add.php");   // chequea que lo introducido este bien.
      			...
      			<div class="card-body">
		      		...
		      		<div class="form-row">
				      		...
				      		<div class="col-md-3 col-lg-3 mb-1">
								...
								<i class="fas fa-user fa-lg"></i>&nbsp;&nbsp; <b> Pre-Inscripción: </b></div> 
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">Centre dentro del margen, simulando una foto carnet y haga clic "Recortar".</h5>
...
<div class="col-md-12 mt-3 mb-2 content-box-gray rounded ">
 ...
 <?php include ("zona_adm_estudiante_pre_1.php"); ?>
...
<div class="col-md-12 mt-3 mb-2 content-box-alterno rounded " style="<?php echo $gdiv2; ?>" >
 ...
 <?php include ("zona_adm_estudiante_pre_2.php"); ?>
...
<div class="col-md-12 mt-3 mb-2 content-box-gray rounded " style="<?php echo $gdiv3; ?>">
 ...
 <?php include ("zona_adm_estudiante_pre_3.php"); ?>
...
<div class="col-md-12 mt-3 mb-2 content-box-alterno rounded " style="<?php echo $gdiv4; ?>">
 ...
 <?php include ("zona_adm_estudiante_pre_4.php"); ?>
...
<div class="col-md-12 mt-3 mb-2 content-box-gray rounded " style="<?php echo $gdiv5; ?>">
 ...
 <?php include ("zona_adm_estudiante_pre_5.php"); ?>
