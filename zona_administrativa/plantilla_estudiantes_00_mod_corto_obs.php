...
<textarea maxlength="750" class="form-control" style="background-color:#E9E7E7 !important; color:black;" id="mod_obs_text<?php echo $row_datos_plantillaOBS['id_obs_estu']; ?>" name="mod_obs_text" rows="2"> <?php echo $row_datos_plantillaOBS['obs_estud']; ?> </textarea>
