...
<?php include ("listas_imp_php/lista_plantilla_cumplen_hoy.php"); ?>  <!-- hace la lista -->
...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <div class="form-row">
            ...
            <i><b>Cumpleañeros del día:</b> </i></div> 
...
$fecha_cum = date('d-m', strtotime($row_datos_plantilla['nacimiento_per'])); echo $fecha_cum; ?> </td>
