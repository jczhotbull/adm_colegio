...
<?php include ("listas_imp_php/lista_de_representantes".$selec.".php"); ?>  <!-- ayuda a hacer el listado -->
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <?php include("plantillita_repre_nuevecillo.php"); ?>
...
<?php include("plantilla_repres_00_upd_fot.php");   ?>
              ...
              <td class="align-middle" align="center"><?php echo $row_datos_estudiantes['nombre_repre']; ?>,<br>
                    <?php echo $row_datos_estudiantes['apellido_repre']; ?></td> 
