...
<?php include ("listas_imp_php/lista_estudiantes_ins.php"); ?>  <!-- ayuda a hacer el listado -->
 ...
 <td class="align-middle" align="center"><?php echo $row_datos_estudiantes['celular_repre']; 
                  ...
                  <td class="align-middle" align="center"> 
                    ...
                    <div class="form-row mb-2">
                      ...
                      <!--boton 1 -->
                      <div class="col-lg-12" data-toggle="tooltip" data-placement="top" title="Modificar Datos">
...
<!-- cierre modal editar -->
        ...
        <div class="card-footer text-muted"><b>Info:</b> Puede incorporar, retirar, modificar y eliminar de la lista a un estudiante.</div> 
