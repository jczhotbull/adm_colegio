...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal02_muj.php" method="POST">
...
<!--    <input type="hidden" id=""   name=""   value="">
  ...
  <div data-toggle="tooltip" data-placement="top" title="Lista con nombres" >
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal02_vac_muj.php" method="POST">
