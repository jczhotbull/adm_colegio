...
$nombre_dir_completo_vac = '../0000 Notas Respaldo/'.$nombre_add_directorio.'';

$nombre_dir_completo1 = '../0000 Notas Respaldo/'.$nombre_add_directorio.''.$dir_extra1.'';
$nombre_dir_completo2 = '../0000 Notas Respaldo/'.$nombre_add_directorio.''.$dir_extra2.'';
$nombre_dir_completo3 = '../0000 Notas Respaldo/'.$nombre_add_directorio.''.$dir_extra3.'';
$nombre_dir_completo4 = '../0000 Notas Respaldo/'.$nombre_add_directorio.''.$dir_extra4.'';
...
<input maxlength="14" type="text" class="form-control" id="especial_cuarto" name="especial_cuarto" value="<?php echo $especial_cuarto; ?>" required>                  
          ...
          <div class="input-group col-md-3 mt-2 mb-3">
                <div class="input-group-prepend">
    <span class="input-group-text alert-success" id="basic-addon1"><i>Mes Actual:</i></span>  
                    </div>
...
<div class="border border-danger rounded"> 
        ...
        <form method="POST">
         ...
         <div class="input-group col-md-3 mt-4 mb-3">
                          <div class="input-group-prepend">
        ...
        <button type="submit" name="reset_general" class="btn btn-info btn-block form-control form-control-sm "> 
         ...
         <div class="input-group col-md-4 mt-4 mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text alert-info" id="basic-addon1"><b>Resetear</b>&nbsp; claves de acceso en asignaturas:</i></span>  
                          </div>
        ...
        <button type="submit" name="reset_asign" class="btn btn-info btn-block form-control form-control-sm "> 
         ...
         <div class="input-group col-md-4 mt-4 mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text alert-info" id="basic-addon1"><b>Resetear</b>&nbsp; claves de acceso a secciones:</i></span>  
                          </div>
        ...
        <button type="submit" name="reset_secc" class="btn btn-info btn-block form-control form-control-sm "> 
         ...
         <div class="input-group col-md-1 mt-4 mb-3">
...
<form method="POST">
 ...
 <div class="input-group col-md-12 mt-4 mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text alert-success" id="basic-addon1"><i>Respaldar las <b>fotos</b> de los estudiantes, ciclo <b><?php echo $row_datos_plantilla_per['periodo_escolar']; ?></b>.</i></span>  
                  </div>
...
<div class="form-row ">  <!-- mensaje q aprece -->
 ...
 <div class="ml-2 input-group col-md-12 mt-4 mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text alert-danger" id="basic-addon1"><i>Eliminar todas las <b>fotos</b> de los estudiantes.</i></span>  
                  </div>
...
<form method="POST">
 ...
 <div class="input-group col-md-12 mt-4 mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text alert-primary" id="basic-addon1"><i>Respaldar las <b>notas y/o cortes</b> del ciclo <b><?php echo $row_datos_plantilla_per_old['periodo_escolar']; ?></b>.</i></span>  
                  </div>



 <input type="hidden" id="nombre_ciclo"  name="nombre_ciclo" value="<?php echo $row_datos_plantilla_per_old['periodo_escolar']; ?>">
...
realizarlo siempre al comienzo del año escolar.</span>"</b></span>
</div>
...
<div style="margin-left: 25px; padding-top: 7px;" >
<span class="alert-light"><b>"Necesario realizarlo al comienzo de cada año escolar, tras haber realizado el respaldo previamente."</b></span>
</div>
...
<h5 class="text-primary">Seleccione los meses, que han de estar cancelados para poder descargar las Notas y/o Boletas:</h5>
...
<input maxlength="50" type="text" class="form-control" id="host_del_sis" name="host_del_sis" value="<?php echo $el_host; ?>" required>                  
 ...
 <div class="input-group col-md-2 mt-2 mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text alert-danger" id="basic-addon1"><i><b>Port:</b></i></span>  
                  </div>
...
desde programas externos, menos seguros, el correo para esta función debe ser uno que no se use para nada
importante, de preferencia solo para él envió de email del sistema;</b>. El email de Respuesta es el correo
al cual los representantes indicaran sus inquietudes; DE PREFERENCIA USAR CORREO GMAIL.</h6>
...
<br> <br><br>
 ...
 <div class="card border-info col-md-12" style="margin-top: 40px; padding: 10px;">
...
<input maxlength="20" type="text" class="form-control " id="div22" name="div22" value="<?php echo $cab_div2; ?>" required>                  
 ...
 <div class="input-group col-md-6 mt-2 mb-3">
                  <div class="input-group-prepend">
...
<option disabled></option>
 ...
 <div class="input-group col-md-4 mb-3">
                <div class="input-group-prepend">
                      <span class="input-group-text alert-danger" id="basic-addon1"><i><b>Permitir Ver Notas:</b></i></span>  
                    </div>    
...
<div class="col-md-6 mb-3" style="padding-top: 7px;" >
<span class="warning-light"><b>"Permite o no a los representantes ver las notas."</b></span>
</div>
...
<form method="POST">
 ...
 <div class="input-group col-md-9 mb-3">
                <div class="input-group-prepend">
                      <span class="input-group-text alert-danger" id="basic-addon1"><i><b>Comprobar que los representantes esten al día con los pagos para que puedan ver las notas y la boleta?:</b></i></span>  
                    </div> 
