 ...
 <div data-toggle="tooltip" data-placement="top" title="Borrar foto." >
                ...
                <button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal"
                 data-target="#borrar_foto_re_<?php echo $row_datos_estudiantez['id_estud']; ?>"> <i class="fas fa-camera-retro"></i></button>
...
<div class="modal fade" id="borrar_foto_re_<?php echo $row_datos_estudiantez['id_estud']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br> <b>"<?php echo $row_datos_estudiantez['apellido_repre'];?>,  <?php echo $row_datos_estudiantez['nombre_repre'];?> 
