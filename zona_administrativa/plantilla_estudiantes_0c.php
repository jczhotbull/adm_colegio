...
if (strlen($_POST['buscar_estud']) <=2 )  // no sea mayor a 40 caracteres
    ...
    header( "Location: plantilla_estudiantes_0c.php?ciclo=".$id_periodo_clave."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=5" ); 
      ...
      if ($totalRows_datos_plantilla_bus == '0') {
       ...
       header( "Location: plantilla_estudiantes_0c.php?ciclo=".$id_periodo_clave."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=55" );
      ...
      if ($totalRows_datos_plantilla_bus >= '1' and $totalRows_datos_plantilla_bus <= '16') {
        ...
        header( "Location: plantilla_estudiantes_0c.php?ciclo=".$id_periodo_clave."&tituloJKL=Resultados...&criterio=".$busqueda."&alertin=0" );
      ...
      if ($totalRows_datos_plantilla_bus >= '17') {
        ...
        header( "Location: plantilla_estudiantes_0c.php?ciclo=".$id_periodo_clave."&tituloJKL=Resultados...&criterio=".$xxxsearch."&alertin=1" ); 
...
<?php include ("listas_imp_php/lista_estudiantes_0c.php"); ?>  <!-- ayuda a hacer el listado -->
...
<form method="POST">
            ...
            <div class="input-group-prepend">
              <span class="input-group-text alert-success">Nueva Busqueda</span>
            </div>
    ...
    if ( $row_datos_estudiantes['int_si_o_no'] == '1') {
     ...
     echo $row_datos_estudiantes['apellidos_estu'];?>,<br>
                   <?php echo $row_datos_estudiantes['nombre_estu'];  ?>  <br><span style="color: #417FD5;">"Edad: <b><?php echo $r_d_reg_estu_HOYx['nombre_edad']; ?></b> años."   </span> 
                    <span style="color: green;"><i>-</i></span> <span><b><?php echo $row_datos_estudiantes['tipo_religion']; ?></b></span><br>
                  <span style="color: red;"><i class="fab fa-medrt"></i></span> <span><?php echo $row_datos_estudiantes['nombre_medico']; ?></span><br>
...
<!-- cierre modal editar -->
                      ...
                      $ready = $row_datos_estudiantes['inscrito_si_o_no'];
                       ...
                       if ($ready==1){?>style="display:none"<?php } ?>  >
                        ...
                        <form target="_blank" action="zzz_impresiones/imp_planilla_basica.php" method="POST">
...
<!--boton 2 alterno -->
                      ...
                      $ready = $row_datos_estudiantes['inscrito_si_o_no'];
                       ...
                       if ($ready==0){?>style="display:none"<?php } ?>  >
                        ...
                        <form target="_blank" action="zzz_impresiones/imp_planilla.php" method="POST">
