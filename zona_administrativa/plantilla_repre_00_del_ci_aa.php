 ...
 <div data-toggle="tooltip" data-placement="top" title="Borrar Doc. Id." >
                ...
                <button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal"
                 data-target="#borrar_ci_re_<?php echo $row_datos_estudiantez['id_estud']; ?>"> <i class="far fa-id-card"></i></button>
...
<div class="modal fade" id="borrar_ci_re_<?php echo $row_datos_estudiantez['id_estud']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
