...
$query = "SELECT * FROM plantilla_contratados, plantilla_personal, sexo, divisiones, grados
         ...
         WHERE  plantilla_contratados.id_per = plantilla_personal.id_per
            ...
            and plantilla_personal.id_sexo = '2'
...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal02_hom.php" method="POST">
...
<!--    <input type="hidden" id=""   name=""   value="">
  ...
  <div data-toggle="tooltip" data-placement="top" title="Lista con nombres" >
    ...
    <form target="_blank" action="zzz_impresiones/imp_lista_personal02_vac_hom.php" method="POST">
