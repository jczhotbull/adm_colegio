...
include("consultas_add/chequeo_estudiantes_extra_add_fast.php");   // chequea que lo introducido este bien.
...
include ("zona_adm_estudiante_add_fast.php");
...
<div class="form-row"  style="display: <?php echo $mostrar_form;?> " >
<div class="col-md-12">
...
<!-- representado 1 -->
<div class="col-md-12 mt-3 mb-2 content-box-gray rounded " style="display: <?php echo $mostrar_form;?>" >

<form method="POST" name="preinscribir" onsubmit="return validateForm()">   <!-- permite enviar  -->

 <?php include ("zona_adm_estudiante_pre_add_fast.php"); ?>
...
<div style="display: <?php echo $mostrar_form;?>">  
