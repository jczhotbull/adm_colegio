...
<?php include ("listas_imp_php/lista_plantilla_cumplen.php"); ?>  <!-- hace la lista -->
...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <div class="form-row">
            ...
            <i><b>Cumpleañeros del mes:</b> </i></div> 
...
$fecha_cum = date('d-m', strtotime($row_datos_plantilla['nacimiento_per'])); echo $fecha_cum; ?> <br> <?php
...
if ( $fecha_cum == $today ) {
 ...
 $tortaaa = 'fas fa-birthday-cake fa-lg fa-spin';
 ...
 ?>   <i style="color:purple;" class="<?php echo $tortaaa; ?>"></i> </td>
